...
class TestKernelOpts(unittest.TestCase):
  ...
  def test_tensor_core_emulation_opts_group(self):
    ...
    for tc in Device[Device.DEFAULT].renderer.tensor_cores:
      ...
      helper_linearizer_opt(r, [
        [Opt(OptOps.TC, 0, (-1, 0, 3)), Opt(OptOps.GROUP, 0, 2)],
        [Opt(OptOps.TC, 0, (-1, 0, 3)), Opt(OptOps.GROUPTOP, 0, 4)],
        [Opt(OptOps.TC, 0, (-1, 0, 3)), Opt(OptOps.UPCAST, 0, 4), Opt(OptOps.GROUP, 0, 2)],
        [Opt(OptOps.TC, 0, (-1, 0, 3)), Opt(OptOps.LOCAL, 0, 4), Opt(OptOps.GROUP, 0, 2)],
        [Opt(OptOps.TC, 0, (-1, 0, 3)), Opt(OptOps.UNROLL, 0, 4), Opt(OptOps.GROUP, 0, 2)],
        [Opt(OptOps.TC, 0, (-1, 0, 3)), Opt(OptOps.UPCAST, 0, 2), Opt(OptOps.LOCAL, 0, 2), Opt(OptOps.GROUP, 0, 2)],
        [Opt(OptOps.TC, 0, (-1, 0, 3)), Opt(OptOps.LOCAL, 0, 2), Opt(OptOps.GROUPTOP, 0, 8), Opt(OptOps.UNROLL, 0, 2), Opt(OptOps.UPCAST, 1, 2)],
      ], apply_tc=False, atol=atol, rtol=rtol)
