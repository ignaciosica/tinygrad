...
def do_expand(root:UOp):
  ...
  if root.op is Ops.WMMA: exclude_args = tuple(dedup(root.arg[-1] + tuple(y[0] for y in flatten(root.arg[-2]))))
  elif root.op is Ops.STORE and root.arg: exclude_args = root.arg
  else: exclude_args = ()
