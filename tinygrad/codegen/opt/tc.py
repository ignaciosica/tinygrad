...
class TensorCore:  # D = A * B + C, A is (M x K), B is (K x N), C and D are (M x N)
  ...
  def __str__(self):
    return "_".join(["WMMA"] + list(map(str, self.dims)) + [self.dtype_in.name, self.dtype_out.name])
...
cuda_8168_f16 = [
  TensorCore(
    ...
    dtype_out=do,
    opts=cuda_tc_opts,
    swizzle=((("r1", "r2", "l2", "l3", "l4"), ("r0", "u1"), ("l0", "l1", "u0")), (("r1", "r2", "u0", "l0", "l1"), ("u1", "r0"), ("l2", "l3", "l4"))),
  )
...
cuda_8168_tf32 = [
  TensorCore(
    ...
    opts=cuda_tc_opts,
    swizzle=((("r0", "r1", "l2", "l3", "l4"), ("u1", "r2"), ("l0", "l1", "u0")), (("r0", "r1", "u0", "l0", "l1"), ("u1", "r2"), ("l2", "l3", "l4"))),
  )
]
...
metal = [
  TensorCore(
    ...
    swizzle=((("r1", "l1", "l2", "r2", "l4"), ("r0",), ("u0", "l0", "l3")), (("l0", "r0", "r1", "l3", "r2"), ("u0",), ("l1", "l2", "l4"))),
  )
  for di, do in [
...
amx = [
  TensorCore(
    ...
    dtype_in=dt,
    dtype_out=dt,
    swizzle=(((), ("u0", "u1", "u2", "u3", "u4", "u5", "u6", "u7"), ()), ((), ("u4", "u5", "u6", "u7", "u0", "u1", "u2", "u3"), ())),
...
intel = [
  TensorCore(
    ...
    swizzle=((("r1", "r2", "r3"), ("u0", "u1", "u2"), ("l0", "l1", "l2", "r0")), (("l0", "l1", "l2"), ("r1", "r2", "r3"), ("u0", "u1", "u2", "r0"))),
  )
]
