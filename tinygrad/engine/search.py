...
actions += [Opt(op=OptOps.TC, axis=0, amt=pref, arg=0) for pref in range(4)]
actions += [Opt(op=OptOps.TC, axis=axis, amt=0, arg=getenv("TC_OPT", 2)) for axis in range(9)] # covers resnet kernels (3 global * 3 reduce)
