...
def AMDGPU_PTE_MTYPE_VG10(flags, mtype):  # macro
  return ((flags) & (~AMDGPU_PTE_MTYPE_VG10_SHIFT(3))) | AMDGPU_PTE_MTYPE_VG10_SHIFT(
    mtype
  )
...
AMDGPU_PTE_DEFAULT_ATC = (
  (1 << 1) | (1 << 2) | (1 << 4) | (1 << 5) | (1 << 6) | AMDGPU_PTE_MTYPE_VG10(0, 2)
)  # macro
...
def AMDGPU_PTE_MTYPE_NV10(flags, mtype):  # macro
  return ((flags) & (~AMDGPU_PTE_MTYPE_NV10_SHIFT(7))) | AMDGPU_PTE_MTYPE_NV10_SHIFT(
    mtype
  )
...
def AMDGPU_PTE_MTYPE_GFX12(flags, mtype):  # macro
  return ((flags) & (~AMDGPU_PTE_MTYPE_GFX12_SHIFT(3))) | AMDGPU_PTE_MTYPE_GFX12_SHIFT(
    mtype
  )
...
__all__ = [
  ...
  "AMDGPU_DOORBELL_LAYOUT1_HIQ",
  "AMDGPU_DOORBELL_LAYOUT1_IH",
  ...
  "AMDGPU_NAVI10_DOORBELL_sDMA_ENGINE3",
  "AMDGPU_PDE_PTE",
  ...
  "AUDIO_AZ_HWID",
  "BINARY_SIGNATURE",
  "BIST_MEM_TRAINING_ENCROACHED_SIZE",
  "BOOTCFG_CMD_GET",
  "BOOTCFG_CMD_INVALIDATE",
  "BOOTCFG_CMD_SET",
  ...
  "GFX_FW_TYPE_IMU_I",
  "GFX_FW_TYPE_ISP",
  "GFX_FW_TYPE_ISP_DATA",
  "GFX_FW_TYPE_JPEG_RAM",
  "GFX_FW_TYPE_LSDMA",
  "GFX_FW_TYPE_MAX",
  ...
  "GFX_FW_TYPE_VPE",
  "GFX_FW_TYPE_VPEC_FW1",
  "GFX_FW_TYPE_VPEC_FW2",
  "HARVEST_INFO",
  ...
  "PSP_HEADER_SIZE",
  "PSP_MEM_TRAIN_COLD_BOOT",
  "PSP_MEM_TRAIN_INIT_FAILED",
  ...
  "PSP_RING_TYPE__KM",
  "PSP_RING_TYPE__UM",
  "PSP_RUNTIME_DB_COOKIE_ID",
  "PSP_RUNTIME_DB_DIAG_ENTRY_MAX_COUNT",
  "PSP_RUNTIME_DB_OFFSET",
  "PSP_RUNTIME_DB_SIZE_IN_BYTES",
  "PSP_RUNTIME_DB_VER_1",
  ...
  "SOC15_IH_CLIENTID_UTCL2LOG",
  "SOC15_IH_CLIENTID_UVD",
  "SOC15_IH_CLIENTID_UVD1",
  "SOC15_IH_CLIENTID_VCE0",
  "SOC15_IH_CLIENTID_VCE1",
  "SOC15_IH_CLIENTID_VCN",
  "SOC15_IH_CLIENTID_VCN1",
  "SOC15_IH_CLIENTID_VMC",
  "SOC15_IH_CLIENTID_VMC1",
  "SOC15_IH_CLIENTID_XDMA",
  "SOC21_IH_CLIENTID_ATHUB",
  "SOC21_IH_CLIENTID_BIF",
  "SOC21_IH_CLIENTID_DCN",
  "SOC21_IH_CLIENTID_DF",
  "SOC21_IH_CLIENTID_GFX",
  "SOC21_IH_CLIENTID_GRBM_CP",
  "SOC21_IH_CLIENTID_IH",
  "SOC21_IH_CLIENTID_IMU",
  "SOC21_IH_CLIENTID_ISP",
  "SOC21_IH_CLIENTID_LSDMA",
  "SOC21_IH_CLIENTID_MAX",
  "SOC21_IH_CLIENTID_MP0",
  "SOC21_IH_CLIENTID_MP1",
  "SOC21_IH_CLIENTID_MP3",
  "SOC21_IH_CLIENTID_PWR",
  "SOC21_IH_CLIENTID_RLC",
  "SOC21_IH_CLIENTID_ROM_SMUIO",
  "SOC21_IH_CLIENTID_THM",
  "SOC21_IH_CLIENTID_VCN",
  "SOC21_IH_CLIENTID_VCN1",
  "SOC21_IH_CLIENTID_VMC",
  "SOC21_IH_CLIENTID_VPE",
  "SOC21_IH_CLIENTID_VPE1",
  "SST_HWID",
  "SYSTEMHUB_HWID",
  ...
  "psp_shared_mem_size",
  "soc15_ih_clientid",
  "soc15_ih_clientid_name",
  "soc21_ih_clientid",
  "struct__fuse_data_bits",
  "struct_amdgpu_device",
  "struct_amdgpu_firmware_info",
  "struct_amdgpu_iv_entry",
  "struct_binary_header",
  "struct_common_firmware_header",
  "struct_die",
  "struct_die_header",
  "struct_die_info",
  "struct_dmcu_firmware_header_v1_0",
  "struct_dmcub_firmware_header_v1_0",
  "struct_firmware",
  "struct_gc_info_v1_0",
  "struct_gc_info_v1_1",
  "struct_gc_info_v1_2",
  ...
  "struct_gpu_info_firmware_v1_0",
  "struct_gpu_info_firmware_v1_1",
  "struct_gpu_info_header",
  "struct_harvest_info",
  "struct_harvest_info_header",
  "struct_harvest_table",
  "struct_imu_firmware_header_v1_0",
  "struct_ip",
  "struct_ip_discovery_header",
  "struct_ip_discovery_header_0_0",
  "struct_ip_structure",
  "struct_ip_v3",
  "struct_ip_v4",
  "struct_mall_info_header",
  "struct_mall_info_v1_0",
  "struct_mall_info_v2_0",
  "struct_mc_firmware_header_v1_0",
  "struct_mes_firmware_header_v1_0",
  "struct_nps_info_header",
  "struct_nps_info_v1_0",
  "struct_nps_instance_info_v1_0",
  "struct_psp_bin_desc",
  "struct_psp_context",
  ...
  "struct_psp_firmware_header_v2_1",
  "struct_psp_fw_bin_desc",
  "struct_psp_fw_legacy_bin_desc",
  "struct_psp_gfx_buf_desc",
  "struct_psp_gfx_buf_list",
  "struct_psp_gfx_cmd_boot_cfg",
  "struct_psp_gfx_cmd_invoke_cmd",
  "struct_psp_gfx_cmd_load_ip_fw",
  "struct_psp_gfx_cmd_load_ta",
  "struct_psp_gfx_cmd_load_toc",
  "struct_psp_gfx_cmd_reg_prog",
  ...
  "struct_psp_gfx_cmd_unload_ta",
  "struct_psp_gfx_ctrl",
  "struct_psp_gfx_rb_frame",
  "struct_psp_gfx_resp",
  ...
  "struct_ta_firmware_header_v1_0",
  "struct_ta_firmware_header_v2_0",
  "struct_table_info",
  "struct_umsch_mm_firmware_header_v1_0",
  "struct_v11_compute_mqd",
  "struct_v11_gfx_mqd",
  "struct_v11_sdma_mqd",
  "struct_v12_compute_mqd",
  "struct_v12_gfx_mqd",
  "struct_v12_sdma_mqd",
  "struct_vcn_info_header",
  "struct_vcn_info_v1_0",
  "struct_vcn_instance_info_v1_0",
  "struct_vpe_firmware_header_v1_0",
  "ta_fw_type",
  "ta_type_id",
  "table",
  "table__enumvalues",
  ...
  "union_psp_gfx_cmd_setup_tmr_0",
  "union_psp_gfx_commands",
  "union_psp_gfx_uresp",
]
