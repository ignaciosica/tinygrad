...
try:
  ...
  hsa_queue_create.argtypes = [
    ...
    hsa_queue_type32_t,
    ctypes.CFUNCTYPE(
      None, c__EA_hsa_status_t, ctypes.POINTER(struct_hsa_queue_s), ctypes.POINTER(None)
    ),
    ctypes.POINTER(None),
    uint32_t,
    uint32_t,
...
try:
  ...
  hsa_isa_iterate_wavefronts.argtypes = [
    hsa_isa_t,
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, struct_hsa_wavefront_s, ctypes.POINTER(None)),
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
...
struct_hsa_ext_images_1_00_pfn_s._fields_ = [
  ...
  (
    ...
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, struct_hsa_agent_s, struct_hsa_ext_sampler_s),
  ),
]
...
struct_hsa_ven_amd_aqlprofile_1_00_pfn_s._fields_ = [
  ...
  (
    "hsa_ven_amd_aqlprofile_error_string",
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, ctypes.POINTER(ctypes.POINTER(ctypes.c_char))),
  ),
  (
    "hsa_ven_amd_aqlprofile_validate_event",
    ctypes.CFUNCTYPE(
