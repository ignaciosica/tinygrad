...
_libraries["libhsa-runtime64.so"] = ctypes.CDLL(
  os.getenv("ROCM_PATH") + "/lib/libhsa-runtime64.so" if os.getenv("ROCM_PATH") else ctypes.util.find_library("hsa-runtime64")
)
...
try:
  ...
  hsa_queue_create.argtypes = [
    ...
    uint32_t,
    hsa_queue_type32_t,
    ctypes.CFUNCTYPE(None, c__EA_hsa_status_t, ctypes.POINTER(struct_hsa_queue_s), ctypes.POINTER(None)),
    ctypes.POINTER(None),
    uint32_t,
    uint32_t,
...
try:
  ...
  hsa_executable_iterate_symbols.argtypes = [
    hsa_executable_t,
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, struct_hsa_executable_s, struct_hsa_executable_symbol_s, ctypes.POINTER(None)),
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
try:
  ...
  hsa_executable_iterate_agent_symbols.argtypes = [
    hsa_executable_t,
    hsa_agent_t,
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, struct_hsa_executable_s, struct_hsa_agent_s, struct_hsa_executable_symbol_s, ctypes.POINTER(None)),
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
...
try:
  ...
  hsa_code_object_serialize.argtypes = [
    hsa_code_object_t,
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, ctypes.c_uint64, struct_hsa_callback_data_s, ctypes.POINTER(ctypes.POINTER(None))),
    hsa_callback_data_t,
    ctypes.POINTER(ctypes.c_char),
...
try:
  ...
  hsa_code_object_iterate_symbols.argtypes = [
    hsa_code_object_t,
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, struct_hsa_code_object_s, struct_hsa_code_symbol_s, ctypes.POINTER(None)),
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
...
struct_hsa_ext_images_1_00_pfn_s._fields_ = [
  ...
  (
    "hsa_ext_image_clear",
    ctypes.CFUNCTYPE(
      c__EA_hsa_status_t, struct_hsa_agent_s, struct_hsa_ext_image_s, ctypes.POINTER(None), ctypes.POINTER(struct_hsa_ext_image_region_s)
    ),
  ),
  (
    "hsa_ext_sampler_create",
    ctypes.CFUNCTYPE(
      c__EA_hsa_status_t, struct_hsa_agent_s, ctypes.POINTER(struct_hsa_ext_sampler_descriptor_s), ctypes.POINTER(struct_hsa_ext_sampler_s)
    ),
  ),
...
try:
  ...
  hsa_amd_agent_iterate_memory_pools.argtypes = [
    hsa_agent_t,
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, struct_hsa_amd_memory_pool_s, ctypes.POINTER(None)),
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
...
try:
  ...
  hsa_ext_program_iterate_modules.argtypes = [
    hsa_ext_program_t,
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, struct_hsa_ext_program_s, ctypes.POINTER(struct_BrigModuleHeader), ctypes.POINTER(None)),
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
...
hsa_ven_amd_aqlprofile_data_callback_t = ctypes.CFUNCTYPE(
  c__EA_hsa_status_t, c__EA_hsa_ven_amd_aqlprofile_info_type_t, ctypes.POINTER(struct_c__SA_hsa_ven_amd_aqlprofile_info_data_t), ctypes.POINTER(None)
)
try:
...
hsa_ven_amd_aqlprofile_coordinate_callback_t = ctypes.CFUNCTYPE(
  c__EA_hsa_status_t, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.c_int32, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(None)
)
try:
...
struct_hsa_ven_amd_aqlprofile_1_00_pfn_s._fields_ = [
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      c__EA_hsa_status_t, struct_hsa_agent_s, ctypes.POINTER(struct_c__SA_hsa_ven_amd_aqlprofile_event_t), ctypes.POINTER(ctypes.c_bool)
    ),
  ),
  (
    "hsa_ven_amd_aqlprofile_start",
    ctypes.CFUNCTYPE(
      c__EA_hsa_status_t, ctypes.POINTER(struct_c__SA_hsa_ven_amd_aqlprofile_profile_t), ctypes.POINTER(struct_c__SA_hsa_ext_amd_aql_pm4_packet_t)
    ),
  ),
  (
  ...
  (
    ...
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, ctypes.POINTER(struct_c__SA_hsa_ext_amd_aql_pm4_packet_t), ctypes.POINTER(None)),
  ),
  (
  ...
  (
    ...
    ctypes.CFUNCTYPE(c__EA_hsa_status_t, ctypes.CFUNCTYPE(c__EA_hsa_status_t, ctypes.c_int32, ctypes.POINTER(ctypes.c_char))),
  ),
  (
