...
_libraries = {}
_libraries["libibverbs"] = ctypes.CDLL(
  ctypes.util.find_library("ibverbs"), use_errno=True
)  #  ctypes.CDLL('libibverbs')
...
IBV_FLOW_ACTION_ESP_KEYMAT_AES_GCM = (
  IB_UVERBS_FLOW_ACTION_ESP_KEYMAT_AES_GCM  # macro
)
...
ibv_flow_action_esp_keymat_aes_gcm_iv_algo = (
  ib_uverbs_flow_action_esp_keymat_aes_gcm_iv_algo  # macro
)
...
IBV_FLOW_ACTION_ESP_FLAGS_ESN_NEW_WINDOW = (
  IB_UVERBS_FLOW_ACTION_ESP_FLAGS_ESN_NEW_WINDOW  # macro
)
...
struct_ib_uverbs_flow_action_esp_encap._anonymous_ = (
  "_0",
  "_1",
)
...
IBV_ADVISE_MR_ADVICE_PREFETCH_WRITE = (
  IB_UVERBS_ADVISE_MR_ADVICE_PREFETCH_WRITE  # macro
)
IBV_ADVISE_MR_ADVICE_PREFETCH_NO_FAULT = (
  IB_UVERBS_ADVISE_MR_ADVICE_PREFETCH_NO_FAULT  # macro
)
...
struct_ibv_context_ops._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_device_attr),
    ),
  ),
  (
    "_compat_query_port",
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(struct_ibv_context),
      ctypes.c_ubyte,
      ctypes.POINTER(struct__compat_ibv_port_attr),
    ),
  ),
  ...
  (
    "alloc_mw",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_mw), ctypes.POINTER(struct_ibv_pd), ibv_mw_type
    ),
  ),
  (
    "bind_mw",
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_qp),
      ctypes.POINTER(struct_ibv_mw),
      ctypes.POINTER(struct_ibv_mw_bind),
    ),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_cq),
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_wc),
    ),
  ),
  (
    "req_notify_cq",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_cq), ctypes.c_int32),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_srq),
      ctypes.POINTER(struct_ibv_recv_wr),
      ctypes.POINTER(ctypes.POINTER(struct_ibv_recv_wr)),
    ),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_qp),
      ctypes.POINTER(struct_ibv_send_wr),
      ctypes.POINTER(ctypes.POINTER(struct_ibv_send_wr)),
    ),
  ),
  (
    "post_recv",
...
struct__ibv_device_ops._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_device),
      ctypes.c_int32,
    ),
  ),
...
struct_ibv_send_wr._anonymous_ = (
  "_0",
  "_1",
)
...
struct_ibv_qp_ex._fields_ = [
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(struct_ibv_mw),
      ctypes.c_uint32,
      ctypes.POINTER(struct_ibv_mw_bind_info),
    ),
  ),
  (
    "wr_local_inv",
    ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_ibv_qp_ex), ctypes.c_uint32),
  ),
  (
    "wr_rdma_read",
    ctypes.CFUNCTYPE(
      None, ctypes.POINTER(struct_ibv_qp_ex), ctypes.c_uint32, ctypes.c_uint64
    ),
  ),
  (
    "wr_rdma_write",
  ...
  (
    "wr_set_inline_data",
    ctypes.CFUNCTYPE(
      None, ctypes.POINTER(struct_ibv_qp_ex), ctypes.POINTER(None), ctypes.c_uint64
    ),
  ),
  (
    ...
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(struct_ibv_qp_ex),
      ctypes.c_uint64,
      ctypes.POINTER(struct_ibv_data_buf),
    ),
  ),
  (
    "wr_set_sge",
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(struct_ibv_qp_ex),
      ctypes.c_uint64,
      ctypes.POINTER(struct_ibv_sge),
    ),
  ),
  ("wr_start", ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_ibv_qp_ex))),
  (
    "wr_complete",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_qp_ex)),
  ),
...
try:
  ...
  ibv_wr_atomic_cmp_swp.argtypes = [
    ctypes.POINTER(struct_ibv_qp_ex),
    uint32_t,
    uint64_t,
    uint64_t,
...
try:
  ...
  ibv_wr_atomic_fetch_add.argtypes = [
    ctypes.POINTER(struct_ibv_qp_ex),
    uint32_t,
    uint64_t,
    uint64_t,
...
try:
  ...
  ibv_wr_rdma_write_imm.argtypes = [
    ctypes.POINTER(struct_ibv_qp_ex),
    uint32_t,
    uint64_t,
    __be32,
...
try:
  ...
  ibv_wr_set_inline_data.argtypes = [
    ctypes.POINTER(struct_ibv_qp_ex),
    ctypes.POINTER(None),
    size_t,
  ]
...
try:
  ...
  ibv_wr_set_inline_data_list.argtypes = [
    ctypes.POINTER(struct_ibv_qp_ex),
    size_t,
    ctypes.POINTER(struct_ibv_data_buf),
  ]
...
struct_ibv_cq_ex._fields_ = [
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_cq_ex),
      ctypes.POINTER(struct_ibv_poll_cq_attr),
    ),
  ),
  ...
  (
    "read_vendor_err",
    ctypes.CFUNCTYPE(ctypes.c_uint32, ctypes.POINTER(struct_ibv_cq_ex)),
  ),
  (
    "read_byte_len",
    ctypes.CFUNCTYPE(ctypes.c_uint32, ctypes.POINTER(struct_ibv_cq_ex)),
  ...
  (
    "read_dlid_path_bits",
    ctypes.CFUNCTYPE(ctypes.c_ubyte, ctypes.POINTER(struct_ibv_cq_ex)),
  ),
  (
    "read_completion_ts",
    ctypes.CFUNCTYPE(ctypes.c_uint64, ctypes.POINTER(struct_ibv_cq_ex)),
  ),
  (
    "read_cvlan",
    ctypes.CFUNCTYPE(ctypes.c_uint16, ctypes.POINTER(struct_ibv_cq_ex)),
  ),
  (
    "read_flow_tag",
    ctypes.CFUNCTYPE(ctypes.c_uint32, ctypes.POINTER(struct_ibv_cq_ex)),
  ...
  (
    "read_tm_info",
    ctypes.CFUNCTYPE(
      None, ctypes.POINTER(struct_ibv_cq_ex), ctypes.POINTER(struct_ibv_wc_tm_info)
    ),
  ),
  (
...
try:
  ...
  pass
try:
  ibv_wc_read_invalidated_rkey = _libraries[
    "libibverbs"
...
try:
  ...
  pass
try:
  ibv_wc_read_completion_wallclock_ns = _libraries[
    "libibverbs"
...
try:
  ...
  ibv_wc_read_tm_info.argtypes = [
    ctypes.POINTER(struct_ibv_cq_ex),
    ctypes.POINTER(struct_ibv_wc_tm_info),
  ]
except AttributeError:
  pass
try:
...
struct_verbs_context._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(struct_ibv_context),
      ctypes.c_ubyte,
      ctypes.POINTER(struct_ibv_port_attr),
      ctypes.c_uint64,
    ),
  ),
  (
  ...
  (
    "alloc_null_mr",
    ctypes.CFUNCTYPE(ctypes.POINTER(struct_ibv_mr), ctypes.POINTER(struct_ibv_pd)),
  ),
  (
    "read_counters",
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_counters),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_counters),
      ctypes.POINTER(struct_ibv_counter_attach_attr),
      ctypes.POINTER(struct_ibv_flow),
    ),
  ),
  (
    "create_counters",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_counters),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_counters_init_attr),
    ),
  ),
  (
    "destroy_counters",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_counters)),
  ),
  (
    "reg_dm_mr",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_mr),
      ctypes.POINTER(struct_ibv_pd),
      ctypes.POINTER(struct_ibv_dm),
      ctypes.c_uint64,
      ctypes.c_uint64,
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_dm),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_alloc_dm_attr),
    ),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_flow_action),
      ctypes.POINTER(struct_ibv_flow_action_esp_attr),
    ),
  ),
  (
    "destroy_flow_action",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_flow_action)),
  ),
  (
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_qp),
      ctypes.POINTER(struct_ibv_qp_rate_limit_attr),
    ),
  ),
  (
    "alloc_parent_domain",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_pd),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_parent_domain_init_attr),
    ),
  ),
  ...
  (
    "alloc_td",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_td),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_td_init_attr),
    ),
  ),
  (
    "modify_cq",
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_cq),
      ctypes.POINTER(struct_ibv_modify_cq_attr),
    ),
  ),
  (
    "post_srq_ops",
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_srq),
      ctypes.POINTER(struct_ibv_ops_wr),
      ctypes.POINTER(ctypes.POINTER(struct_ibv_ops_wr)),
    ),
  ),
  (
    "destroy_rwq_ind_table",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_rwq_ind_table)),
  ),
  (
    "create_rwq_ind_table",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_rwq_ind_table),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_rwq_ind_table_init_attr),
    ),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_wq),
      ctypes.POINTER(struct_ibv_wq_attr),
    ),
  ),
  (
    "create_wq",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_wq),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_wq_init_attr),
    ),
  ),
  (
    "query_rt_values",
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_values_ex),
    ),
  ),
  (
    "create_cq_ex",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_cq_ex),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_cq_init_attr_ex),
    ),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_query_device_ex_input),
      ctypes.POINTER(struct_ibv_device_attr_ex),
      ctypes.c_uint64,
    ),
  ),
  (
    "ibv_destroy_flow",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_flow)),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_flow),
      ctypes.POINTER(struct_ibv_qp),
      ctypes.POINTER(struct_ibv_flow_attr),
    ),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_qp),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_qp_open_attr),
    ),
  ),
  (
    "create_qp_ex",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_qp),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_qp_init_attr_ex),
    ),
  ),
  (
    "get_srq_num",
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_ibv_srq), ctypes.POINTER(ctypes.c_uint32)
    ),
  ),
  (
    "create_srq_ex",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_srq),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_srq_init_attr_ex),
    ),
  ),
  (
    "open_xrcd",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_xrcd),
      ctypes.POINTER(struct_ibv_context),
      ctypes.POINTER(struct_ibv_xrcd_init_attr),
    ),
  ),
...
try:
  ...
  ibv_get_async_event.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    ctypes.POINTER(struct_ibv_async_event),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  ibv_query_gid.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    uint8_t,
    ctypes.c_int32,
    ctypes.POINTER(union_ibv_gid),
  ]
except AttributeError:
  pass
try:
  ...
  _ibv_query_gid_ex.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    uint32_t,
    uint32_t,
    ctypes.POINTER(struct_ibv_gid_entry),
    uint32_t,
    size_t,
  ]
except AttributeError:
...
try:
  ...
  ibv_create_flow_action_esp.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    ctypes.POINTER(struct_ibv_flow_action_esp_attr),
  ]
except AttributeError:
...
try:
  ...
  ibv_modify_flow_action_esp.argtypes = [
    ctypes.POINTER(struct_ibv_flow_action),
    ctypes.POINTER(struct_ibv_flow_action_esp_attr),
  ]
except AttributeError:
...
try:
  ...
  ibv_create_cq.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    ctypes.c_int32,
    ctypes.POINTER(None),
    ctypes.POINTER(struct_ibv_comp_channel),
    ctypes.c_int32,
  ]
except AttributeError:
  pass
...
try:
  ...
  ibv_get_cq_event.argtypes = [
    ctypes.POINTER(struct_ibv_comp_channel),
    ctypes.POINTER(ctypes.POINTER(struct_ibv_cq)),
...
try:
  ...
  ibv_create_srq.argtypes = [
    ctypes.POINTER(struct_ibv_pd),
    ctypes.POINTER(struct_ibv_srq_init_attr),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  ibv_modify_srq.argtypes = [
    ctypes.POINTER(struct_ibv_srq),
    ctypes.POINTER(struct_ibv_srq_attr),
    ctypes.c_int32,
  ]
except AttributeError:
  pass
...
try:
  ...
  ibv_create_qp.argtypes = [
    ctypes.POINTER(struct_ibv_pd),
    ctypes.POINTER(struct_ibv_qp_init_attr),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  ibv_alloc_parent_domain.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    ctypes.POINTER(struct_ibv_parent_domain_init_attr),
  ]
except AttributeError:
...
try:
  ...
  ibv_query_rt_values_ex.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    ctypes.POINTER(struct_ibv_values_ex),
  ]
except AttributeError:
...
try:
  ...
  ibv_modify_qp.argtypes = [
    ctypes.POINTER(struct_ibv_qp),
    ctypes.POINTER(struct_ibv_qp_attr),
    ctypes.c_int32,
  ]
except AttributeError:
  pass
try:
  ...
  ibv_modify_qp_rate_limit.argtypes = [
    ctypes.POINTER(struct_ibv_qp),
    ctypes.POINTER(struct_ibv_qp_rate_limit_attr),
  ]
except AttributeError:
...
try:
  ...
  ibv_query_qp_data_in_order.argtypes = [
    ctypes.POINTER(struct_ibv_qp),
    ibv_wr_opcode,
    uint32_t,
  ]
...
try:
  ...
  ibv_create_rwq_ind_table.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    ctypes.POINTER(struct_ibv_rwq_ind_table_init_attr),
  ]
except AttributeError:
...
try:
  ...
  ibv_create_ah.argtypes = [
    ctypes.POINTER(struct_ibv_pd),
    ctypes.POINTER(struct_ibv_ah_attr),
  ]
except AttributeError:
  pass
try:
  ...
  ibv_init_ah_from_wc.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    uint8_t,
    ctypes.POINTER(struct_ibv_wc),
    ctypes.POINTER(struct_ibv_grh),
    ctypes.POINTER(struct_ibv_ah_attr),
  ]
except AttributeError:
  pass
try:
  ...
  ibv_create_ah_from_wc.argtypes = [
    ctypes.POINTER(struct_ibv_pd),
    ctypes.POINTER(struct_ibv_wc),
    ctypes.POINTER(struct_ibv_grh),
    uint8_t,
...
try:
  ...
  ibv_resolve_eth_l2_from_gid.argtypes = [
    ctypes.POINTER(struct_ibv_context),
    ctypes.POINTER(struct_ibv_ah_attr),
    ctypes.c_ubyte * 6,
    ctypes.POINTER(ctypes.c_uint16),
...
try:
  ...
  ibv_set_ece.argtypes = [
    ctypes.POINTER(struct_ibv_qp),
    ctypes.POINTER(struct_ibv_ece),
  ]
except AttributeError:
  pass
try:
...
__all__ = [
  ...
  "IBV_FLOW_ACTION_ESP_REPLAY_NONE",
  "IBV_FLOW_ACTION_IV_ALGO_SEQ",
  ...
  "c__Ea_IBV_LINK_LAYER_UNSPECIFIED",
  "c__Ea_IBV_SYSFS_NAME_MAX",
  "c__Ea_IBV_WC_IP_CSUM_OK_SHIFT",
  "c__Ea_IBV_WC_STANDARD_FLAGS",
  "c__Ea_IB_USER_VERBS_EX_CMD_QUERY_DEVICE",
  "c__Ea_IB_UVERBS_CREATE_QP_SUP_COMP_MASK",
  "ib_placement_type",
  "ib_selectivity_level",
  "ib_uverbs_access_flags",
  "ib_uverbs_advise_mr_advice",
  "ib_uverbs_advise_mr_flag",
  "ib_uverbs_core_support",
  "ib_uverbs_create_qp_mask",
  "ib_uverbs_device_cap_flags",
  "ib_uverbs_ex_create_cq_flags",
  ...
  "ibv_event_type",
  "ibv_event_type_str",
  "ibv_flow_action_esp_flags",
  "ibv_flow_action_esp_keymat",
  "ibv_flow_action_esp_keymat_aes_gcm_iv_algo",
  "ibv_flow_action_esp_mask",
  "ibv_flow_action_esp_replay",
  "ibv_flow_attr_type",
  "ibv_flow_flags",
  ...
  "size_t",
  "ssize_t",
  "struct___pthread_cond_s",
  "struct___pthread_internal_list",
  "struct___pthread_mutex_s",
  "struct__compat_ibv_port_attr",
  "struct__ibv_device_ops",
  "struct_c__UA___atomic_wide_counter___value32",
  "struct_ib_uverbs_ah_attr",
  "struct_ib_uverbs_alloc_mw",
  "struct_ib_uverbs_alloc_mw_resp",
  "struct_ib_uverbs_alloc_pd",
  "struct_ib_uverbs_alloc_pd_resp",
  "struct_ib_uverbs_async_event_desc",
  "struct_ib_uverbs_attach_mcast",
  "struct_ib_uverbs_close_xrcd",
  "struct_ib_uverbs_cmd_hdr",
  "struct_ib_uverbs_comp_event_desc",
  "struct_ib_uverbs_cq_moderation",
  "struct_ib_uverbs_cq_moderation_caps",
  "struct_ib_uverbs_create_ah",
  "struct_ib_uverbs_create_ah_resp",
  "struct_ib_uverbs_create_comp_channel",
  "struct_ib_uverbs_create_comp_channel_resp",
  "struct_ib_uverbs_create_cq",
  "struct_ib_uverbs_create_cq_resp",
  "struct_ib_uverbs_create_flow",
  "struct_ib_uverbs_create_flow_resp",
  "struct_ib_uverbs_create_qp",
  "struct_ib_uverbs_create_qp_resp",
  "struct_ib_uverbs_create_srq",
  "struct_ib_uverbs_create_srq_resp",
  "struct_ib_uverbs_create_xsrq",
  "struct_ib_uverbs_dealloc_mw",
  "struct_ib_uverbs_dealloc_pd",
  "struct_ib_uverbs_dereg_mr",
  "struct_ib_uverbs_destroy_ah",
  "struct_ib_uverbs_destroy_cq",
  "struct_ib_uverbs_destroy_cq_resp",
  "struct_ib_uverbs_destroy_flow",
  "struct_ib_uverbs_destroy_qp",
  "struct_ib_uverbs_destroy_qp_resp",
  "struct_ib_uverbs_destroy_srq",
  "struct_ib_uverbs_destroy_srq_resp",
  "struct_ib_uverbs_detach_mcast",
  ...
  "struct_ib_uverbs_ex_modify_cq",
  "struct_ib_uverbs_ex_modify_qp",
  ...
  "struct_ib_uverbs_flow_attr",
  "struct_ib_uverbs_flow_eth_filter",
  ...
  "struct_ib_uverbs_get_context_resp",
  "struct_ib_uverbs_gid_entry",
  "struct_ib_uverbs_global_route",
  "struct_ib_uverbs_modify_qp",
  "struct_ib_uverbs_modify_srq",
  "struct_ib_uverbs_odp_caps",
  "struct_ib_uverbs_odp_caps_per_transport_caps",
  "struct_ib_uverbs_open_qp",
  "struct_ib_uverbs_open_xrcd",
  "struct_ib_uverbs_open_xrcd_resp",
  "struct_ib_uverbs_poll_cq",
  "struct_ib_uverbs_poll_cq_resp",
  "struct_ib_uverbs_post_recv",
  "struct_ib_uverbs_post_recv_resp",
  "struct_ib_uverbs_post_send",
  "struct_ib_uverbs_post_send_resp",
  "struct_ib_uverbs_post_srq_recv",
  "struct_ib_uverbs_post_srq_recv_resp",
  "struct_ib_uverbs_qp_attr",
  "struct_ib_uverbs_qp_cap",
  "struct_ib_uverbs_qp_dest",
  "struct_ib_uverbs_query_device",
  "struct_ib_uverbs_query_device_resp",
  "struct_ib_uverbs_query_port",
  "struct_ib_uverbs_query_port_resp",
  "struct_ib_uverbs_query_port_resp_ex",
  "struct_ib_uverbs_query_qp",
  "struct_ib_uverbs_query_qp_resp",
  "struct_ib_uverbs_query_srq",
  "struct_ib_uverbs_query_srq_resp",
  "struct_ib_uverbs_recv_wr",
  "struct_ib_uverbs_reg_mr",
  "struct_ib_uverbs_reg_mr_resp",
  "struct_ib_uverbs_req_notify_cq",
  "struct_ib_uverbs_rereg_mr",
  "struct_ib_uverbs_rereg_mr_resp",
  "struct_ib_uverbs_resize_cq",
  "struct_ib_uverbs_resize_cq_resp",
  "struct_ib_uverbs_rss_caps",
  "struct_ib_uverbs_send_wr",
  "struct_ib_uverbs_send_wr_1_atomic",
  "struct_ib_uverbs_send_wr_1_rdma",
  "struct_ib_uverbs_send_wr_1_ud",
  "struct_ib_uverbs_sge",
  "struct_ib_uverbs_tm_caps",
  "struct_ib_uverbs_wc",
  "struct_ibv_ah",
  "struct_ibv_ah_attr",
  "struct_ibv_alloc_dm_attr",
  "struct_ibv_async_event",
  "struct_ibv_comp_channel",
  "struct_ibv_context",
  "struct_ibv_context_ops",
  "struct_ibv_counter_attach_attr",
  "struct_ibv_counters",
  "struct_ibv_counters_init_attr",
  "struct_ibv_cq",
  "struct_ibv_cq_ex",
  "struct_ibv_cq_init_attr_ex",
  "struct_ibv_cq_moderation_caps",
  "struct_ibv_data_buf",
  "struct_ibv_device",
  "struct_ibv_device_attr",
  "struct_ibv_device_attr_ex",
  "struct_ibv_dm",
  "struct_ibv_ece",
  "struct_ibv_flow",
  "struct_ibv_flow_action",
  "struct_ibv_flow_action_esp_attr",
  "struct_ibv_flow_attr",
  "struct_ibv_flow_esp_filter",
  "struct_ibv_flow_eth_filter",
  "struct_ibv_flow_gre_filter",
  "struct_ibv_flow_ipv4_ext_filter",
  "struct_ibv_flow_ipv4_filter",
  "struct_ibv_flow_ipv6_filter",
  "struct_ibv_flow_mpls_filter",
  "struct_ibv_flow_spec",
  ...
  "struct_ibv_flow_spec_counter_action",
  "struct_ibv_flow_spec_esp",
  "struct_ibv_flow_spec_eth",
  "struct_ibv_flow_spec_gre",
  "struct_ibv_flow_spec_ipv4",
  "struct_ibv_flow_spec_ipv4_ext",
  "struct_ibv_flow_spec_ipv6",
  "struct_ibv_flow_spec_mpls",
  "struct_ibv_flow_spec_tcp_udp",
  "struct_ibv_flow_spec_tunnel",
  "struct_ibv_flow_tcp_udp_filter",
  "struct_ibv_flow_tunnel_filter",
  "struct_ibv_gid_entry",
  "struct_ibv_gid_global",
  "struct_ibv_global_route",
  "struct_ibv_grh",
  "struct_ibv_moderate_cq",
  "struct_ibv_modify_cq_attr",
  "struct_ibv_mr",
  "struct_ibv_mw",
  "struct_ibv_mw_bind",
  "struct_ibv_mw_bind_info",
  "struct_ibv_odp_caps",
  "struct_ibv_odp_caps_per_transport_caps",
  "struct_ibv_ops_wr",
  "struct_ibv_ops_wr_0_add",
  "struct_ibv_ops_wr_tm",
  "struct_ibv_packet_pacing_caps",
  "struct_ibv_parent_domain_init_attr",
  "struct_ibv_pci_atomic_caps",
  "struct_ibv_pd",
  "struct_ibv_poll_cq_attr",
  "struct_ibv_port_attr",
  "struct_ibv_qp",
  "struct_ibv_qp_attr",
  "struct_ibv_qp_cap",
  "struct_ibv_qp_ex",
  "struct_ibv_qp_init_attr",
  "struct_ibv_qp_init_attr_ex",
  "struct_ibv_qp_open_attr",
  "struct_ibv_qp_rate_limit_attr",
  "struct_ibv_query_device_ex_input",
  "struct_ibv_recv_wr",
  "struct_ibv_rss_caps",
  "struct_ibv_rwq_ind_table",
  "struct_ibv_rwq_ind_table_init_attr",
  "struct_ibv_rx_hash_conf",
  "struct_ibv_send_wr",
  "struct_ibv_send_wr_1_atomic",
  "struct_ibv_send_wr_1_rdma",
  "struct_ibv_send_wr_1_ud",
  "struct_ibv_send_wr_2_xrc",
  "struct_ibv_send_wr_3_bind_mw",
  "struct_ibv_send_wr_3_tso",
  "struct_ibv_sge",
  "struct_ibv_srq",
  "struct_ibv_srq_attr",
  "struct_ibv_srq_init_attr",
  "struct_ibv_srq_init_attr_ex",
  "struct_ibv_td",
  "struct_ibv_td_init_attr",
  "struct_ibv_tm_cap",
  "struct_ibv_tm_caps",
  "struct_ibv_tso_caps",
  "struct_ibv_values_ex",
  "struct_ibv_wc",
  "struct_ibv_wc_tm_info",
  "struct_ibv_wq",
  "struct_ibv_wq_attr",
  "struct_ibv_wq_init_attr",
  "struct_ibv_xrcd",
  "struct_ibv_xrcd_init_attr",
  "struct_timespec",
  "struct_verbs_context",
  "struct_verbs_ex_private",
  "uint16_t",
  "uint32_t",
  "uint64_t",
  "uint8_t",
  "union_c__UA___atomic_wide_counter",
  "union_c__UA_pthread_cond_t",
  ...
  "union_ib_uverbs_send_wr_ex",
  "union_ib_uverbs_send_wr_wr",
  "union_ib_uverbs_wc_ex",
  "union_ibv_async_event_element",
  "union_ibv_flow_spec_0",
  "union_ibv_gid",
  "union_ibv_send_wr_0",
  "union_ibv_send_wr_3",
  "union_ibv_send_wr_qp_type",
