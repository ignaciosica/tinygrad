...
struct_ibv_context_ops._fields_ = [
  ...
  (
    "_compat_query_port",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_context), ctypes.c_ubyte, ctypes.POINTER(struct__compat_ibv_port_attr)),
  ),
  ...
  (
    "post_srq_recv",
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_ibv_srq), ctypes.POINTER(struct_ibv_recv_wr), ctypes.POINTER(ctypes.POINTER(struct_ibv_recv_wr))
    ),
  ),
  ...
  (
    "post_send",
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_ibv_qp), ctypes.POINTER(struct_ibv_send_wr), ctypes.POINTER(ctypes.POINTER(struct_ibv_send_wr))
    ),
  ),
  (
    "post_recv",
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_ibv_qp), ctypes.POINTER(struct_ibv_recv_wr), ctypes.POINTER(ctypes.POINTER(struct_ibv_recv_wr))
    ),
  ),
...
struct_ibv_wq._fields_ = [
  ...
  (
    "post_recv",
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_ibv_wq), ctypes.POINTER(struct_ibv_recv_wr), ctypes.POINTER(ctypes.POINTER(struct_ibv_recv_wr))
    ),
  ),
  ("mutex", union_c__UA_pthread_mutex_t),
  ("cond", union_c__UA_pthread_cond_t),
...
struct_ibv_qp_ex._fields_ = [
  ...
  (
    "wr_bind_mw",
    ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_ibv_qp_ex), ctypes.POINTER(struct_ibv_mw), ctypes.c_uint32, ctypes.POINTER(struct_ibv_mw_bind_info)),
  ),
  ...
  (
    "wr_flush",
    ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_ibv_qp_ex), ctypes.c_uint32, ctypes.c_uint64, ctypes.c_uint64, ctypes.c_ubyte, ctypes.c_ubyte),
  ),
]
...
struct_ibv_parent_domain_init_attr._fields_ = [
  ...
  (
    "alloc",
    ctypes.CFUNCTYPE(ctypes.POINTER(None), ctypes.POINTER(struct_ibv_pd), ctypes.POINTER(None), ctypes.c_uint64, ctypes.c_uint64, ctypes.c_uint64),
  ),
...
struct_verbs_context._fields_ = [
  (
    "query_port",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_context), ctypes.c_ubyte, ctypes.POINTER(struct_ibv_port_attr), ctypes.c_uint64),
  ),
  (
    "advise_mr",
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_ibv_pd), ib_uverbs_advise_mr_advice, ctypes.c_uint32, ctypes.POINTER(struct_ibv_sge), ctypes.c_uint32
    ),
  ),
  ("alloc_null_mr", ctypes.CFUNCTYPE(ctypes.POINTER(struct_ibv_mr), ctypes.POINTER(struct_ibv_pd))),
  (
    "read_counters",
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_counters), ctypes.POINTER(ctypes.c_uint64), ctypes.c_uint32, ctypes.c_uint32),
  ),
  (
    "attach_counters_point_flow",
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_ibv_counters), ctypes.POINTER(struct_ibv_counter_attach_attr), ctypes.POINTER(struct_ibv_flow)
    ),
  ),
  (
    "create_counters",
    ctypes.CFUNCTYPE(ctypes.POINTER(struct_ibv_counters), ctypes.POINTER(struct_ibv_context), ctypes.POINTER(struct_ibv_counters_init_attr)),
  ),
  ("destroy_counters", ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_counters))),
  (
    "reg_dm_mr",
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_mr), ctypes.POINTER(struct_ibv_pd), ctypes.POINTER(struct_ibv_dm), ctypes.c_uint64, ctypes.c_uint64, ctypes.c_uint32
    ),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_flow_action), ctypes.POINTER(struct_ibv_flow_action_esp_attr)),
  ),
  ("destroy_flow_action", ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_ibv_flow_action))),
  (
    "create_flow_action_esp",
    ctypes.CFUNCTYPE(ctypes.POINTER(struct_ibv_flow_action), ctypes.POINTER(struct_ibv_context), ctypes.POINTER(struct_ibv_flow_action_esp_attr)),
  ),
  ...
  (
    "alloc_parent_domain",
    ctypes.CFUNCTYPE(ctypes.POINTER(struct_ibv_pd), ctypes.POINTER(struct_ibv_context), ctypes.POINTER(struct_ibv_parent_domain_init_attr)),
  ),
  ...
  (
    "post_srq_ops",
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_ibv_srq), ctypes.POINTER(struct_ibv_ops_wr), ctypes.POINTER(ctypes.POINTER(struct_ibv_ops_wr))
    ),
  ),
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_ibv_rwq_ind_table), ctypes.POINTER(struct_ibv_context), ctypes.POINTER(struct_ibv_rwq_ind_table_init_attr)
    ),
  ),
  ...
  (
    "create_cq_ex",
    ctypes.CFUNCTYPE(ctypes.POINTER(struct_ibv_cq_ex), ctypes.POINTER(struct_ibv_context), ctypes.POINTER(struct_ibv_cq_init_attr_ex)),
  ),
  ...
  (
    "create_srq_ex",
    ctypes.CFUNCTYPE(ctypes.POINTER(struct_ibv_srq), ctypes.POINTER(struct_ibv_context), ctypes.POINTER(struct_ibv_srq_init_attr_ex)),
  ),
