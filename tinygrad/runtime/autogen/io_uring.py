...
struct_io_uring_sqe._anonymous_ = (
  "_0",
  "_1",
  "_2",
  "_3",
...
try:
  ...
  io_uring_opcode_supported.argtypes = [
    ctypes.POINTER(struct_io_uring_probe),
    ctypes.c_int32,
  ]
except AttributeError:
  pass
...
try:
  ...
  io_uring_queue_init_mem.argtypes = [
    ctypes.c_uint32,
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_params),
    ctypes.POINTER(None),
    size_t,
  ]
except AttributeError:
...
try:
  ...
  io_uring_queue_init_params.argtypes = [
    ctypes.c_uint32,
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_params),
  ]
...
try:
  ...
  io_uring_peek_batch_cqe.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(ctypes.POINTER(struct_io_uring_cqe)),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
...
try:
  ...
  io_uring_wait_cqes.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(ctypes.POINTER(struct_io_uring_cqe)),
    ctypes.c_uint32,
    ctypes.POINTER(struct___kernel_timespec),
    ctypes.POINTER(struct_c__SA___sigset_t),
  ]
except AttributeError:
  pass
try:
  ...
  io_uring_wait_cqe_timeout.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(ctypes.POINTER(struct_io_uring_cqe)),
    ctypes.POINTER(struct___kernel_timespec),
  ]
...
try:
  ...
  io_uring_submit_and_wait.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  io_uring_submit_and_wait_timeout = _libraries[
    "FIXME_STUB"
  ].io_uring_submit_and_wait_timeout
  io_uring_submit_and_wait_timeout.restype = ctypes.c_int32
  io_uring_submit_and_wait_timeout.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(ctypes.POINTER(struct_io_uring_cqe)),
    ctypes.c_uint32,
    ctypes.POINTER(struct___kernel_timespec),
...
try:
  ...
  io_uring_register_buffers.argtypes = [
    ctypes.POINTER(struct_io_uring),
...
try:
  ...
  io_uring_register_files.argtypes = [
    ctypes.POINTER(struct_io_uring),
...
try:
  ...
  pass
try:
  io_uring_register_files_update = _libraries[
    "FIXME_STUB"
  ].io_uring_register_files_update
  io_uring_register_files_update.restype = ctypes.c_int32
  io_uring_register_files_update.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.c_uint32,
    ctypes.POINTER(ctypes.c_int32),
    ctypes.c_uint32,
...
try:
  ...
  io_uring_register_eventfd.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  ...
  io_uring_register_probe.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_probe),
    ctypes.c_uint32,
  ]
  ...
  pass
try:
  io_uring_register_personality = _libraries[
    "FIXME_STUB"
...
try:
  io_uring_register_restrictions = _libraries[
    "FIXME_STUB"
  ].io_uring_register_restrictions
  io_uring_register_restrictions.restype = ctypes.c_int32
  io_uring_register_restrictions.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_restriction),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
...
try:
  ...
  io_uring_register_iowq_aff.argtypes = [
    ctypes.POINTER(struct_io_uring),
    size_t,
    ctypes.POINTER(struct_c__SA_cpu_set_t),
  ]
except AttributeError:
  pass
try:
  io_uring_unregister_iowq_aff = _libraries[
    "FIXME_STUB"
...
try:
  ...
  io_uring_register_buf_ring.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_buf_reg),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  io_uring_unregister_buf_ring = _libraries[
    "FIXME_STUB"
  ].io_uring_unregister_buf_ring
  io_uring_unregister_buf_ring.restype = ctypes.c_int32
  io_uring_unregister_buf_ring.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  io_uring_register_sync_cancel = _libraries[
    "FIXME_STUB"
  ].io_uring_register_sync_cancel
  io_uring_register_sync_cancel.restype = ctypes.c_int32
  io_uring_register_sync_cancel.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_sync_cancel_reg),
  ]
except AttributeError:
  pass
try:
  io_uring_register_file_alloc_range = _libraries[
    "FIXME_STUB"
  ].io_uring_register_file_alloc_range
  io_uring_register_file_alloc_range.restype = ctypes.c_int32
  io_uring_register_file_alloc_range.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.c_uint32,
    ctypes.c_uint32,
  ]
...
try:
  ...
  pass
try:
  io_uring_submit_and_get_events = _libraries[
    "FIXME_STUB"
...
try:
  ...
  io_uring_setup_buf_ring.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.c_uint32,
    ctypes.c_int32,
    ctypes.c_uint32,
...
try:
  ...
  io_uring_free_buf_ring.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_buf_ring),
    ctypes.c_uint32,
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  ...
  io_uring_cqe_seen.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_cqe),
  ]
except AttributeError:
  pass
try:
  ...
  io_uring_sqe_set_data.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
...
try:
  ...
  io_uring_sqe_set_flags.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  __io_uring_set_target_fixed_file = _libraries[
    "FIXME_STUB"
  ].__io_uring_set_target_fixed_file
  __io_uring_set_target_fixed_file.restype = None
  __io_uring_set_target_fixed_file.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  io_uring_prep_read_fixed.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(None),
    ctypes.c_uint32,
...
try:
  ...
  io_uring_prep_writev2.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_iovec),
    ctypes.c_uint32,
...
try:
  ...
  io_uring_prep_write_fixed.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(None),
    ctypes.c_uint32,
...
try:
  ...
  io_uring_prep_recvmsg.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_msghdr),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  io_uring_prep_recvmsg_multishot = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_recvmsg_multishot
  io_uring_prep_recvmsg_multishot.restype = None
  io_uring_prep_recvmsg_multishot.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_msghdr),
    ctypes.c_uint32,
...
try:
  ...
  io_uring_prep_sendmsg.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_msghdr),
    ctypes.c_uint32,
...
try:
  ...
  io_uring_prep_poll_add.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_uint32,
  ]
  ...
  pass
try:
  io_uring_prep_poll_multishot = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_poll_multishot
  io_uring_prep_poll_multishot.restype = None
  io_uring_prep_poll_multishot.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_uint32,
  ]
...
try:
  ...
  io_uring_prep_poll_update.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    __u64,
    __u64,
    ctypes.c_uint32,
...
try:
  ...
  io_uring_prep_timeout.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(struct___kernel_timespec),
    ctypes.c_uint32,
    ctypes.c_uint32,
  ...
  pass
try:
  io_uring_prep_timeout_remove = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_timeout_remove
  io_uring_prep_timeout_remove.restype = None
  io_uring_prep_timeout_remove.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    __u64,
    ctypes.c_uint32,
  ]
  ...
  pass
try:
  io_uring_prep_timeout_update = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_timeout_update
  io_uring_prep_timeout_update.restype = None
  io_uring_prep_timeout_update.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(struct___kernel_timespec),
    __u64,
    ctypes.c_uint32,
...
try:
  ...
  io_uring_prep_accept.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_sockaddr),
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  ...
  io_uring_prep_accept_direct.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_sockaddr),
    ctypes.POINTER(ctypes.c_uint32),
  ...
  pass
try:
  io_uring_prep_multishot_accept = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_multishot_accept
  io_uring_prep_multishot_accept.restype = None
  io_uring_prep_multishot_accept.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_sockaddr),
    ctypes.POINTER(ctypes.c_uint32),
  ...
  pass
try:
  io_uring_prep_multishot_accept_direct = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_multishot_accept_direct
  io_uring_prep_multishot_accept_direct.restype = None
  io_uring_prep_multishot_accept_direct.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_sockaddr),
    ctypes.POINTER(ctypes.c_uint32),
...
try:
  ...
  io_uring_prep_cancel64.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    __u64,
    ctypes.c_int32,
  ]
...
try:
  ...
  io_uring_prep_cancel_fd.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_uint32,
  ]
...
try:
  ...
  io_uring_prep_link_timeout.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(struct___kernel_timespec),
    ctypes.c_uint32,
  ]
...
try:
  ...
  io_uring_prep_connect.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_sockaddr),
    socklen_t,
...
try:
  ...
  io_uring_prep_files_update.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(ctypes.c_int32),
    ctypes.c_uint32,
    ctypes.c_int32,
...
try:
  ...
  io_uring_prep_fallocate.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
    __u64,
...
try:
  ...
  io_uring_prep_openat_direct.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
    ctypes.c_int32,
...
try:
  ...
  io_uring_prep_close_direct.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  io_uring_prep_fadvise.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    __u64,
    off_t,
...
try:
  ...
  io_uring_prep_madvise.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(None),
    off_t,
    ctypes.c_int32,
...
try:
  ...
  io_uring_prep_send_set_addr.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(struct_sockaddr),
    __u16,
  ]
...
try:
  ...
  io_uring_prep_send_zc.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(None),
    size_t,
...
try:
  ...
  io_uring_prep_send_zc_fixed.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(None),
    size_t,
...
try:
  ...
  io_uring_prep_sendmsg_zc.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(struct_msghdr),
    ctypes.c_uint32,
...
try:
  ...
  pass
try:
  io_uring_prep_recv_multishot = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_recv_multishot
  io_uring_prep_recv_multishot.restype = None
  io_uring_prep_recv_multishot.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(None),
    size_t,
...
try:
  ...
  io_uring_recvmsg_validate.argtypes = [
    ctypes.POINTER(None),
    ctypes.c_int32,
    ctypes.POINTER(struct_msghdr),
  ]
...
try:
  io_uring_recvmsg_cmsg_firsthdr = _libraries[
    "FIXME_STUB"
  ].io_uring_recvmsg_cmsg_firsthdr
  io_uring_recvmsg_cmsg_firsthdr.restype = ctypes.POINTER(struct_cmsghdr)
  io_uring_recvmsg_cmsg_firsthdr.argtypes = [
    ctypes.POINTER(struct_io_uring_recvmsg_out),
    ctypes.POINTER(struct_msghdr),
  ]
except AttributeError:
  pass
try:
  io_uring_recvmsg_cmsg_nexthdr = _libraries[
    "FIXME_STUB"
  ].io_uring_recvmsg_cmsg_nexthdr
  io_uring_recvmsg_cmsg_nexthdr.restype = ctypes.POINTER(struct_cmsghdr)
  io_uring_recvmsg_cmsg_nexthdr.argtypes = [
    ctypes.POINTER(struct_io_uring_recvmsg_out),
    ctypes.POINTER(struct_msghdr),
    ctypes.POINTER(struct_cmsghdr),
  ]
except AttributeError:
  pass
try:
  ...
  io_uring_recvmsg_payload.argtypes = [
    ctypes.POINTER(struct_io_uring_recvmsg_out),
    ctypes.POINTER(struct_msghdr),
  ]
except AttributeError:
...
try:
  ...
  io_uring_prep_openat2.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(struct_open_how),
  ]
except AttributeError:
  pass
try:
  io_uring_prep_openat2_direct = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_openat2_direct
  io_uring_prep_openat2_direct.restype = None
  io_uring_prep_openat2_direct.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(struct_open_how),
...
try:
  ...
  io_uring_prep_epoll_ctl.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
    ctypes.c_int32,
    ctypes.POINTER(struct_epoll_event),
  ]
except AttributeError:
  pass
try:
  io_uring_prep_provide_buffers = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_provide_buffers
  io_uring_prep_provide_buffers.restype = None
  io_uring_prep_provide_buffers.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(None),
    ctypes.c_int32,
    ctypes.c_int32,
  ...
  pass
try:
  io_uring_prep_remove_buffers = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_remove_buffers
  io_uring_prep_remove_buffers.restype = None
  io_uring_prep_remove_buffers.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
  ]
...
try:
  ...
  io_uring_prep_shutdown.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
  ]
...
try:
  ...
  io_uring_prep_unlinkat.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
    ctypes.c_int32,
...
try:
  ...
  io_uring_prep_renameat.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
    ctypes.c_int32,
...
try:
  ...
  pass
try:
  io_uring_prep_sync_file_range = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_sync_file_range
  io_uring_prep_sync_file_range.restype = None
  io_uring_prep_sync_file_range.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_uint32,
    __u64,
...
try:
  ...
  io_uring_prep_mkdirat.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
    mode_t,
...
try:
  ...
  io_uring_prep_symlinkat.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(ctypes.c_char),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
...
try:
  ...
  io_uring_prep_symlink.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
  ]
...
try:
  ...
  pass
try:
  io_uring_prep_msg_ring_cqe_flags = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_msg_ring_cqe_flags
  io_uring_prep_msg_ring_cqe_flags.restype = None
  io_uring_prep_msg_ring_cqe_flags.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_uint32,
    __u64,
...
try:
  ...
  io_uring_prep_msg_ring.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_uint32,
    __u64,
...
try:
  ...
  io_uring_prep_msg_ring_fd.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
    ctypes.c_int32,
  ...
  pass
try:
  io_uring_prep_msg_ring_fd_alloc = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_msg_ring_fd_alloc
  io_uring_prep_msg_ring_fd_alloc.restype = None
  io_uring_prep_msg_ring_fd_alloc.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
    __u64,
...
try:
  ...
  io_uring_prep_getxattr.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
...
try:
  ...
  io_uring_prep_setxattr.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
...
try:
  ...
  io_uring_prep_fgetxattr.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
...
try:
  ...
  io_uring_prep_fsetxattr.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
...
try:
  ...
  io_uring_prep_socket_direct.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
    ctypes.c_int32,
  ...
  pass
try:
  io_uring_prep_socket_direct_alloc = _libraries[
    "FIXME_STUB"
  ].io_uring_prep_socket_direct_alloc
  io_uring_prep_socket_direct_alloc.restype = None
  io_uring_prep_socket_direct_alloc.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
    ctypes.c_int32,
...
try:
  ...
  io_uring_prep_cmd_sock.argtypes = [
    ctypes.POINTER(struct_io_uring_sqe),
    ctypes.c_int32,
    ctypes.c_int32,
    ctypes.c_int32,
...
try:
  ...
  io_uring_cq_eventfd_toggle.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  io_uring_buf_ring_add.argtypes = [
    ctypes.POINTER(struct_io_uring_buf_ring),
    ctypes.POINTER(None),
    ctypes.c_uint32,
    ctypes.c_uint16,
...
try:
  ...
  io_uring_buf_ring_advance.argtypes = [
    ctypes.POINTER(struct_io_uring_buf_ring),
    ctypes.c_int32,
  ]
except AttributeError:
  pass
try:
  __io_uring_buf_ring_cq_advance = _libraries[
    "FIXME_STUB"
  ].__io_uring_buf_ring_cq_advance
  __io_uring_buf_ring_cq_advance.restype = None
  __io_uring_buf_ring_cq_advance.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_buf_ring),
    ctypes.c_int32,
    ctypes.c_int32,
  ...
  pass
try:
  io_uring_buf_ring_cq_advance = _libraries[
    "FIXME_STUB"
  ].io_uring_buf_ring_cq_advance
  io_uring_buf_ring_cq_advance.restype = None
  io_uring_buf_ring_cq_advance.argtypes = [
    ctypes.POINTER(struct_io_uring),
    ctypes.POINTER(struct_io_uring_buf_ring),
    ctypes.c_int32,
  ]
...
try:
  ...
  io_uring_mlock_size_params.argtypes = [
    ctypes.c_uint32,
    ctypes.POINTER(struct_io_uring_params),
  ]
except AttributeError:
...
__all__ = [
  ...
  "__u64",
  "_io_uring_get_sqe",
  "c__Ea_IORING_CQE_BUFFER_SHIFT",
  "c__Ea_IORING_MSG_DATA",
  "c__Ea_IORING_REGISTER_BUFFERS",
  "c__Ea_IORING_RESTRICTION_REGISTER_OP",
  "c__Ea_IOSQE_FIXED_FILE_BIT",
  "c__Ea_IOU_PBUF_RING_MMAP",
  "c__Ea_IO_WQ_BOUND",
  "c__Ea_SOCKET_URING_OP_SIOCINQ",
  "int64_t",
  ...
  "socklen_t",
  "ssize_t",
  "struct___kernel_timespec",
  "struct_c__SA___sigset_t",
  "struct_c__SA_cpu_set_t",
  "struct_cmsghdr",
  "struct_epoll_event",
  ...
  "struct_io_uring",
  "struct_io_uring_buf",
  "struct_io_uring_buf_reg",
  "struct_io_uring_buf_ring",
  "struct_io_uring_buf_ring_0_0",
  "struct_io_uring_buf_status",
  "struct_io_uring_cq",
  "struct_io_uring_cqe",
  "struct_io_uring_file_index_range",
  "struct_io_uring_files_update",
  "struct_io_uring_getevents_arg",
  "struct_io_uring_params",
  "struct_io_uring_probe",
  "struct_io_uring_probe_op",
  "struct_io_uring_recvmsg_out",
  "struct_io_uring_restriction",
  "struct_io_uring_rsrc_register",
  "struct_io_uring_rsrc_update",
  "struct_io_uring_rsrc_update2",
  "struct_io_uring_sq",
  "struct_io_uring_sqe",
  "struct_io_uring_sqe_0_0",
  "struct_io_uring_sqe_4_0",
  "struct_io_uring_sqe_5_0",
  "struct_io_uring_sync_cancel_reg",
  "struct_iovec",
  "struct_msghdr",
  "struct_open_how",
  "struct_sockaddr",
  "struct_statx",
  "union_io_uring_buf_ring_0",
  "union_io_uring_restriction_0",
  "union_io_uring_sqe_0",
  "union_io_uring_sqe_1",
  "union_io_uring_sqe_2",
  "union_io_uring_sqe_3",
  "union_io_uring_sqe_4",
