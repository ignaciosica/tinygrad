...
AMDKFD_IOC_AVAILABLE_MEMORY = AMDKFD_IOWR(
  0x23, struct_kfd_ioctl_get_available_memory_args
)  # macro (from list)
...
AMDKFD_IOC_DBG_REGISTER_DEPRECATED = AMDKFD_IOW(
...
AMDKFD_IOC_DBG_UNREGISTER_DEPRECATED = AMDKFD_IOW(
...
AMDKFD_IOC_DBG_ADDRESS_WATCH_DEPRECATED = AMDKFD_IOW(
...
AMDKFD_IOC_DBG_WAVE_CONTROL_DEPRECATED = AMDKFD_IOW(
...
AMDKFD_IOC_EXPORT_DMABUF = AMDKFD_IOWR(
  0x24, struct_kfd_ioctl_export_dmabuf_args
)  # macro (from list)
...
AMDKFD_IOC_CRIU_OP = AMDKFD_IOWR(
  0x22, struct_kfd_ioctl_criu_args
)  # macro (from list)
...
KFD_EC_MASK_PROCESS = KFD_EC_MASK(EC_PROCESS_RUNTIME) | KFD_EC_MASK(
...
def KFD_DBG_EC_TYPE_IS_QUEUE(ecode):  # macro
  return KFD_DBG_EC_IS_VALID(ecode) and not not (
    KFD_EC_MASK(ecode)
    & (
      KFD_EC_MASK(EC_QUEUE_WAVE_ABORT)
      | KFD_EC_MASK(EC_QUEUE_WAVE_TRAP)
...
AMDKFD_IOC_RUNTIME_ENABLE = AMDKFD_IOWR(
  0x25, struct_kfd_ioctl_runtime_enable_args
)  # macro (from list)
...
AMDKFD_IOC_DBG_TRAP = AMDKFD_IOWR(
  0x26, struct_kfd_ioctl_dbg_trap_args
)  # macro (from list)
__all__ = [
  "AMDKFD_COMMAND_END",
  ...
  "_IOWR",
  "kfd_criu_op",
  "kfd_dbg_runtime_state",
  "kfd_dbg_trap_address_watch_mode",
  "kfd_dbg_trap_exception_code",
  "kfd_dbg_trap_flags",
  "kfd_dbg_trap_mask",
  "kfd_dbg_trap_operations",
  "kfd_dbg_trap_override_mode",
  ...
  "struct_kfd_criu_bo_bucket",
  "struct_kfd_criu_device_bucket",
  "struct_kfd_dbg_device_info_entry",
  ...
  "struct_kfd_queue_snapshot_entry",
  "struct_kfd_runtime_info",
  "union_kfd_event_data_0",
  "union_kfd_ioctl_dbg_trap_args_0",
]
