...
_libraries["libusb"] = (
  None
  if (lib_path := os.getenv("LIBUSB_PATH", ctypes.util.find_library("usb-1.0")))
  is None
  else ctypes.CDLL(lib_path)
)  #  ctypes.CDLL('libusb')
...
struct_libusb_bos_descriptor._fields_ = [
  ...
  (
    "dev_capability",
    ctypes.POINTER(struct_libusb_bos_dev_capability_descriptor) * 0,
  ),
]
...
libusb_transfer_cb_fn = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_libusb_transfer)
)
...
libusb_log_cb = ctypes.CFUNCTYPE(
  None,
...
try:
  ...
  libusb_get_device_list.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    ctypes.POINTER(ctypes.POINTER(ctypes.POINTER(struct_libusb_device))),
  ]
except AttributeError:
  pass
try:
  ...
  libusb_free_device_list.argtypes = [
    ctypes.POINTER(ctypes.POINTER(struct_libusb_device)),
    ctypes.c_int32,
  ]
except AttributeError:
  pass
...
try:
  ...
  libusb_get_configuration.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
...
try:
  ...
  libusb_get_device_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_device),
    ctypes.POINTER(struct_libusb_device_descriptor),
  ]
except AttributeError:
  pass
try:
  libusb_get_active_config_descriptor = _libraries[
    "libusb"
  ].libusb_get_active_config_descriptor
  libusb_get_active_config_descriptor.restype = ctypes.c_int32
  libusb_get_active_config_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_device),
    ctypes.POINTER(ctypes.POINTER(struct_libusb_config_descriptor)),
  ]
except AttributeError:
  pass
...
try:
  ...
  pass
try:
  libusb_get_config_descriptor_by_value = _libraries[
    "libusb"
...
try:
  ...
  libusb_free_config_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_config_descriptor)
  ]
except AttributeError:
  pass
try:
  libusb_get_ss_endpoint_companion_descriptor = _libraries[
    "libusb"
  ].libusb_get_ss_endpoint_companion_descriptor
  libusb_get_ss_endpoint_companion_descriptor.restype = ctypes.c_int32
  libusb_get_ss_endpoint_companion_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    ctypes.POINTER(struct_libusb_endpoint_descriptor),
    ctypes.POINTER(ctypes.POINTER(struct_libusb_ss_endpoint_companion_descriptor)),
  ]
except AttributeError:
  pass
try:
  libusb_free_ss_endpoint_companion_descriptor = _libraries[
    "libusb"
  ].libusb_free_ss_endpoint_companion_descriptor
  libusb_free_ss_endpoint_companion_descriptor.restype = None
  libusb_free_ss_endpoint_companion_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_ss_endpoint_companion_descriptor)
  ]
except AttributeError:
  pass
try:
  ...
  libusb_get_bos_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.POINTER(ctypes.POINTER(struct_libusb_bos_descriptor)),
  ]
except AttributeError:
  pass
try:
  ...
  libusb_free_bos_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_bos_descriptor)
  ]
except AttributeError:
  pass
try:
  libusb_get_usb_2_0_extension_descriptor = _libraries[
    "libusb"
  ].libusb_get_usb_2_0_extension_descriptor
  libusb_get_usb_2_0_extension_descriptor.restype = ctypes.c_int32
  libusb_get_usb_2_0_extension_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_context),
  ...
  pass
try:
  libusb_free_usb_2_0_extension_descriptor = _libraries[
    "libusb"
  ].libusb_free_usb_2_0_extension_descriptor
  libusb_free_usb_2_0_extension_descriptor.restype = None
  libusb_free_usb_2_0_extension_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_usb_2_0_extension_descriptor)
  ]
except AttributeError:
  pass
try:
  libusb_get_ss_usb_device_capability_descriptor = _libraries[
    "libusb"
  ].libusb_get_ss_usb_device_capability_descriptor
  libusb_get_ss_usb_device_capability_descriptor.restype = ctypes.c_int32
  libusb_get_ss_usb_device_capability_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    ctypes.POINTER(struct_libusb_bos_dev_capability_descriptor),
    ctypes.POINTER(
      ctypes.POINTER(struct_libusb_ss_usb_device_capability_descriptor)
    ),
  ]
except AttributeError:
  pass
try:
  libusb_free_ss_usb_device_capability_descriptor = _libraries[
    "libusb"
  ].libusb_free_ss_usb_device_capability_descriptor
  libusb_free_ss_usb_device_capability_descriptor.restype = None
  libusb_free_ss_usb_device_capability_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_ss_usb_device_capability_descriptor)
  ]
except AttributeError:
  pass
try:
  libusb_get_container_id_descriptor = _libraries[
    "libusb"
  ].libusb_get_container_id_descriptor
  libusb_get_container_id_descriptor.restype = ctypes.c_int32
  libusb_get_container_id_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    ctypes.POINTER(struct_libusb_bos_dev_capability_descriptor),
  ...
  pass
try:
  libusb_free_container_id_descriptor = _libraries[
    "libusb"
  ].libusb_free_container_id_descriptor
  libusb_free_container_id_descriptor.restype = None
  libusb_free_container_id_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_container_id_descriptor)
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  libusb_get_max_packet_size.argtypes = [
    ctypes.POINTER(struct_libusb_device),
    ctypes.c_ubyte,
  ]
except AttributeError:
  pass
try:
  libusb_get_max_iso_packet_size = _libraries[
    "libusb"
...
try:
  ...
  libusb_wrap_sys_device.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    intptr_t,
    ctypes.POINTER(ctypes.POINTER(struct_libusb_device_handle)),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  libusb_set_configuration.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  ...
  libusb_claim_interface.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  ...
  libusb_release_interface.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_int32,
  ]
except AttributeError:
  pass
try:
  libusb_open_device_with_vid_pid = _libraries[
    "libusb"
  ].libusb_open_device_with_vid_pid
  libusb_open_device_with_vid_pid.restype = ctypes.POINTER(
  ...
  pass
try:
  libusb_set_interface_alt_setting = _libraries[
    "libusb"
...
try:
  ...
  libusb_kernel_driver_active.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  ...
  libusb_detach_kernel_driver.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  ...
  libusb_attach_kernel_driver.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_int32,
  ]
except AttributeError:
  pass
try:
  libusb_set_auto_detach_kernel_driver = _libraries[
    "libusb"
  ...
  pass
try:
  libusb_control_transfer_get_data = _libraries[
    "libusb"
  ].libusb_control_transfer_get_data
  libusb_control_transfer_get_data.restype = ctypes.POINTER(ctypes.c_ubyte)
  libusb_control_transfer_get_data.argtypes = [
    ctypes.POINTER(struct_libusb_transfer)
  ]
except AttributeError:
  pass
try:
  libusb_control_transfer_get_setup = _libraries[
    "libusb"
  ].libusb_control_transfer_get_setup
  libusb_control_transfer_get_setup.restype = ctypes.POINTER(
    struct_libusb_control_setup
  )
  libusb_control_transfer_get_setup.argtypes = [
    ctypes.POINTER(struct_libusb_transfer)
  ]
except AttributeError:
  pass
try:
  ...
  libusb_fill_control_setup.argtypes = [
    ctypes.POINTER(ctypes.c_ubyte),
    uint8_t,
    uint8_t,
    uint16_t,
...
try:
  ...
  libusb_transfer_set_stream_id.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    uint32_t,
  ]
except AttributeError:
...
try:
  ...
  libusb_fill_control_transfer.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.POINTER(ctypes.c_ubyte),
...
try:
  ...
  libusb_fill_bulk_transfer.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_ubyte,
    ctypes.POINTER(ctypes.c_ubyte),
  ...
  pass
try:
  libusb_fill_bulk_stream_transfer = _libraries[
    "libusb"
  ].libusb_fill_bulk_stream_transfer
  libusb_fill_bulk_stream_transfer.restype = None
  libusb_fill_bulk_stream_transfer.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_ubyte,
    uint32_t,
  ...
  pass
try:
  libusb_fill_interrupt_transfer = _libraries[
    "libusb"
  ].libusb_fill_interrupt_transfer
  libusb_fill_interrupt_transfer.restype = None
  libusb_fill_interrupt_transfer.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_ubyte,
    ctypes.POINTER(ctypes.c_ubyte),
...
try:
  ...
  libusb_fill_iso_transfer.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_ubyte,
    ctypes.POINTER(ctypes.c_ubyte),
...
try:
  ...
  libusb_set_iso_packet_lengths.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  libusb_get_iso_packet_buffer.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  libusb_get_iso_packet_buffer_simple = _libraries[
    "libusb"
  ].libusb_get_iso_packet_buffer_simple
  libusb_get_iso_packet_buffer_simple.restype = ctypes.POINTER(ctypes.c_ubyte)
  libusb_get_iso_packet_buffer_simple.argtypes = [
    ctypes.POINTER(struct_libusb_transfer),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  libusb_control_transfer.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    uint8_t,
    uint8_t,
    uint16_t,
...
try:
  ...
  libusb_interrupt_transfer.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    ctypes.c_ubyte,
    ctypes.POINTER(ctypes.c_ubyte),
    ctypes.c_int32,
...
try:
  ...
  libusb_get_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    uint8_t,
    uint8_t,
    ctypes.POINTER(ctypes.c_ubyte),
...
try:
  ...
  libusb_get_string_descriptor.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    uint8_t,
    uint16_t,
    ctypes.POINTER(ctypes.c_ubyte),
  ...
  pass
try:
  libusb_get_string_descriptor_ascii = _libraries[
    "libusb"
  ].libusb_get_string_descriptor_ascii
  libusb_get_string_descriptor_ascii.restype = ctypes.c_int32
  libusb_get_string_descriptor_ascii.argtypes = [
    ctypes.POINTER(struct_libusb_device_handle),
    uint8_t,
    ctypes.POINTER(ctypes.c_ubyte),
    ctypes.c_int32,
...
try:
  ...
  pass
try:
  libusb_interrupt_event_handler = _libraries[
    "libusb"
...
try:
  ...
  libusb_wait_for_event.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    ctypes.POINTER(struct_timeval),
  ]
except AttributeError:
  pass
try:
  ...
  libusb_handle_events_timeout.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    ctypes.POINTER(struct_timeval),
  ]
except AttributeError:
  pass
try:
  libusb_handle_events_timeout_completed = _libraries[
    "libusb"
...
try:
  ...
  pass
try:
  libusb_handle_events_completed = _libraries[
    "libusb"
...
try:
  ...
  libusb_handle_events_locked.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    ctypes.POINTER(struct_timeval),
  ]
except AttributeError:
  pass
try:
  libusb_pollfds_handle_timeouts = _libraries[
    "libusb"
...
try:
  ...
  libusb_get_next_timeout.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    ctypes.POINTER(struct_timeval),
  ]
except AttributeError:
...
libusb_pollfd_added_cb = ctypes.CFUNCTYPE(
  None, ctypes.c_int32, ctypes.c_int16, ctypes.POINTER(None)
)
libusb_pollfd_removed_cb = ctypes.CFUNCTYPE(
  None, ctypes.c_int32, ctypes.POINTER(None)
)
try:
...
try:
  ...
  libusb_free_pollfds.argtypes = [
    ctypes.POINTER(ctypes.POINTER(struct_libusb_pollfd))
  ]
except AttributeError:
  pass
try:
  ...
  libusb_set_pollfd_notifiers.argtypes = [
    ctypes.POINTER(struct_libusb_context),
...
libusb_hotplug_callback_fn = ctypes.CFUNCTYPE(
  ctypes.c_int32,
  ctypes.POINTER(struct_libusb_context),
  ctypes.POINTER(struct_libusb_device),
  c__EA_libusb_hotplug_event,
  ctypes.POINTER(None),
)
try:
  libusb_hotplug_register_callback = _libraries[
    "libusb"
  ...
  pass
try:
  libusb_hotplug_deregister_callback = _libraries[
    "libusb"
...
try:
  ...
  libusb_hotplug_get_user_data.argtypes = [
    ctypes.POINTER(struct_libusb_context),
    libusb_hotplug_callback_handle,
  ]
except AttributeError:
...
__all__ = [
  ...
  "libusb_hotplug_event__enumvalues",
  "libusb_hotplug_flag",
  "libusb_hotplug_flag__enumvalues",
  ...
  "struct_libusb_container_id_descriptor",
  ...
  "struct_libusb_iso_packet_descriptor",
  "struct_libusb_pollfd",
