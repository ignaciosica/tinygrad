...
LLVMOpInfoCallback = ctypes.CFUNCTYPE(
  ctypes.c_int32, ctypes.POINTER(None), ctypes.c_uint64, ctypes.c_uint64, ctypes.c_uint64, ctypes.c_int32, ctypes.POINTER(None)
)
...
LLVMMemoryManagerAllocateCodeSectionCallback = ctypes.CFUNCTYPE(
  ctypes.POINTER(ctypes.c_ubyte), ctypes.POINTER(None), ctypes.c_uint64, ctypes.c_uint32, ctypes.c_uint32, ctypes.POINTER(ctypes.c_char)
)
...
LLVMOrcMaterializationUnitDiscardFunction = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(None), ctypes.POINTER(struct_LLVMOrcOpaqueJITDylib), ctypes.POINTER(struct_LLVMOrcOpaqueSymbolStringPoolEntry)
)
...
LLVMOrcGenericIRModuleOperationFunction = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_LLVMOpaqueError), ctypes.POINTER(None), ctypes.POINTER(struct_LLVMOpaqueModule)
)
...
try:
  ...
  LLVMAddInternalizePassWithMustPreservePredicate.argtypes = [
    LLVMPassManagerRef,
    ctypes.POINTER(None),
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_LLVMOpaqueValue), ctypes.POINTER(None)),
  ]
except AttributeError:
  pass
try:
