...
PATHS_TO_TRY = [
  (BASE := os.getenv("MESA_PATH", f"/usr{'/local/' if helpers.OSX else '/'}lib"))
  + "/libtinymesa_cpu"
  + (EXT := ".dylib" if helpers.OSX else ".so"),
...
_libraries["FIXME_STUB"] = (
  FunctionFactoryStub()
)  #  (dll := _try_dlopen_tinymesa_cpu())
...
try:
  ...
  blob_init_fixed.argtypes = [
    ctypes.POINTER(struct_blob),
    ctypes.POINTER(None),
    size_t,
  ]
except AttributeError:
...
try:
  ...
  blob_finish_get_buffer.argtypes = [
    ctypes.POINTER(struct_blob),
...
try:
  ...
  blob_reader_init.argtypes = [
    ctypes.POINTER(struct_blob_reader),
    ctypes.POINTER(None),
    size_t,
  ]
except AttributeError:
...
try:
  glsl_type_singleton_init_or_ref = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  glsl_type_singleton_decref = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  encode_type_to_blob.argtypes = [
    ctypes.POINTER(struct_blob),
    ctypes.POINTER(struct_glsl_type),
  ]
except AttributeError:
  pass
try:
  ...
  pass
glsl_type_size_align_func = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_glsl_type),
...
try:
  ...
  pass
try:
  glsl_apply_signedness_to_base_type = _libraries[
    "libtinymesa_cpu.so"
...
try:
  glsl_get_sampler_dim_coordinate_components = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  glsl_type_is_integer_16_32_64 = _libraries[
    "FIXME_STUB"
  ].glsl_type_is_integer_16_32_64
...
try:
  ...
  pass
try:
  glsl_type_is_array_of_arrays = _libraries[
    "FIXME_STUB"
  ].glsl_type_is_array_of_arrays
...
try:
  ...
  pass
try:
  glsl_type_is_vector_or_scalar = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  glsl_type_is_array_or_matrix = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_type_is_array_or_matrix
...
try:
  ...
  pass
try:
  glsl_matrix_type_is_row_major = _libraries[
    "FIXME_STUB"
  ].glsl_matrix_type_is_row_major
...
try:
  ...
  pass
try:
  glsl_without_array_or_matrix = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  glsl_get_cmat_description = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  glsl_contains_subroutine = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_contains_subroutine
...
try:
  ...
  pass
try:
  glsl_get_sampler_result_type = _libraries[
    "FIXME_STUB"
  ...
  pass
try:
  glsl_get_sampler_coordinate_components = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_sampler_coordinate_components
  glsl_get_sampler_coordinate_components.restype = ctypes.c_int32
  glsl_get_sampler_coordinate_components.argtypes = [
    ctypes.POINTER(struct_glsl_type)
  ]
except AttributeError:
  pass
try:
  glsl_type_compare_no_precision = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_type_compare_no_precision
  glsl_type_compare_no_precision.restype = ctypes.c_bool
  glsl_type_compare_no_precision.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.POINTER(struct_glsl_type),
  ]
except AttributeError:
...
try:
  ...
  glsl_get_struct_field.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  glsl_get_struct_field_data = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_struct_field_data
  glsl_get_struct_field_data.restype = ctypes.POINTER(struct_glsl_struct_field)
  glsl_get_struct_field_data.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  glsl_get_struct_location_offset = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_struct_location_offset
  glsl_get_struct_location_offset.restype = ctypes.c_uint32
  glsl_get_struct_location_offset.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  glsl_get_struct_elem_name.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  glsl_simple_explicit_type = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_simple_explicit_type
  glsl_simple_explicit_type.restype = ctypes.POINTER(struct_glsl_type)
  glsl_simple_explicit_type.argtypes = [
    ctypes.c_uint32,
    ctypes.c_uint32,
    ctypes.c_uint32,
    ctypes.c_uint32,
...
try:
  ...
  pass
try:
  glsl_bare_shadow_sampler_type = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  glsl_struct_type_with_explicit_alignment = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_struct_type_with_explicit_alignment
  glsl_struct_type_with_explicit_alignment.restype = ctypes.POINTER(struct_glsl_type)
  glsl_struct_type_with_explicit_alignment.argtypes = [
    ctypes.POINTER(struct_glsl_struct_field),
    ctypes.c_uint32,
    ctypes.POINTER(ctypes.c_char),
    ctypes.c_bool,
    ctypes.c_uint32,
...
try:
  ...
  pass
try:
  glsl_type_replace_vec3_with_vec4 = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_type_replace_vec3_with_vec4
...
try:
  ...
  glsl_explicit_matrix_type.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_uint32,
    ctypes.c_bool,
  ]
...
try:
  ...
  pass
try:
  glsl_texture_type_to_sampler = _libraries[
    "FIXME_STUB"
  ].glsl_texture_type_to_sampler
  glsl_texture_type_to_sampler.restype = ctypes.POINTER(struct_glsl_type)
  glsl_texture_type_to_sampler.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
try:
  glsl_sampler_type_to_texture = _libraries[
    "FIXME_STUB"
  ...
  pass
try:
  glsl_replace_vector_type = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_replace_vector_type
  glsl_replace_vector_type.restype = ctypes.POINTER(struct_glsl_type)
  glsl_replace_vector_type.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  glsl_count_vec4_slots.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_bool,
    ctypes.c_bool,
  ]
...
try:
  ...
  pass
try:
  glsl_get_component_slots = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  glsl_get_component_slots_aligned = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_component_slots_aligned
  glsl_get_component_slots_aligned.restype = ctypes.c_uint32
  glsl_get_component_slots_aligned.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  glsl_type_uniform_locations = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_type_uniform_locations
...
try:
  ...
  glsl_count_attribute_slots.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  glsl_get_cl_type_size_align = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_cl_type_size_align
  glsl_get_cl_type_size_align.restype = None
  glsl_get_cl_type_size_align.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.POINTER(ctypes.c_uint32),
  ]
  ...
  pass
try:
  glsl_get_internal_ifc_packing = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_internal_ifc_packing
  glsl_get_internal_ifc_packing.restype = glsl_interface_packing
  glsl_get_internal_ifc_packing.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  glsl_get_std430_array_stride = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_std430_array_stride
  glsl_get_std430_array_stride.restype = ctypes.c_uint32
  glsl_get_std430_array_stride.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  glsl_get_explicit_std140_type = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_explicit_std140_type
  glsl_get_explicit_std140_type.restype = ctypes.POINTER(struct_glsl_type)
  glsl_get_explicit_std140_type.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
try:
  glsl_get_explicit_std430_type = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_explicit_std430_type
  glsl_get_explicit_std430_type.restype = ctypes.POINTER(struct_glsl_type)
  glsl_get_explicit_std430_type.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
try:
  glsl_get_explicit_interface_type = _libraries[
    "FIXME_STUB"
  ].glsl_get_explicit_interface_type
  glsl_get_explicit_interface_type.restype = ctypes.POINTER(struct_glsl_type)
  glsl_get_explicit_interface_type.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
try:
  glsl_size_align_handle_array_and_structs = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_size_align_handle_array_and_structs
  glsl_size_align_handle_array_and_structs.restype = None
  glsl_size_align_handle_array_and_structs.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    glsl_type_size_align_func,
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.POINTER(ctypes.c_uint32),
  ...
  pass
try:
  glsl_get_natural_size_align_bytes = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_natural_size_align_bytes
  glsl_get_natural_size_align_bytes.restype = None
  glsl_get_natural_size_align_bytes.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.POINTER(ctypes.c_uint32),
  ]
  ...
  pass
try:
  glsl_get_word_size_align_bytes = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_word_size_align_bytes
  glsl_get_word_size_align_bytes.restype = None
  glsl_get_word_size_align_bytes.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.POINTER(ctypes.c_uint32),
  ]
  ...
  pass
try:
  glsl_get_vec4_size_align_bytes = _libraries[
    "libtinymesa_cpu.so"
  ].glsl_get_vec4_size_align_bytes
  glsl_get_vec4_size_align_bytes.restype = None
  glsl_get_vec4_size_align_bytes.argtypes = [
    ctypes.POINTER(struct_glsl_type),
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.POINTER(ctypes.c_uint32),
  ]
...
try:
  ...
  ralloc_set_destructor.argtypes = [
    ctypes.POINTER(None),
...
try:
  ...
  ralloc_asprintf_append.argtypes = [
    ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),
    ctypes.POINTER(ctypes.c_char),
  ]
except AttributeError:
...
try:
  ...
  ralloc_vasprintf_append.argtypes = [
    ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),
    ctypes.POINTER(ctypes.c_char),
    va_list,
  ]
...
try:
  ...
  pass
try:
  linear_context_with_opts = _libraries[
    "libtinymesa_cpu.so"
  ].linear_context_with_opts
  linear_context_with_opts.restype = ctypes.POINTER(struct_linear_ctx)
  linear_context_with_opts.argtypes = [
    ctypes.POINTER(None),
    ctypes.POINTER(struct_c__SA_linear_opts),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  pass
try:
  ralloc_steal_linear_context = _libraries[
    "libtinymesa_cpu.so"
  ].ralloc_steal_linear_context
  ralloc_steal_linear_context.restype = None
  ralloc_steal_linear_context.argtypes = [
    ctypes.POINTER(None),
    ctypes.POINTER(struct_linear_ctx),
  ]
except AttributeError:
  pass
try:
  ralloc_parent_of_linear_context = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  linear_alloc_child_array = _libraries[
    "libtinymesa_cpu.so"
  ].linear_alloc_child_array
  linear_alloc_child_array.restype = ctypes.POINTER(None)
  linear_alloc_child_array.argtypes = [
    ctypes.POINTER(struct_linear_ctx),
    size_t,
    ctypes.c_uint32,
  ]
  ...
  pass
try:
  linear_zalloc_child_array = _libraries[
    "libtinymesa_cpu.so"
  ].linear_zalloc_child_array
  linear_zalloc_child_array.restype = ctypes.POINTER(None)
  linear_zalloc_child_array.argtypes = [
    ctypes.POINTER(struct_linear_ctx),
    size_t,
    ctypes.c_uint32,
  ]
...
try:
  ...
  linear_asprintf_append.argtypes = [
    ctypes.POINTER(struct_linear_ctx),
    ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),
    ctypes.POINTER(ctypes.c_char),
  ]
...
try:
  ...
  linear_vasprintf_append.argtypes = [
    ctypes.POINTER(struct_linear_ctx),
    ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),
    ctypes.POINTER(ctypes.c_char),
    va_list,
...
struct_set._fields_ = [
  ...
  (
    "key_equals_function",
    ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(None), ctypes.POINTER(None)),
  ),
...
nir_instr_filter_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool, ctypes.POINTER(struct_nir_instr), ctypes.POINTER(None)
)
...
struct_nir_shader_compiler_options._fields_ = [
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.c_uint32,
      ctypes.POINTER(struct_nir_shader),
      ctypes.POINTER(struct_nir_shader),
    ),
  ),
  (
    "varying_estimate_instr_cost",
    ctypes.CFUNCTYPE(ctypes.c_uint32, ctypes.POINTER(struct_nir_instr)),
  ),
...
try:
  ...
  pass
try:
  nir_process_debug_variable = _libraries[
    "libtinymesa_cpu.so"
...
try:
  nir_const_value_for_raw_uint = _libraries[
    "FIXME_STUB"
...
try:
  ...
  pass
try:
  nir_const_value_for_float = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_const_value_as_float = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_src_set_parent_instr.argtypes = [
    ctypes.POINTER(struct_nir_src),
...
try:
  ...
  nir_src_set_parent_if.argtypes = [
    ctypes.POINTER(struct_nir_src),
    ctypes.POINTER(struct_nir_if),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  nir_is_same_comp_swizzle.argtypes = [
  ...
  pass
try:
  nir_is_sequential_comp_swizzle = _libraries[
    "FIXME_STUB"
  ].nir_is_sequential_comp_swizzle
  nir_is_sequential_comp_swizzle.restype = ctypes.c_bool
  nir_is_sequential_comp_swizzle.argtypes = [
    ctypes.POINTER(ctypes.c_ubyte),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  nir_get_nir_type_for_glsl_base_type = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_get_nir_type_for_glsl_type = _libraries[
    "FIXME_STUB"
  ...
  pass
try:
  nir_get_glsl_base_type_for_nir_type = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_is_float_control_inf_preserve = _libraries[
    "FIXME_STUB"
  ].nir_is_float_control_inf_preserve
  ...
  pass
try:
  nir_is_float_control_nan_preserve = _libraries[
    "FIXME_STUB"
...
try:
  ...
  pass
try:
  nir_has_any_rounding_mode_enabled = _libraries[
    "FIXME_STUB"
...
try:
  nir_op_infos = (struct_nir_op_info * 489).in_dll(
    _libraries["libtinymesa_cpu.so"], "nir_op_infos"
  )
...
try:
  nir_alu_instr_is_signed_zero_preserve = _libraries[
    "FIXME_STUB"
  ].nir_alu_instr_is_signed_zero_preserve
  nir_alu_instr_is_signed_zero_preserve.restype = ctypes.c_bool
  nir_alu_instr_is_signed_zero_preserve.argtypes = [
    ctypes.POINTER(struct_nir_alu_instr)
  ]
except AttributeError:
  pass
try:
  nir_alu_instr_is_inf_preserve = _libraries[
    "FIXME_STUB"
  ].nir_alu_instr_is_inf_preserve
  ...
  pass
try:
  nir_alu_instr_is_nan_preserve = _libraries[
    "FIXME_STUB"
...
try:
  ...
  nir_alu_src_copy.argtypes = [
    ctypes.POINTER(struct_nir_alu_src),
    ctypes.POINTER(struct_nir_alu_src),
  ]
except AttributeError:
  pass
try:
  nir_alu_instr_src_read_mask = _libraries[
    "libtinymesa_cpu.so"
  ].nir_alu_instr_src_read_mask
  nir_alu_instr_src_read_mask.restype = nir_component_mask_t
  nir_alu_instr_src_read_mask.argtypes = [
    ctypes.POINTER(struct_nir_alu_instr),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  nir_alu_instr_channel_used.argtypes = [
    ctypes.POINTER(struct_nir_alu_instr),
    ctypes.c_uint32,
    ctypes.c_uint32,
  ]
  ...
  pass
try:
  nir_alu_instr_is_comparison = _libraries[
    "libtinymesa_cpu.so"
  ].nir_alu_instr_is_comparison
...
try:
  ...
  pass
try:
  nir_alu_srcs_negative_equal_typed = _libraries[
    "libtinymesa_cpu.so"
  ].nir_alu_srcs_negative_equal_typed
  nir_alu_srcs_negative_equal_typed.restype = ctypes.c_bool
  nir_alu_srcs_negative_equal_typed.argtypes = [
    ctypes.POINTER(struct_nir_alu_instr),
    ctypes.POINTER(struct_nir_alu_instr),
    ctypes.c_uint32,
    ctypes.c_uint32,
...
struct_nir_deref_instr._anonymous_ = (
  "_0",
  "_1",
)
...
try:
  nir_deref_cast_is_trivial = _libraries[
    "libtinymesa_cpu.so"
  ].nir_deref_cast_is_trivial
...
try:
  ...
  nir_deref_mode_may_be.argtypes = [
    ctypes.POINTER(struct_nir_deref_instr),
    nir_variable_mode,
  ]
except AttributeError:
  pass
try:
  ...
  nir_deref_mode_must_be.argtypes = [
    ctypes.POINTER(struct_nir_deref_instr),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  nir_deref_mode_is_one_of.argtypes = [
    ctypes.POINTER(struct_nir_deref_instr),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  nir_deref_mode_is_in_set.argtypes = [
    ctypes.POINTER(struct_nir_deref_instr),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_deref_instr_get_variable = _libraries[
    "FIXME_STUB"
  ...
  pass
try:
  nir_deref_instr_has_indirect = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_deref_instr_remove_if_unused = _libraries[
    "libtinymesa_cpu.so"
  ].nir_deref_instr_remove_if_unused
  nir_deref_instr_remove_if_unused.restype = ctypes.c_bool
  nir_deref_instr_remove_if_unused.argtypes = [
    ctypes.POINTER(struct_nir_deref_instr)
  ]
except AttributeError:
  pass
try:
  nir_deref_instr_array_stride = _libraries[
    "libtinymesa_cpu.so"
  ].nir_deref_instr_array_stride
...
try:
  nir_intrinsic_index_names = (ctypes.POINTER(ctypes.c_char) * 75).in_dll(
    _libraries["libtinymesa_cpu.so"], "nir_intrinsic_index_names"
  )
except (AttributeError, ValueError):
  pass
...
try:
  ...
  nir_intrinsic_get_var.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
...
try:
  nir_instr_xfb_write_mask = _libraries[
    "libtinymesa_cpu.so"
  ].nir_instr_xfb_write_mask
...
try:
  nir_intrinsic_infos = (struct_nir_intrinsic_info * 732).in_dll(
    _libraries["libtinymesa_cpu.so"], "nir_intrinsic_infos"
  )
except (AttributeError, ValueError):
  pass
try:
  nir_intrinsic_src_components = _libraries[
    "libtinymesa_cpu.so"
  ].nir_intrinsic_src_components
  nir_intrinsic_src_components.restype = ctypes.c_uint32
  nir_intrinsic_src_components.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  nir_intrinsic_dest_components = _libraries[
    "libtinymesa_cpu.so"
  ].nir_intrinsic_dest_components
  nir_intrinsic_dest_components.restype = ctypes.c_uint32
  nir_intrinsic_dest_components.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr)
  ]
except AttributeError:
  pass
try:
  nir_intrinsic_instr_src_type = _libraries[
    "libtinymesa_cpu.so"
  ].nir_intrinsic_instr_src_type
  nir_intrinsic_instr_src_type.restype = nir_alu_type
  nir_intrinsic_instr_src_type.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  nir_intrinsic_instr_dest_type = _libraries[
    "libtinymesa_cpu.so"
  ].nir_intrinsic_instr_dest_type
  nir_intrinsic_instr_dest_type.restype = nir_alu_type
  nir_intrinsic_instr_dest_type.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr)
  ]
except AttributeError:
  pass
try:
  nir_intrinsic_copy_const_indices = _libraries[
    "libtinymesa_cpu.so"
  ].nir_intrinsic_copy_const_indices
  nir_intrinsic_copy_const_indices.restype = None
  nir_intrinsic_copy_const_indices.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
    ctypes.POINTER(struct_nir_intrinsic_instr),
  ]
except AttributeError:
...
try:
  ...
  nir_intrinsic_set_align.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
    ctypes.c_uint32,
    ctypes.c_uint32,
  ]
...
try:
  ...
  pass
try:
  nir_image_intrinsic_coord_components = _libraries[
    "libtinymesa_cpu.so"
  ].nir_image_intrinsic_coord_components
  nir_image_intrinsic_coord_components.restype = ctypes.c_uint32
  nir_image_intrinsic_coord_components.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr)
  ]
except AttributeError:
  pass
try:
  nir_rewrite_image_intrinsic = _libraries[
    "libtinymesa_cpu.so"
  ].nir_rewrite_image_intrinsic
  nir_rewrite_image_intrinsic.restype = None
  nir_rewrite_image_intrinsic.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
  ...
  pass
try:
  nir_intrinsic_can_reorder = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_intrinsic_has_semantic.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
...
try:
  nir_tex_instr_need_sampler = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_tex_instr_result_size = _libraries[
    "libtinymesa_cpu.so"
  ].nir_tex_instr_result_size
...
try:
  ...
  pass
try:
  nir_tex_instr_has_implicit_derivative = _libraries[
    "libtinymesa_cpu.so"
  ].nir_tex_instr_has_implicit_derivative
  nir_tex_instr_has_implicit_derivative.restype = ctypes.c_bool
  nir_tex_instr_has_implicit_derivative.argtypes = [
    ctypes.POINTER(struct_nir_tex_instr)
  ]
except AttributeError:
  pass
try:
  ...
  nir_tex_instr_src_type.argtypes = [
    ctypes.POINTER(struct_nir_tex_instr),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  nir_tex_instr_src_size.argtypes = [
    ctypes.POINTER(struct_nir_tex_instr),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  nir_tex_instr_src_index.argtypes = [
    ctypes.POINTER(struct_nir_tex_instr),
    nir_tex_src_type,
  ]
except AttributeError:
...
try:
  ...
  nir_tex_instr_add_src.argtypes = [
    ctypes.POINTER(struct_nir_tex_instr),
    nir_tex_src_type,
    ctypes.POINTER(struct_nir_def),
  ]
  ...
  pass
try:
  nir_tex_instr_remove_src = _libraries[
    "libtinymesa_cpu.so"
  ].nir_tex_instr_remove_src
  nir_tex_instr_remove_src.restype = None
  nir_tex_instr_remove_src.argtypes = [
    ctypes.POINTER(struct_nir_tex_instr),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  nir_phi_get_src_from_block.argtypes = [
    ctypes.POINTER(struct_nir_phi_instr),
    ctypes.POINTER(struct_nir_block),
  ]
except AttributeError:
  pass
...
try:
  ...
  pass
try:
  nir_block_ends_in_return_or_halt = _libraries[
    "FIXME_STUB"
...
try:
  ...
  pass
try:
  nir_loop_has_continue_construct = _libraries[
    "FIXME_STUB"
  ...
  pass
try:
  nir_loop_first_continue_block = _libraries[
    "FIXME_STUB"
  ].nir_loop_first_continue_block
  ...
  pass
try:
  nir_loop_last_continue_block = _libraries[
    "FIXME_STUB"
  ].nir_loop_last_continue_block
...
nir_intrin_filter_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool, ctypes.POINTER(struct_nir_intrinsic_instr), ctypes.POINTER(None)
)
nir_vectorize_cb = ctypes.CFUNCTYPE(
  ctypes.c_ubyte, ctypes.POINTER(struct_nir_instr), ctypes.POINTER(None)
)
nir_shader = struct_nir_shader
try:
  nir_foreach_function_with_impl_first = _libraries[
    "FIXME_STUB"
  ...
  pass
try:
  nir_foreach_function_with_impl_next = _libraries[
    "FIXME_STUB"
  ].nir_foreach_function_with_impl_next
  nir_foreach_function_with_impl_next.restype = ctypes.POINTER(
    struct_nir_function_impl
  )
  nir_foreach_function_with_impl_next.argtypes = [
    ctypes.POINTER(ctypes.POINTER(struct_nir_function))
  ]
except AttributeError:
  pass
try:
  ...
  pass
try:
  nir_shader_get_function_for_name = _libraries[
    "FIXME_STUB"
  ].nir_shader_get_function_for_name
  nir_shader_get_function_for_name.restype = ctypes.POINTER(struct_nir_function)
  nir_shader_get_function_for_name.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(ctypes.c_char),
  ]
except AttributeError:
  pass
try:
  nir_remove_non_entrypoints = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_shader_create.argtypes = [
    ctypes.POINTER(None),
    gl_shader_stage,
    ctypes.POINTER(struct_nir_shader_compiler_options),
    ctypes.POINTER(struct_shader_info),
  ]
except AttributeError:
  pass
try:
  ...
  nir_shader_add_variable.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_variable),
  ]
except AttributeError:
  pass
try:
  nir_function_impl_add_variable = _libraries[
    "FIXME_STUB"
  ].nir_function_impl_add_variable
  nir_function_impl_add_variable.restype = None
  nir_function_impl_add_variable.argtypes = [
...
try:
  ...
  pass
try:
  nir_state_variable_create = _libraries[
    "libtinymesa_cpu.so"
  ].nir_state_variable_create
  nir_state_variable_create.restype = ctypes.POINTER(struct_nir_variable)
  nir_state_variable_create.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_glsl_type),
    ctypes.POINTER(ctypes.c_char),
    ctypes.c_int16 * 4,
...
try:
  ...
  pass
try:
  nir_create_variable_with_location = _libraries[
    "libtinymesa_cpu.so"
  ].nir_create_variable_with_location
  nir_create_variable_with_location.restype = ctypes.POINTER(struct_nir_variable)
  nir_create_variable_with_location.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    ctypes.c_int32,
    ctypes.POINTER(struct_glsl_type),
...
try:
  ...
  pass
try:
  nir_find_variable_with_driver_location = _libraries[
    "libtinymesa_cpu.so"
  ].nir_find_variable_with_driver_location
  nir_find_variable_with_driver_location.restype = ctypes.POINTER(
    struct_nir_variable
  )
  nir_find_variable_with_driver_location.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    ctypes.c_uint32,
  ]
...
try:
  ...
  nir_find_state_variable.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_int16 * 4,
  ]
except AttributeError:
  pass
try:
  nir_find_sampler_variable_with_tex_index = _libraries[
    "libtinymesa_cpu.so"
  ].nir_find_sampler_variable_with_tex_index
  nir_find_sampler_variable_with_tex_index.restype = ctypes.POINTER(
    struct_nir_variable
  )
  nir_find_sampler_variable_with_tex_index.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  nir_sort_variables_with_modes = _libraries[
    "libtinymesa_cpu.so"
  ].nir_sort_variables_with_modes
  nir_sort_variables_with_modes.restype = None
  nir_sort_variables_with_modes.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.CFUNCTYPE(
      ctypes.c_int32,
      ctypes.POINTER(struct_nir_variable),
...
try:
  ...
  nir_function_set_impl.argtypes = [
    ctypes.POINTER(struct_nir_function),
    ctypes.POINTER(struct_nir_function_impl),
  ]
except AttributeError:
  pass
try:
  nir_function_impl_create = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_function_impl_create_bare = _libraries[
    "libtinymesa_cpu.so"
  ].nir_function_impl_create_bare
...
try:
  ...
  pass
try:
  nir_cf_node_get_function = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_shader_preserve_all_metadata = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_deref_instr_create.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_deref_type,
  ]
except AttributeError:
...
try:
  ...
  nir_call_instr_create.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_function),
  ]
except AttributeError:
...
try:
  ...
  nir_phi_instr_add_src.argtypes = [
    ctypes.POINTER(struct_nir_phi_instr),
    ctypes.POINTER(struct_nir_block),
    ctypes.POINTER(struct_nir_def),
  ]
  ...
  pass
try:
  nir_parallel_copy_instr_create = _libraries[
    "libtinymesa_cpu.so"
  ].nir_parallel_copy_instr_create
  nir_parallel_copy_instr_create.restype = ctypes.POINTER(
    struct_nir_parallel_copy_instr
  )
...
try:
  ...
  nir_undef_instr_create.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_uint32,
    ctypes.c_uint32,
  ]
...
try:
  ...
  nir_instr_insert_before.argtypes = [
    ctypes.POINTER(struct_nir_instr),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
...
try:
  ...
  nir_instr_insert_after.argtypes = [
    ctypes.POINTER(struct_nir_instr),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
  pass
try:
  nir_instr_insert_before_block = _libraries[
    "FIXME_STUB"
  ].nir_instr_insert_before_block
  nir_instr_insert_before_block.restype = None
  nir_instr_insert_before_block.argtypes = [
    ctypes.POINTER(struct_nir_block),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
  pass
try:
  nir_instr_insert_after_block = _libraries[
    "FIXME_STUB"
  ].nir_instr_insert_after_block
  nir_instr_insert_after_block.restype = None
  nir_instr_insert_after_block.argtypes = [
    ctypes.POINTER(struct_nir_block),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
...
try:
  ...
  nir_instr_insert_before_cf.argtypes = [
    ctypes.POINTER(struct_nir_cf_node),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
  pass
try:
  ...
  nir_instr_insert_after_cf.argtypes = [
    ctypes.POINTER(struct_nir_cf_node),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
  pass
try:
  nir_instr_insert_before_cf_list = _libraries[
    "FIXME_STUB"
  ].nir_instr_insert_before_cf_list
  nir_instr_insert_before_cf_list.restype = None
  nir_instr_insert_before_cf_list.argtypes = [
    ctypes.POINTER(struct_exec_list),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
  pass
try:
  nir_instr_insert_after_cf_list = _libraries[
    "FIXME_STUB"
  ].nir_instr_insert_after_cf_list
  nir_instr_insert_after_cf_list.restype = None
  nir_instr_insert_after_cf_list.argtypes = [
    ctypes.POINTER(struct_exec_list),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
...
try:
  ...
  pass
nir_foreach_def_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool, ctypes.POINTER(struct_nir_def), ctypes.POINTER(None)
)
nir_foreach_src_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool, ctypes.POINTER(struct_nir_src), ctypes.POINTER(None)
)
try:
  nir_foreach_src = _libraries["FIXME_STUB"].nir_foreach_src
  nir_foreach_src.restype = ctypes.c_bool
  nir_foreach_src.argtypes = [
    ctypes.POINTER(struct_nir_instr),
    nir_foreach_src_cb,
    ctypes.POINTER(None),
  ]
  ...
  pass
try:
  nir_foreach_phi_src_leaving_block = _libraries[
    "libtinymesa_cpu.so"
  ].nir_foreach_phi_src_leaving_block
  nir_foreach_phi_src_leaving_block.restype = ctypes.c_bool
  nir_foreach_phi_src_leaving_block.argtypes = [
    ctypes.POINTER(struct_nir_block),
    nir_foreach_src_cb,
    ctypes.POINTER(None),
  ]
...
try:
  ...
  pass
try:
  nir_src_is_always_uniform = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_def_init_for_type.argtypes = [
    ctypes.POINTER(struct_nir_instr),
    ctypes.POINTER(struct_nir_def),
    ctypes.POINTER(struct_glsl_type),
  ]
...
try:
  ...
  pass
try:
  nir_def_first_component_read = _libraries[
    "FIXME_STUB"
  ].nir_def_first_component_read
...
try:
  ...
  pass
try:
  nir_unstructured_start_block = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_cf_node_cf_tree_first = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_cf_node_cf_tree_last = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_cf_node_cf_tree_next = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_cf_node_cf_tree_prev = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_block_get_following_if = _libraries[
    "libtinymesa_cpu.so"
  ].nir_block_get_following_if
  ...
  pass
try:
  nir_block_get_following_loop = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_block_get_predecessors_sorted = _libraries[
    "libtinymesa_cpu.so"
  ].nir_block_get_predecessors_sorted
  nir_block_get_predecessors_sorted.restype = ctypes.POINTER(
    ctypes.POINTER(struct_nir_block)
  )
  nir_block_get_predecessors_sorted.argtypes = [
    ctypes.POINTER(struct_nir_block),
    ctypes.POINTER(None),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_shader_clear_pass_flags = _libraries[
    "libtinymesa_cpu.so"
  ].nir_shader_clear_pass_flags
...
try:
  ...
  nir_shader_index_vars.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
  pass
try:
  nir_function_impl_index_vars = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_print_function_body.argtypes = [
    ctypes.POINTER(struct_nir_function_impl),
    ctypes.POINTER(struct__IO_FILE),
  ]
except AttributeError:
  pass
try:
  nir_print_shader_annotated = _libraries[
    "libtinymesa_cpu.so"
  ].nir_print_shader_annotated
  nir_print_shader_annotated.restype = None
  nir_print_shader_annotated.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct__IO_FILE),
    ctypes.POINTER(struct_hash_table),
  ]
except AttributeError:
  pass
try:
...
try:
  nir_log_shader_annotated_tagged = _libraries[
    "libtinymesa_cpu.so"
  ].nir_log_shader_annotated_tagged
  nir_log_shader_annotated_tagged.restype = None
  nir_log_shader_annotated_tagged.argtypes = [
    mesa_log_level,
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_hash_table),
...
try:
  ...
  pass
try:
  nir_shader_gather_debug_info = _libraries[
    "libtinymesa_cpu.so"
  ].nir_shader_gather_debug_info
  nir_shader_gather_debug_info.restype = ctypes.POINTER(ctypes.c_char)
  nir_shader_gather_debug_info.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(ctypes.c_char),
    uint32_t,
  ]
...
try:
  ...
  nir_function_impl_clone.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_function_impl),
  ]
except AttributeError:
  pass
try:
  nir_function_impl_clone_remap_globals = _libraries[
    "libtinymesa_cpu.so"
  ].nir_function_impl_clone_remap_globals
  nir_function_impl_clone_remap_globals.restype = ctypes.POINTER(
    struct_nir_function_impl
  )
  nir_function_impl_clone_remap_globals.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_function_impl),
    ctypes.POINTER(struct_hash_table),
  ]
...
try:
  ...
  nir_constant_clone.argtypes = [
    ctypes.POINTER(struct_nir_constant),
    ctypes.POINTER(struct_nir_variable),
  ]
except AttributeError:
  pass
...
try:
  ...
  pass
try:
  nir_shader_serialize_deserialize = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_validate_ssa_dominance = _libraries[
    "libtinymesa_cpu.so"
  ].nir_validate_ssa_dominance
  nir_validate_ssa_dominance.restype = None
  nir_validate_ssa_dominance.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(ctypes.c_char),
  ]
except AttributeError:
  pass
try:
  nir_metadata_set_validation_flag = _libraries[
    "libtinymesa_cpu.so"
  ].nir_metadata_set_validation_flag
  nir_metadata_set_validation_flag.restype = None
  nir_metadata_set_validation_flag.argtypes = [ctypes.POINTER(struct_nir_shader)]
except AttributeError:
  pass
try:
  nir_metadata_check_validation_flag = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_metadata_require_all = _libraries[
    "libtinymesa_cpu.so"
  ].nir_metadata_require_all
...
try:
  ...
  pass
nir_instr_writemask_filter_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.POINTER(struct_nir_instr),
  ctypes.c_uint32,
  ctypes.POINTER(None),
...
try:
  ...
  pass
try:
  nir_block_is_unreachable = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_dump_dom_tree_impl.argtypes = [
    ctypes.POINTER(struct_nir_function_impl),
    ctypes.POINTER(struct__IO_FILE),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_dump_dom_frontier_impl = _libraries[
    "libtinymesa_cpu.so"
  ].nir_dump_dom_frontier_impl
  nir_dump_dom_frontier_impl.restype = None
  nir_dump_dom_frontier_impl.argtypes = [
    ctypes.POINTER(struct_nir_function_impl),
    ctypes.POINTER(struct__IO_FILE),
  ]
except AttributeError:
...
try:
  ...
  nir_dump_dom_frontier.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct__IO_FILE),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_gs_count_vertices_and_primitives = _libraries[
    "libtinymesa_cpu.so"
  ].nir_gs_count_vertices_and_primitives
  nir_gs_count_vertices_and_primitives.restype = None
  nir_gs_count_vertices_and_primitives.argtypes = [
    ctypes.POINTER(struct_nir_shader),
...
try:
  ...
  pass
try:
  nir_split_per_member_structs = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_split_struct_vars.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_link_shader_functions = _libraries[
    "libtinymesa_cpu.so"
  ].nir_link_shader_functions
  nir_link_shader_functions.restype = ctypes.c_bool
  nir_link_shader_functions.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_shader),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_collect_src_uniforms = _libraries[
    "libtinymesa_cpu.so"
  ].nir_collect_src_uniforms
  nir_collect_src_uniforms.restype = ctypes.c_bool
  nir_collect_src_uniforms.argtypes = [
    ctypes.POINTER(struct_nir_src),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.POINTER(ctypes.c_ubyte),
  ...
  pass
try:
  nir_add_inlinable_uniforms = _libraries[
    "libtinymesa_cpu.so"
  ].nir_add_inlinable_uniforms
  nir_add_inlinable_uniforms.restype = None
  nir_add_inlinable_uniforms.argtypes = [
    ctypes.POINTER(struct_nir_src),
...
try:
  ...
  nir_propagate_invariant.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  nir_lower_var_copy_instr.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
    ctypes.POINTER(struct_nir_shader),
  ]
except AttributeError:
  pass
try:
  nir_lower_deref_copy_instr = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_deref_copy_instr
  nir_lower_deref_copy_instr.restype = None
  nir_lower_deref_copy_instr.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_intrinsic_instr),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_lower_global_vars_to_local = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_lower_constant_to_temp = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_constant_to_temp
...
try:
  nir_lower_array_deref_of_vec = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_array_deref_of_vec
  nir_lower_array_deref_of_vec.restype = ctypes.c_bool
  nir_lower_array_deref_of_vec.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(struct_nir_variable)),
    nir_lower_array_deref_of_vec_options,
  ]
except AttributeError:
  pass
try:
  nir_lower_indirect_derefs = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_indirect_derefs
  nir_lower_indirect_derefs.restype = ctypes.c_bool
  nir_lower_indirect_derefs.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    uint32_t,
  ]
  ...
  pass
try:
  nir_lower_indirect_var_derefs = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_indirect_var_derefs
  nir_lower_indirect_var_derefs.restype = ctypes.c_bool
  nir_lower_indirect_var_derefs.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_set),
  ]
except AttributeError:
  pass
try:
  nir_lower_locals_to_regs = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_lower_vars_to_scratch = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_vars_to_scratch
  nir_lower_vars_to_scratch.restype = ctypes.c_bool
  nir_lower_vars_to_scratch.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    ctypes.c_int32,
    glsl_type_size_align_func,
  ...
  pass
try:
  nir_lower_scratch_to_var = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_scratch_to_var
...
try:
  ...
  nir_shader_gather_info.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_function_impl),
  ]
except AttributeError:
...
try:
  ...
  nir_link_xfb_varyings.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_shader),
  ]
except AttributeError:
...
try:
  ...
  nir_link_opt_varyings.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_shader),
  ]
except AttributeError:
  pass
try:
  nir_link_varying_precision = _libraries[
    "libtinymesa_cpu.so"
  ].nir_link_varying_precision
  nir_link_varying_precision.restype = None
  nir_link_varying_precision.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_shader),
  ]
except AttributeError:
...
try:
  ...
  nir_clone_deref_instr.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_variable),
    ctypes.POINTER(struct_nir_deref_instr),
  ]
...
try:
  nir_slot_is_sysval_output = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_slot_is_sysval_output_and_varying = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_remove_sysval_output = _libraries[
    "libtinymesa_cpu.so"
  ].nir_remove_sysval_output
  nir_remove_sysval_output.restype = ctypes.c_bool
  nir_remove_sysval_output.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr),
    gl_shader_stage,
  ]
except AttributeError:
...
try:
  ...
  nir_lower_amul.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.CFUNCTYPE(
      ctypes.c_int32, ctypes.POINTER(struct_glsl_type), ctypes.c_bool
    ),
  ]
except AttributeError:
  pass
try:
  ...
  pass
try:
  nir_sort_variables_by_location = _libraries[
    "libtinymesa_cpu.so"
  ].nir_sort_variables_by_location
  nir_sort_variables_by_location.restype = None
  nir_sort_variables_by_location.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
  pass
try:
  nir_assign_io_var_locations = _libraries[
    "libtinymesa_cpu.so"
  ].nir_assign_io_var_locations
  nir_assign_io_var_locations.restype = None
  nir_assign_io_var_locations.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    ctypes.POINTER(ctypes.c_uint32),
    gl_shader_stage,
...
try:
  ...
  pass
try:
  nir_io_add_const_offset_to_base = _libraries[
    "libtinymesa_cpu.so"
  ].nir_io_add_const_offset_to_base
  nir_io_add_const_offset_to_base.restype = ctypes.c_bool
  nir_io_add_const_offset_to_base.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_io_add_intrinsic_xfb_info = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_lower_vars_to_explicit_types = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_vars_to_explicit_types
  nir_lower_vars_to_explicit_types.restype = ctypes.c_bool
  nir_lower_vars_to_explicit_types.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    glsl_type_size_align_func,
  ]
  ...
  pass
try:
  nir_gather_explicit_io_initializers = _libraries[
    "libtinymesa_cpu.so"
  ].nir_gather_explicit_io_initializers
  nir_gather_explicit_io_initializers.restype = None
  nir_gather_explicit_io_initializers.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(None),
    size_t,
    nir_variable_mode,
...
try:
  ...
  nir_lower_vec3_to_vec4.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  nir_address_format_bit_size = _libraries[
    "libtinymesa_cpu.so"
  ].nir_address_format_bit_size
  nir_address_format_bit_size.restype = ctypes.c_uint32
  nir_address_format_bit_size.argtypes = [nir_address_format]
except AttributeError:
  pass
try:
  nir_address_format_num_components = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_address_format_to_glsl_type = _libraries[
    "FIXME_STUB"
  ...
  pass
try:
  nir_address_format_null_value = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_lower_explicit_io_instr = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_explicit_io_instr
  nir_lower_explicit_io_instr.restype = None
  nir_lower_explicit_io_instr.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_intrinsic_instr),
    ctypes.POINTER(struct_nir_def),
    nir_address_format,
...
try:
  ...
  nir_lower_explicit_io.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    nir_address_format,
  ]
...
nir_lower_mem_access_bit_sizes_cb = ctypes.CFUNCTYPE(
  struct_nir_mem_access_size_align,
  c__EA_nir_intrinsic_op,
  ctypes.c_ubyte,
  ctypes.c_ubyte,
  ctypes.c_uint32,
  ctypes.c_uint32,
...
try:
  nir_lower_mem_access_bit_sizes = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_mem_access_bit_sizes
  nir_lower_mem_access_bit_sizes.restype = ctypes.c_bool
  nir_lower_mem_access_bit_sizes.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_mem_access_bit_sizes_options),
  ]
except AttributeError:
  pass
try:
  ...
  nir_lower_robust_access.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_intrin_filter_cb,
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
nir_should_vectorize_mem_func = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.c_uint32,
  ctypes.c_uint32,
  ctypes.c_uint32,
...
try:
  nir_opt_load_store_vectorize = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_load_store_vectorize
  nir_opt_load_store_vectorize.restype = ctypes.c_bool
  nir_opt_load_store_vectorize.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_load_store_vectorize_options),
  ]
except AttributeError:
  pass
try:
  nir_opt_load_store_update_alignments = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
nir_lower_shader_calls_should_remat_func = ctypes.CFUNCTYPE(
  ctypes.c_bool, ctypes.POINTER(struct_nir_instr), ctypes.POINTER(None)
)
...
try:
  ...
  nir_lower_shader_calls.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_shader_calls_options),
    ctypes.POINTER(ctypes.POINTER(ctypes.POINTER(struct_nir_shader))),
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
try:
  nir_get_io_offset_src_number = _libraries[
    "libtinymesa_cpu.so"
  ].nir_get_io_offset_src_number
  nir_get_io_offset_src_number.restype = ctypes.c_int32
  nir_get_io_offset_src_number.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr)
  ]
except AttributeError:
  pass
try:
  nir_get_io_index_src_number = _libraries[
    "libtinymesa_cpu.so"
  ].nir_get_io_index_src_number
  ...
  pass
try:
  nir_get_io_arrayed_index_src_number = _libraries[
    "libtinymesa_cpu.so"
  ].nir_get_io_arrayed_index_src_number
  nir_get_io_arrayed_index_src_number.restype = ctypes.c_int32
  nir_get_io_arrayed_index_src_number.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr)
  ]
except AttributeError:
  pass
...
try:
  ...
  pass
try:
  nir_lower_reg_intrinsics_to_ssa_impl = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_reg_intrinsics_to_ssa_impl
  nir_lower_reg_intrinsics_to_ssa_impl.restype = ctypes.c_bool
  nir_lower_reg_intrinsics_to_ssa_impl.argtypes = [
    ctypes.POINTER(struct_nir_function_impl)
  ]
except AttributeError:
  pass
try:
  nir_lower_reg_intrinsics_to_ssa = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_remove_dead_derefs_impl = _libraries[
    "libtinymesa_cpu.so"
...
struct_nir_remove_dead_variables_options._fields_ = [
  (
    "can_remove_var",
    ctypes.CFUNCTYPE(
      ctypes.c_bool, ctypes.POINTER(struct_nir_variable), ctypes.POINTER(None)
    ),
  ),
...
try:
  nir_remove_dead_variables = _libraries[
    "libtinymesa_cpu.so"
  ].nir_remove_dead_variables
  nir_remove_dead_variables.restype = ctypes.c_bool
  nir_remove_dead_variables.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    ctypes.POINTER(struct_nir_remove_dead_variables_options),
  ]
except AttributeError:
  pass
try:
  nir_lower_variable_initializers = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_variable_initializers
  nir_lower_variable_initializers.restype = ctypes.c_bool
  nir_lower_variable_initializers.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  nir_clear_shared_memory.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_uint32,
    ctypes.c_uint32,
  ]
...
try:
  ...
  pass
try:
  nir_move_vec_src_uses_to_dest = _libraries[
    "libtinymesa_cpu.so"
  ].nir_move_vec_src_uses_to_dest
  nir_move_vec_src_uses_to_dest.restype = ctypes.c_bool
  nir_move_vec_src_uses_to_dest.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
try:
  nir_move_output_stores_to_end = _libraries[
    "libtinymesa_cpu.so"
  ].nir_move_output_stores_to_end
...
try:
  ...
  nir_lower_vec_to_regs.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_instr_writemask_filter_cb,
    ctypes.POINTER(None),
  ]
except AttributeError:
  pass
...
try:
  ...
  nir_lower_alu_to_scalar.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_instr_filter_cb,
    ctypes.POINTER(None),
  ]
...
try:
  ...
  nir_lower_bool_to_float.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_opt_simplify_convert_alu_types = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_simplify_convert_alu_types
...
try:
  ...
  pass
try:
  nir_lower_convert_alu_types = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_convert_alu_types
  nir_lower_convert_alu_types.restype = ctypes.c_bool
  nir_lower_convert_alu_types.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(struct_nir_intrinsic_instr)),
  ]
except AttributeError:
  pass
try:
  nir_lower_constant_convert_alu_types = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_lower_load_const_to_scalar = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_lower_read_invocation_to_scalar = _libraries[
    "FIXME_STUB"
  ...
  pass
try:
  nir_lower_phis_to_scalar = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_phis_to_scalar
  nir_lower_phis_to_scalar.restype = ctypes.c_bool
  nir_lower_phis_to_scalar.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_vectorize_cb,
    ctypes.POINTER(None),
  ]
  ...
  pass
try:
  nir_lower_all_phis_to_scalar = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_lower_io_array_vars_to_elements = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_io_array_vars_to_elements
  nir_lower_io_array_vars_to_elements.restype = None
  nir_lower_io_array_vars_to_elements.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_shader),
  ]
except AttributeError:
...
try:
  ...
  nir_lower_io_to_scalar.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
    nir_instr_filter_cb,
    ctypes.POINTER(None),
...
try:
  ...
  pass
try:
  nir_opt_vectorize_io_vars = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_vectorize_io_vars
  nir_opt_vectorize_io_vars.restype = ctypes.c_bool
  nir_opt_vectorize_io_vars.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
  pass
try:
  nir_lower_tess_level_array_vars_to_vec = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_tess_level_array_vars_to_vec
  nir_lower_tess_level_array_vars_to_vec.restype = ctypes.c_bool
  nir_lower_tess_level_array_vars_to_vec.argtypes = [
    ctypes.POINTER(struct_nir_shader)
  ]
except AttributeError:
  pass
try:
  nir_create_passthrough_tcs_impl = _libraries[
    "libtinymesa_cpu.so"
  ].nir_create_passthrough_tcs_impl
  nir_create_passthrough_tcs_impl.restype = ctypes.POINTER(struct_nir_shader)
  nir_create_passthrough_tcs_impl.argtypes = [
    ctypes.POINTER(struct_nir_shader_compiler_options),
    ctypes.POINTER(ctypes.c_uint32),
    ctypes.c_uint32,
    uint8_t,
  ...
  pass
try:
  nir_create_passthrough_tcs = _libraries[
    "libtinymesa_cpu.so"
  ].nir_create_passthrough_tcs
  nir_create_passthrough_tcs.restype = ctypes.POINTER(struct_nir_shader)
  nir_create_passthrough_tcs.argtypes = [
    ctypes.POINTER(struct_nir_shader_compiler_options),
    ctypes.POINTER(struct_nir_shader),
    uint8_t,
  ]
...
try:
  ...
  pass
try:
  nir_lower_fragcoord_wtrans = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_opt_frag_coord_to_pixel_coord = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_frag_coord_to_pixel_coord
  ...
  pass
try:
  nir_lower_frag_coord_to_pixel_coord = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_lower_viewport_transform = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_lower_is_helper_invocation = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_lower_single_sampled = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_single_sampled
...
try:
  ...
  nir_lower_subgroups.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_subgroups_options),
  ]
except AttributeError:
  pass
try:
  ...
  pass
try:
  nir_build_lowered_load_helper_invocation = _libraries[
    "libtinymesa_cpu.so"
  ].nir_build_lowered_load_helper_invocation
  nir_build_lowered_load_helper_invocation.restype = ctypes.POINTER(struct_nir_def)
  nir_build_lowered_load_helper_invocation.argtypes = [
    ctypes.POINTER(struct_nir_builder)
  ]
except AttributeError:
  pass
...
try:
  nir_lower_compute_system_values = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_compute_system_values
  nir_lower_compute_system_values.restype = ctypes.c_bool
  nir_lower_compute_system_values.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_compute_system_values_options),
  ]
except AttributeError:
  pass
...
try:
  nir_lower_sysvals_to_varyings = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_sysvals_to_varyings
  nir_lower_sysvals_to_varyings.restype = ctypes.c_bool
  nir_lower_sysvals_to_varyings.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_sysvals_to_varyings_options),
  ]
except AttributeError:
  pass
...
try:
  ...
  nir_lower_tex.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_tex_options),
  ]
except AttributeError:
  pass
...
try:
  ...
  nir_lower_tex_shadow.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_uint32,
    ctypes.POINTER(compare_func),
    ctypes.POINTER(struct_nir_lower_tex_shadow_swizzle),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
...
try:
  ...
  nir_lower_image.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_image_options),
  ]
except AttributeError:
  pass
try:
  nir_lower_image_atomics_to_global = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_image_atomics_to_global
  nir_lower_image_atomics_to_global.restype = ctypes.c_bool
  nir_lower_image_atomics_to_global.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_intrin_filter_cb,
    ctypes.POINTER(None),
  ]
...
nir_lower_non_uniform_src_access_callback = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.POINTER(struct_nir_tex_instr),
  ctypes.c_uint32,
  ctypes.POINTER(None),
)
nir_lower_non_uniform_access_callback = ctypes.CFUNCTYPE(
  ctypes.c_uint16, ctypes.POINTER(struct_nir_src), ctypes.POINTER(None)
)
...
try:
  nir_has_non_uniform_access = _libraries[
    "libtinymesa_cpu.so"
  ].nir_has_non_uniform_access
  nir_has_non_uniform_access.restype = ctypes.c_bool
  nir_has_non_uniform_access.argtypes = [
    ctypes.POINTER(struct_nir_shader),
  ...
  pass
try:
  nir_opt_non_uniform_access = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_non_uniform_access
  nir_opt_non_uniform_access.restype = ctypes.c_bool
  nir_opt_non_uniform_access.argtypes = [ctypes.POINTER(struct_nir_shader)]
except AttributeError:
  pass
try:
  nir_lower_non_uniform_access = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_non_uniform_access
  nir_lower_non_uniform_access.restype = ctypes.c_bool
  nir_lower_non_uniform_access.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_non_uniform_access_options),
  ]
except AttributeError:
  pass
...
try:
  ...
  nir_lower_idiv.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_idiv_options),
  ]
except AttributeError:
  pass
...
try:
  nir_lower_input_attachments = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_input_attachments
  nir_lower_input_attachments.restype = ctypes.c_bool
  nir_lower_input_attachments.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_input_attachment_options),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  pass
try:
  nir_lower_clip_cull_distance_to_vec4s = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_clip_cull_distance_to_vec4s
  nir_lower_clip_cull_distance_to_vec4s.restype = ctypes.c_bool
  nir_lower_clip_cull_distance_to_vec4s.argtypes = [
    ctypes.POINTER(struct_nir_shader)
  ]
except AttributeError:
  pass
try:
  nir_lower_clip_cull_distance_array_vars = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_clip_cull_distance_array_vars
  nir_lower_clip_cull_distance_array_vars.restype = ctypes.c_bool
  nir_lower_clip_cull_distance_array_vars.argtypes = [
    ctypes.POINTER(struct_nir_shader)
  ]
except AttributeError:
  pass
try:
  ...
  nir_lower_clip_disable.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_lower_two_sided_color = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_two_sided_color
  nir_lower_two_sided_color.restype = ctypes.c_bool
  nir_lower_two_sided_color.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
try:
  nir_lower_clamp_color_outputs = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_lower_passthrough_edgeflags = _libraries[
    "libtinymesa_cpu.so"
...
try:
  nir_lower_wpos_ytransform = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_wpos_ytransform
  nir_lower_wpos_ytransform.restype = ctypes.c_bool
  nir_lower_wpos_ytransform.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_wpos_ytransform_options),
  ]
except AttributeError:
  pass
try:
  ...
  pass
try:
  nir_lower_pntc_ytransform = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_pntc_ytransform
  nir_lower_pntc_ytransform.restype = ctypes.c_bool
  nir_lower_pntc_ytransform.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_int16 * 4 * 0,
  ]
except AttributeError:
...
try:
  ...
  nir_lower_drawpixels.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_drawpixels_options),
  ]
except AttributeError:
  pass
...
try:
  ...
  nir_lower_bitmap.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_bitmap_options),
  ]
except AttributeError:
  pass
try:
  nir_lower_atomics_to_ssbo = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_atomics_to_ssbo
  nir_lower_atomics_to_ssbo.restype = ctypes.c_bool
  nir_lower_atomics_to_ssbo.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_uint32,
  ]
except AttributeError:
...
try:
  ...
  nir_lower_gs_intrinsics.argtypes = [
    ctypes.POINTER(struct_nir_shader),
  ...
  pass
try:
  nir_lower_halt_to_return = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_halt_to_return
...
try:
  ...
  nir_lower_tess_coord_z.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  nir_lower_task_shader.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_lower_task_shader_options,
  ]
except AttributeError:
  pass
nir_lower_bit_size_callback = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_nir_instr), ctypes.POINTER(None)
)
try:
  nir_lower_bit_size = _libraries["libtinymesa_cpu.so"].nir_lower_bit_size
  nir_lower_bit_size.restype = ctypes.c_bool
  nir_lower_bit_size.argtypes = [
    ctypes.POINTER(struct_nir_shader),
...
try:
  ...
  nir_split_conversions.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_split_conversions_options),
  ]
except AttributeError:
  pass
try:
  nir_split_64bit_vec3_and_vec4 = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_lower_int64_op_to_options_mask = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_int64_op_to_options_mask
...
try:
  ...
  pass
try:
  nir_lower_int64_float_conversions = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_lower_doubles_op_to_options_mask = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_get_io_intrinsic.argtypes = [
    ctypes.POINTER(struct_nir_instr),
    nir_variable_mode,
    ctypes.POINTER(c__EA_nir_variable_mode),
  ]
except AttributeError:
  pass
try:
  ...
  nir_recompute_io_bases.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  nir_lower_mediump_vars.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_clear_mediump_io_flag = _libraries[
    "libtinymesa_cpu.so"
  ].nir_clear_mediump_io_flag
...
try:
  ...
  nir_opt_16bit_tex_image.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_opt_16bit_tex_image_options),
  ]
except AttributeError:
  pass
...
try:
  nir_legalize_16bit_sampler_srcs = _libraries[
    "libtinymesa_cpu.so"
  ].nir_legalize_16bit_sampler_srcs
  nir_legalize_16bit_sampler_srcs.restype = ctypes.c_bool
  nir_legalize_16bit_sampler_srcs.argtypes = [
    ctypes.POINTER(struct_nir_shader),
...
try:
  ...
  nir_lower_interpolation.argtypes = [
    ctypes.POINTER(struct_nir_shader),
...
try:
  ...
  pass
try:
  nir_lower_terminate_to_demote = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_lower_continue_constructs = _libraries[
    "libtinymesa_cpu.so"
...
try:
  nir_shader_uses_view_index = _libraries[
    "libtinymesa_cpu.so"
  ].nir_shader_uses_view_index
...
try:
  ...
  nir_can_lower_multiview.argtypes = [
    ctypes.POINTER(struct_nir_shader),
...
try:
  ...
  pass
try:
  nir_lower_view_index_to_device_index = _libraries[
    "libtinymesa_cpu.so"
  ].nir_lower_view_index_to_device_index
...
try:
  ...
  pass
try:
  nir_normalize_cubemap_coords = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_shader_supports_implicit_lod = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_loop_analyze_impl.argtypes = [
    ctypes.POINTER(struct_nir_function_impl),
    nir_variable_mode,
    ctypes.c_bool,
  ]
...
try:
  ...
  pass
try:
  nir_convert_loop_to_lcssa = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_divergence_analysis_impl = _libraries[
    "libtinymesa_cpu.so"
  ].nir_divergence_analysis_impl
  nir_divergence_analysis_impl.restype = None
  nir_divergence_analysis_impl.argtypes = [
    ctypes.POINTER(struct_nir_function_impl),
...
try:
  ...
  pass
try:
  nir_vertex_divergence_analysis = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_rewrite_uses_to_load_reg = _libraries[
    "libtinymesa_cpu.so"
  ].nir_rewrite_uses_to_load_reg
  nir_rewrite_uses_to_load_reg.restype = None
  nir_rewrite_uses_to_load_reg.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    ctypes.POINTER(struct_nir_def),
  ]
...
try:
  ...
  pass
try:
  nir_lower_ssa_defs_to_regs_block = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_dedup_inline_samplers = _libraries[
    "libtinymesa_cpu.so"
  ].nir_dedup_inline_samplers
...
try:
  ...
  nir_lower_ssbo.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_ssbo_options),
  ]
except AttributeError:
  pass
try:
  ...
  nir_lower_helper_writes.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  nir_lower_printf.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_printf_options),
  ]
except AttributeError:
  pass
try:
  ...
  nir_lower_printf_buffer.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    uint64_t,
    uint32_t,
  ]
  ...
  pass
try:
  nir_opt_comparison_pre_impl = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_comparison_pre_impl
...
try:
  ...
  nir_opt_access.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_opt_access_options),
  ]
except AttributeError:
  pass
try:
  ...
  pass
try:
  nir_opt_algebraic_before_ffma = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_opt_algebraic_before_lower_int64 = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_opt_algebraic_distribute_src_mods = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_algebraic_distribute_src_mods
  nir_opt_algebraic_distribute_src_mods.restype = ctypes.c_bool
  nir_opt_algebraic_distribute_src_mods.argtypes = [
    ctypes.POINTER(struct_nir_shader)
  ]
except AttributeError:
  pass
try:
  nir_opt_algebraic_integer_promotion = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_opt_reassociate_matrix_mul = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_opt_constant_folding = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
nir_combine_barrier_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.POINTER(struct_nir_intrinsic_instr),
  ctypes.POINTER(struct_nir_intrinsic_instr),
  ctypes.POINTER(None),
...
try:
  nir_opt_acquire_release_barriers = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_acquire_release_barriers
  nir_opt_acquire_release_barriers.restype = ctypes.c_bool
  nir_opt_acquire_release_barriers.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    mesa_scope,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_minimize_call_live_states = _libraries[
    "libtinymesa_cpu.so"
  ].nir_minimize_call_live_states
...
try:
  ...
  nir_opt_combine_stores.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_variable_mode,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_opt_find_array_copies = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_opt_large_constants.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    glsl_type_size_align_func,
    ctypes.c_uint32,
  ]
...
try:
  ...
  nir_opt_offsets.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_opt_offsets_options),
  ]
except AttributeError:
  pass
...
try:
  ...
  nir_opt_peephole_select.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_opt_peephole_select_options),
  ]
except AttributeError:
  pass
try:
  ...
  pass
try:
  nir_opt_rematerialize_compares = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_remove_single_src_phis_block = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_opt_shrink_vectors.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  nir_opt_uniform_atomics.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
try:
  nir_opt_uniform_subgroup = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_uniform_subgroup
  nir_opt_uniform_subgroup.restype = ctypes.c_bool
  nir_opt_uniform_subgroup.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_lower_subgroups_options),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  nir_opt_move_discards_to_top = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  nir_opt_ray_query_ranges = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_opt_tex_skip_helpers = _libraries[
    "libtinymesa_cpu.so"
  ].nir_opt_tex_skip_helpers
  nir_opt_tex_skip_helpers.restype = ctypes.c_bool
  nir_opt_tex_skip_helpers.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  nir_intrinsic_from_system_value = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  nir_system_value_from_intrinsic = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  nir_variable_count_slots.argtypes = [
    ctypes.POINTER(struct_nir_variable),
    ctypes.POINTER(struct_glsl_type),
  ]
except AttributeError:
...
try:
  ...
  nir_deref_count_slots.argtypes = [
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_variable),
  ]
except AttributeError:
...
try:
  nir_unsigned_upper_bound = _libraries[
    "libtinymesa_cpu.so"
  ].nir_unsigned_upper_bound
  nir_unsigned_upper_bound.restype = uint32_t
  nir_unsigned_upper_bound.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_hash_table),
    nir_scalar,
    ctypes.POINTER(struct_nir_unsigned_upper_bound_config),
  ]
except AttributeError:
  pass
try:
  nir_addition_might_overflow = _libraries[
    "libtinymesa_cpu.so"
  ].nir_addition_might_overflow
  nir_addition_might_overflow.restype = ctypes.c_bool
  nir_addition_might_overflow.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_hash_table),
    nir_scalar,
    ctypes.c_uint32,
...
struct_nir_opt_preamble_options._fields_ = [
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(ctypes.c_uint32),
      ctypes.POINTER(ctypes.c_uint32),
      ctypes.POINTER(c__EA_nir_preamble_class),
    ),
  ),
  ...
  (
    "instr_cost_cb",
    ctypes.CFUNCTYPE(
      ctypes.c_float, ctypes.POINTER(struct_nir_instr), ctypes.POINTER(None)
    ),
  ),
  (
    "rewrite_cost_cb",
    ctypes.CFUNCTYPE(
      ctypes.c_float, ctypes.POINTER(struct_nir_def), ctypes.POINTER(None)
    ),
  ),
  (
    "avoid_instr_cb",
...
try:
  ...
  nir_opt_preamble.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_opt_preamble_options),
    ctypes.POINTER(ctypes.c_uint32),
  ]
except AttributeError:
  pass
...
try:
  ...
  nir_lower_point_smooth.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_bool,
  ]
except AttributeError:
...
try:
  ...
  nir_remove_tex_shadow.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.c_uint32,
  ]
except AttributeError:
  pass
try:
  nir_trivialize_registers = _libraries[
    "libtinymesa_cpu.so"
  ].nir_trivialize_registers
  nir_trivialize_registers.restype = ctypes.c_bool
  nir_trivialize_registers.argtypes = [ctypes.POINTER(struct_nir_shader)]
except AttributeError:
  pass
try:
  nir_static_workgroup_size = _libraries[
    "libtinymesa_cpu.so"
  ].nir_static_workgroup_size
...
try:
  nir_calc_use_dominance_impl = _libraries[
    "libtinymesa_cpu.so"
  ].nir_calc_use_dominance_impl
  nir_calc_use_dominance_impl.restype = ctypes.POINTER(
    struct_nir_use_dominance_state
  )
  nir_calc_use_dominance_impl.argtypes = [
    ctypes.POINTER(struct_nir_function_impl),
    ctypes.c_bool,
  ]
except AttributeError:
  pass
try:
  nir_get_immediate_use_dominator = _libraries[
    "libtinymesa_cpu.so"
  ].nir_get_immediate_use_dominator
  nir_get_immediate_use_dominator.restype = ctypes.POINTER(struct_nir_instr)
  nir_get_immediate_use_dominator.argtypes = [
    ctypes.POINTER(struct_nir_use_dominance_state),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
  pass
try:
  ...
  nir_use_dominance_lca.argtypes = [
    ctypes.POINTER(struct_nir_use_dominance_state),
    ctypes.POINTER(struct_nir_instr),
    ctypes.POINTER(struct_nir_instr),
  ]
...
try:
  ...
  nir_instr_dominates_use.argtypes = [
    ctypes.POINTER(struct_nir_use_dominance_state),
    ctypes.POINTER(struct_nir_instr),
    ctypes.POINTER(struct_nir_instr),
  ]
  ...
  pass
try:
  nir_print_use_dominators = _libraries[
    "libtinymesa_cpu.so"
  ].nir_print_use_dominators
  nir_print_use_dominators.restype = None
  nir_print_use_dominators.argtypes = [
    ctypes.POINTER(struct_nir_use_dominance_state),
...
try:
  nir_gather_output_dependencies = _libraries[
    "libtinymesa_cpu.so"
  ].nir_gather_output_dependencies
  nir_gather_output_dependencies.restype = None
  nir_gather_output_dependencies.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_c__SA_nir_output_deps),
  ]
except AttributeError:
  pass
try:
  nir_free_output_dependencies = _libraries[
    "libtinymesa_cpu.so"
  ].nir_free_output_dependencies
  nir_free_output_dependencies.restype = None
  nir_free_output_dependencies.argtypes = [
    ctypes.POINTER(struct_c__SA_nir_output_deps)
  ]
except AttributeError:
  pass
...
try:
  nir_gather_input_to_output_dependencies = _libraries[
    "libtinymesa_cpu.so"
  ].nir_gather_input_to_output_dependencies
  nir_gather_input_to_output_dependencies.restype = None
  nir_gather_input_to_output_dependencies.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_c__SA_nir_input_to_output_deps),
  ]
except AttributeError:
  pass
try:
  nir_print_input_to_output_deps = _libraries[
    "libtinymesa_cpu.so"
  ].nir_print_input_to_output_deps
  nir_print_input_to_output_deps.restype = None
  nir_print_input_to_output_deps.argtypes = [
    ctypes.POINTER(struct_c__SA_nir_input_to_output_deps),
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct__IO_FILE),
  ]
...
try:
  nir_gather_output_clipper_var_groups = _libraries[
    "libtinymesa_cpu.so"
  ].nir_gather_output_clipper_var_groups
  nir_gather_output_clipper_var_groups.restype = None
  nir_gather_output_clipper_var_groups.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_c__SA_nir_output_clipper_var_groups),
  ]
except AttributeError:
  pass
...
try:
  ...
  pass
try:
  nir_builder_init_simple_shader = _libraries[
    "libtinymesa_cpu.so"
  ].nir_builder_init_simple_shader
  nir_builder_init_simple_shader.restype = nir_builder
  nir_builder_init_simple_shader.argtypes = [
    gl_shader_stage,
    ctypes.POINTER(struct_nir_shader_compiler_options),
    ctypes.POINTER(ctypes.c_char),
  ]
  ...
  pass
nir_instr_pass_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.POINTER(struct_nir_builder),
  ctypes.POINTER(struct_nir_instr),
  ctypes.POINTER(None),
)
nir_intrinsic_pass_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.POINTER(struct_nir_builder),
  ctypes.POINTER(struct_nir_intrinsic_instr),
  ctypes.POINTER(None),
)
nir_alu_pass_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.POINTER(struct_nir_builder),
  ctypes.POINTER(struct_nir_alu_instr),
  ctypes.POINTER(None),
)
nir_tex_pass_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.POINTER(struct_nir_builder),
  ctypes.POINTER(struct_nir_tex_instr),
  ctypes.POINTER(None),
)
nir_phi_pass_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool,
  ctypes.POINTER(struct_nir_builder),
  ctypes.POINTER(struct_nir_phi_instr),
  ctypes.POINTER(None),
...
try:
  ...
  pass
try:
  nir_shader_instructions_pass = _libraries[
    "FIXME_STUB"
  ].nir_shader_instructions_pass
  nir_shader_instructions_pass.restype = ctypes.c_bool
  nir_shader_instructions_pass.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_instr_pass_cb,
    nir_metadata,
    ctypes.POINTER(None),
  ...
  pass
try:
  nir_function_intrinsics_pass = _libraries[
    "FIXME_STUB"
  ].nir_function_intrinsics_pass
  nir_function_intrinsics_pass.restype = ctypes.c_bool
  nir_function_intrinsics_pass.argtypes = [
    ctypes.POINTER(struct_nir_function_impl),
    nir_intrinsic_pass_cb,
    nir_metadata,
    ctypes.POINTER(None),
  ]
except AttributeError:
...
try:
  ...
  nir_shader_intrinsics_pass.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    nir_intrinsic_pass_cb,
    nir_metadata,
    ctypes.POINTER(None),
...
try:
  ...
  pass
try:
  nir_builder_instr_insert = _libraries[
    "libtinymesa_cpu.so"
  ].nir_builder_instr_insert
  nir_builder_instr_insert.restype = None
  nir_builder_instr_insert.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
  pass
try:
  nir_builder_instr_insert_at_top = _libraries[
    "libtinymesa_cpu.so"
  ].nir_builder_instr_insert_at_top
  nir_builder_instr_insert_at_top.restype = None
  nir_builder_instr_insert_at_top.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_instr),
  ]
except AttributeError:
...
try:
  ...
  nir_build_alu_src_arr.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    nir_op,
    ctypes.POINTER(ctypes.POINTER(struct_nir_def)),
  ]
  ...
  pass
try:
  nir_build_tex_deref_instr = _libraries[
    "libtinymesa_cpu.so"
  ].nir_build_tex_deref_instr
  nir_build_tex_deref_instr.restype = ctypes.POINTER(struct_nir_def)
  nir_build_tex_deref_instr.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    nir_texop,
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.c_uint32,
    ctypes.POINTER(struct_nir_tex_src),
  ]
except AttributeError:
  pass
try:
  ...
  nir_builder_cf_insert.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_cf_node),
  ]
except AttributeError:
  pass
try:
  nir_builder_is_inside_cf = _libraries[
    "libtinymesa_cpu.so"
  ].nir_builder_is_inside_cf
  nir_builder_is_inside_cf.restype = ctypes.c_bool
  nir_builder_is_inside_cf.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_cf_node),
  ]
except AttributeError:
...
try:
  ...
  nir_push_continue.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_loop),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  nir_build_imm.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.c_uint32,
    ctypes.c_uint32,
    ctypes.POINTER(union_c__UA_nir_const_value),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  nir_load_system_value.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    nir_intrinsic_op,
    ctypes.c_int32,
    ctypes.c_uint32,
...
try:
  ...
  nir_convert_to_bit_size.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    nir_alu_type,
    ctypes.c_uint32,
...
try:
  ...
  nir_vector_insert_imm.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    ctypes.POINTER(struct_nir_def),
    ctypes.c_uint32,
...
try:
  ...
  nir_ubitfield_extract_imm.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    uint32_t,
    uint32_t,
...
try:
  ...
  nir_ibitfield_extract_imm.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    uint32_t,
    uint32_t,
...
try:
  ...
  nir_bitfield_insert_imm.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    ctypes.POINTER(struct_nir_def),
    uint32_t,
...
try:
  ...
  nir_pad_vector_imm_int.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    uint64_t,
    ctypes.c_uint32,
...
try:
  ...
  nir_build_deref_array.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_def),
  ]
...
try:
  ...
  nir_build_deref_array_imm.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    int64_t,
  ]
...
try:
  ...
  pass
try:
  nir_build_deref_array_wildcard = _libraries[
    "FIXME_STUB"
  ].nir_build_deref_array_wildcard
  nir_build_deref_array_wildcard.restype = ctypes.POINTER(struct_nir_deref_instr)
  nir_build_deref_array_wildcard.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
  ]
except AttributeError:
...
try:
  ...
  nir_build_deref_struct.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.c_uint32,
  ]
  ...
  pass
try:
  nir_build_deref_cast_with_alignment = _libraries[
    "FIXME_STUB"
  ].nir_build_deref_cast_with_alignment
  nir_build_deref_cast_with_alignment.restype = ctypes.POINTER(
    struct_nir_deref_instr
  )
  nir_build_deref_cast_with_alignment.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    nir_variable_mode,
    ctypes.POINTER(struct_glsl_type),
...
try:
  ...
  nir_alignment_deref_cast.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    uint32_t,
    uint32_t,
...
try:
  ...
  nir_build_deref_follower.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_deref_instr),
  ]
...
try:
  ...
  nir_load_deref_with_access.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    gl_access_qualifier,
  ]
...
try:
  ...
  nir_store_deref_with_access.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_def),
    ctypes.c_uint32,
...
try:
  ...
  pass
try:
  nir_build_write_masked_store = _libraries[
    "FIXME_STUB"
  ].nir_build_write_masked_store
  nir_build_write_masked_store.restype = None
  nir_build_write_masked_store.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_def),
    ctypes.c_uint32,
  ...
  pass
try:
  nir_build_write_masked_stores = _libraries[
    "FIXME_STUB"
  ].nir_build_write_masked_stores
  nir_build_write_masked_stores.restype = None
  nir_build_write_masked_stores.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_def),
    ctypes.POINTER(struct_nir_def),
...
try:
  ...
  nir_copy_deref_with_access.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_deref_instr),
    gl_access_qualifier,
...
try:
  ...
  pass
try:
  nir_memcpy_deref_with_access = _libraries[
    "FIXME_STUB"
  ].nir_memcpy_deref_with_access
  nir_memcpy_deref_with_access.restype = None
  nir_memcpy_deref_with_access.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_def),
...
try:
  ...
  nir_load_array_var_imm.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_variable),
    int64_t,
  ]
...
try:
  ...
  nir_store_array_var_imm.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_variable),
    int64_t,
    ctypes.POINTER(struct_nir_def),
...
try:
  ...
  nir_load_global_constant.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    ctypes.c_uint32,
    ctypes.c_uint32,
...
try:
  ...
  nir_samples_identical_deref.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_deref_instr),
    ctypes.POINTER(struct_nir_def),
  ]
...
try:
  ...
  nir_build_indirect_call.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_function),
    ctypes.POINTER(struct_nir_def),
    size_t,
...
try:
  ...
  nir_scoped_memory_barrier.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    mesa_scope,
...
try:
  ...
  nir_gen_rect_vertices.argtypes = [
    ctypes.POINTER(struct_nir_builder),
    ctypes.POINTER(struct_nir_def),
    ctypes.POINTER(struct_nir_def),
  ]
...
try:
  ...
  nir_serialize_function.argtypes = [
    ctypes.POINTER(struct_blob),
    ctypes.POINTER(struct_nir_function),
  ]
except AttributeError:
  pass
try:
  nir_deserialize_function = _libraries[
    "libtinymesa_cpu.so"
  ].nir_deserialize_function
  nir_deserialize_function.restype = ctypes.POINTER(struct_nir_function)
  nir_deserialize_function.argtypes = [
    ctypes.POINTER(None),
    ctypes.POINTER(struct_nir_shader_compiler_options),
    ctypes.POINTER(struct_blob_reader),
  ]
...
try:
  ...
  nv_device_uuid.argtypes = [
    ctypes.POINTER(struct_nv_device_info),
    ctypes.POINTER(ctypes.c_ubyte),
    size_t,
    ctypes.c_bool,
  ]
...
try:
  ...
  nak_preprocess_nir.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nak_compiler),
  ]
except AttributeError:
  pass
try:
  ...
  nak_nir_lower_image_addrs.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nak_compiler),
  ]
except AttributeError:
...
try:
  ...
  nak_postprocess_nir.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nak_compiler),
    nir_variable_mode,
    ctypes.POINTER(struct_nak_fs_key),
  ]
except AttributeError:
  pass
...
try:
  ...
  nak_fill_qmd.argtypes = [
    ctypes.POINTER(struct_nv_device_info),
    ctypes.POINTER(struct_nak_shader_info),
    ctypes.POINTER(struct_nak_qmd_info),
    ctypes.POINTER(None),
    size_t,
  ]
except AttributeError:
...
try:
  nak_get_qmd_dispatch_size_layout = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  lp_passmgr_create.argtypes = [
    LLVMModuleRef,
    ctypes.POINTER(ctypes.POINTER(struct_lp_passmgr)),
  ]
except AttributeError:
  pass
...
try:
  ...
  lp_passmgr_run.argtypes = [
    ctypes.POINTER(struct_lp_passmgr),
    LLVMModuleRef,
...
try:
  gallivm_create_target_library_info = _libraries[
    "libtinymesa_cpu.so"
  ...
  pass
try:
  gallivm_dispose_target_library_info = _libraries[
    "libtinymesa_cpu.so"
  ].gallivm_dispose_target_library_info
...
try:
  ...
  pass
try:
  lp_bld_init_native_targets = _libraries[
    "libtinymesa_cpu.so"
...
try:
  lp_build_create_jit_compiler_for_module = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_create_jit_compiler_for_module
  lp_build_create_jit_compiler_for_module.restype = ctypes.c_int32
  lp_build_create_jit_compiler_for_module.argtypes = [
    ctypes.POINTER(ctypes.POINTER(struct_LLVMOpaqueExecutionEngine)),
    ctypes.POINTER(ctypes.POINTER(struct_lp_generated_code)),
    ctypes.POINTER(struct_lp_cached_code),
    LLVMModuleRef,
...
try:
  ...
  pass
try:
  lp_get_default_memory_manager = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  pass
try:
  lp_set_module_stack_alignment_override = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  lp_type_from_format_desc.argtypes = [
    ctypes.POINTER(struct_lp_type),
    ctypes.POINTER(struct_util_format_description),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  lp_build_elem_type.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    struct_lp_type,
  ]
except AttributeError:
  pass
...
try:
  ...
  lp_build_int_elem_type.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    struct_lp_type,
  ]
except AttributeError:
...
try:
  ...
  lp_build_int_vec_type.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    struct_lp_type,
  ]
except AttributeError:
...
try:
  ...
  lp_build_context_init.argtypes = [
    ctypes.POINTER(struct_lp_build_context),
    ctypes.POINTER(struct_gallivm_state),
    struct_lp_type,
  ]
except AttributeError:
  pass
try:
  lp_build_count_ir_module = _libraries[
    "libtinymesa_cpu.so"
...
try:
  lp_build_init_native_width = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  gallivm_create.argtypes = [
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(struct_lp_context_ref),
    ctypes.POINTER(struct_lp_cached_code),
  ]
except AttributeError:
  pass
...
try:
  ...
  gallivm_verify_function.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    LLVMValueRef,
  ]
except AttributeError:
  pass
try:
  gallivm_add_global_mapping = _libraries[
    "libtinymesa_cpu.so"
  ].gallivm_add_global_mapping
  gallivm_add_global_mapping.restype = None
  gallivm_add_global_mapping.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    LLVMValueRef,
    ctypes.POINTER(None),
  ]
...
try:
  lp_build_flow_skip_begin = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_flow_skip_begin
  lp_build_flow_skip_begin.restype = None
  lp_build_flow_skip_begin.argtypes = [
    ctypes.POINTER(struct_lp_build_skip_context),
    ctypes.POINTER(struct_gallivm_state),
  ]
except AttributeError:
  pass
try:
  lp_build_flow_skip_cond_break = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_flow_skip_cond_break
  lp_build_flow_skip_cond_break.restype = None
  lp_build_flow_skip_cond_break.argtypes = [
    ctypes.POINTER(struct_lp_build_skip_context),
    LLVMValueRef,
  ]
except AttributeError:
...
try:
  ...
  lp_build_mask_begin.argtypes = [
    ctypes.POINTER(struct_lp_build_mask_context),
    ctypes.POINTER(struct_gallivm_state),
    struct_lp_type,
    LLVMValueRef,
  ]
...
try:
  ...
  lp_build_loop_begin.argtypes = [
    ctypes.POINTER(struct_lp_build_loop_state),
    ctypes.POINTER(struct_gallivm_state),
    LLVMValueRef,
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  lp_build_loop_force_set_counter = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_loop_force_set_counter
  lp_build_loop_force_set_counter.restype = None
  lp_build_loop_force_set_counter.argtypes = [
    ctypes.POINTER(struct_lp_build_loop_state),
    LLVMValueRef,
  ]
except AttributeError:
  pass
try:
  lp_build_loop_force_reload_counter = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_loop_force_reload_counter
  lp_build_loop_force_reload_counter.restype = None
  lp_build_loop_force_reload_counter.argtypes = [
    ctypes.POINTER(struct_lp_build_loop_state)
  ]
except AttributeError:
  pass
...
try:
  ...
  lp_build_loop_end_cond.argtypes = [
    ctypes.POINTER(struct_lp_build_loop_state),
    LLVMValueRef,
    LLVMValueRef,
    LLVMIntPredicate,
...
try:
  ...
  lp_build_for_loop_begin.argtypes = [
    ctypes.POINTER(struct_lp_build_for_loop_state),
    ctypes.POINTER(struct_gallivm_state),
    LLVMValueRef,
    LLVMIntPredicate,
    LLVMValueRef,
...
try:
  ...
  lp_build_if.argtypes = [
    ctypes.POINTER(struct_lp_build_if_state),
    ctypes.POINTER(struct_gallivm_state),
    LLVMValueRef,
  ]
except AttributeError:
...
try:
  lp_build_insert_new_block = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_insert_new_block
  lp_build_insert_new_block.restype = LLVMBasicBlockRef
  lp_build_insert_new_block.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.POINTER(ctypes.c_char),
  ]
except AttributeError:
...
try:
  lp_create_builder_at_entry = _libraries[
    "libtinymesa_cpu.so"
...
try:
  ...
  lp_build_alloca_undef.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    LLVMTypeRef,
    ctypes.POINTER(ctypes.c_char),
  ]
...
try:
  ...
  lp_build_array_alloca.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    LLVMTypeRef,
    LLVMValueRef,
    ctypes.POINTER(ctypes.c_char),
...
struct_lp_build_sampler_soa._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      None,
      ctypes.POINTER(struct_lp_build_sampler_soa),
      ctypes.POINTER(struct_gallivm_state),
      ctypes.POINTER(struct_lp_sampler_params),
    ),
  ),
  (
    "emit_size_query",
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(struct_lp_build_sampler_soa),
      ctypes.POINTER(struct_gallivm_state),
      ctypes.POINTER(struct_lp_sampler_size_query_params),
    ),
  ),
]
...
struct_lp_build_gs_iface._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(struct_lp_build_gs_iface),
      ctypes.POINTER(struct_lp_build_context),
      ctypes.c_bool,
      ctypes.POINTER(struct_LLVMOpaqueValue),
      ctypes.c_bool,
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      ...
      ctypes.POINTER(struct_lp_build_gs_iface),
      ctypes.POINTER(struct_lp_build_context),
      ctypes.POINTER(ctypes.POINTER(struct_LLVMOpaqueValue) * 4),
      ctypes.POINTER(struct_LLVMOpaqueValue),
      ctypes.POINTER(struct_LLVMOpaqueValue),
      ctypes.POINTER(struct_LLVMOpaqueValue),
    ),
...
struct_lp_build_tcs_iface._fields_ = [
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      None,
      ctypes.POINTER(struct_lp_build_tcs_iface),
      ctypes.POINTER(struct_lp_build_context),
      ctypes.c_uint32,
      ctypes.c_bool,
      ctypes.POINTER(struct_LLVMOpaqueValue),
...
struct_lp_build_tes_iface._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_LLVMOpaqueValue),
      ctypes.POINTER(struct_lp_build_tes_iface),
      ctypes.POINTER(struct_lp_build_context),
      ctypes.c_bool,
      ctypes.POINTER(struct_LLVMOpaqueValue),
      ctypes.c_bool,
...
struct_lp_build_mesh_iface._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      None,
      ctypes.POINTER(struct_lp_build_mesh_iface),
      ctypes.POINTER(struct_lp_build_context),
      ctypes.c_uint32,
      ctypes.c_bool,
      ctypes.POINTER(struct_LLVMOpaqueValue),
...
struct_lp_build_image_soa._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      None,
      ctypes.POINTER(struct_lp_build_image_soa),
      ctypes.POINTER(struct_gallivm_state),
      ctypes.POINTER(struct_lp_img_params),
    ),
  ),
  (
    "emit_size_query",
...
try:
  ...
  lp_build_nir_soa.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_lp_build_tgsi_params),
    ctypes.POINTER(ctypes.POINTER(struct_LLVMOpaqueValue) * 4),
  ]
except AttributeError:
  pass
try:
  ...
  lp_build_nir_soa_func.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.POINTER(struct_nir_shader),
    ctypes.POINTER(struct_nir_function_impl),
    ctypes.POINTER(struct_lp_build_tgsi_params),
...
struct_lp_build_sampler_aos._fields_ = [
  (
    ...
    ctypes.CFUNCTYPE(
      ctypes.POINTER(struct_LLVMOpaqueValue),
      ctypes.POINTER(struct_lp_build_sampler_aos),
      ctypes.POINTER(struct_lp_build_context),
      tgsi_texture_type,
      ctypes.c_uint32,
      ctypes.POINTER(struct_LLVMOpaqueValue),
      struct_lp_derivatives,
      lp_build_tex_modifier,
    ),
  ),
]
...
try:
  lp_build_nir_soa_prepasses = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_nir_soa_prepasses
...
try:
  ...
  pass
try:
  lp_nir_array_build_gather_values = _libraries[
    "FIXME_STUB"
  ].lp_nir_array_build_gather_values
  lp_nir_array_build_gather_values.restype = LLVMValueRef
  lp_nir_array_build_gather_values.argtypes = [
    LLVMBuilderRef,
    ctypes.POINTER(ctypes.POINTER(struct_LLVMOpaqueValue)),
    ctypes.c_uint32,
  ]
...
try:
  ...
  lp_build_nir_sample_key.argtypes = [
    gl_shader_stage,
    ctypes.POINTER(struct_nir_tex_instr),
  ]
except AttributeError:
  pass
try:
  lp_img_op_from_intrinsic = _libraries[
    "libtinymesa_cpu.so"
  ].lp_img_op_from_intrinsic
  lp_img_op_from_intrinsic.restype = None
  lp_img_op_from_intrinsic.argtypes = [
    ctypes.POINTER(struct_lp_img_params),
    ctypes.POINTER(struct_nir_intrinsic_instr),
  ]
except AttributeError:
  pass
try:
  lp_packed_img_op_from_intrinsic = _libraries[
    "libtinymesa_cpu.so"
  ].lp_packed_img_op_from_intrinsic
  lp_packed_img_op_from_intrinsic.restype = uint32_t
  lp_packed_img_op_from_intrinsic.argtypes = [
    ctypes.POINTER(struct_nir_intrinsic_instr)
  ]
except AttributeError:
  pass
...
try:
  lp_build_cs_func_call_context = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_cs_func_call_context
  lp_build_cs_func_call_context.restype = LLVMTypeRef
  lp_build_cs_func_call_context.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.c_int32,
    LLVMTypeRef,
    LLVMTypeRef,
...
try:
  ...
  lp_build_array_get_ptr2.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    LLVMTypeRef,
    LLVMValueRef,
    LLVMValueRef,
...
try:
  ...
  lp_build_pointer_get2.argtypes = [
    LLVMBuilderRef,
    LLVMTypeRef,
    LLVMValueRef,
    LLVMValueRef,
...
try:
  ...
  pass
try:
  lp_build_pointer_set_unaligned = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_pointer_set_unaligned
  lp_build_pointer_set_unaligned.restype = None
  lp_build_pointer_set_unaligned.argtypes = [
    LLVMBuilderRef,
    LLVMValueRef,
    LLVMValueRef,
    LLVMValueRef,
...
try:
  ...
  lp_llvm_descriptor_base.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    LLVMValueRef,
    LLVMValueRef,
    ctypes.c_uint32,
...
try:
  ...
  pass
try:
  lp_llvm_buffer_num_elements = _libraries[
    "libtinymesa_cpu.so"
  ].lp_llvm_buffer_num_elements
  lp_llvm_buffer_num_elements.restype = LLVMValueRef
  lp_llvm_buffer_num_elements.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    LLVMValueRef,
    LLVMValueRef,
    ctypes.c_uint32,
...
try:
  lp_build_jit_resources_type = _libraries[
    "libtinymesa_cpu.so"
...
try:
  lp_build_create_jit_vertex_header_type = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_create_jit_vertex_header_type
  lp_build_create_jit_vertex_header_type.restype = LLVMTypeRef
  lp_build_create_jit_vertex_header_type.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.c_int32,
  ]
except AttributeError:
...
try:
  lp_build_jit_fill_sampler_dynamic_state = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_jit_fill_sampler_dynamic_state
  lp_build_jit_fill_sampler_dynamic_state.restype = None
  lp_build_jit_fill_sampler_dynamic_state.argtypes = [
    ctypes.POINTER(struct_lp_sampler_dynamic_state)
  ]
except AttributeError:
  pass
try:
  lp_build_jit_fill_image_dynamic_state = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_jit_fill_image_dynamic_state
  lp_build_jit_fill_image_dynamic_state.restype = None
  lp_build_jit_fill_image_dynamic_state.argtypes = [
    ctypes.POINTER(struct_lp_sampler_dynamic_state)
  ]
except AttributeError:
  pass
try:
  lp_build_sample_function_type = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_sample_function_type
  lp_build_sample_function_type.restype = LLVMTypeRef
  lp_build_sample_function_type.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    uint32_t,
  ]
except AttributeError:
  pass
try:
  lp_build_size_function_type = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_size_function_type
  lp_build_size_function_type.restype = LLVMTypeRef
  lp_build_size_function_type.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.POINTER(struct_lp_sampler_size_query_params),
  ]
except AttributeError:
  pass
try:
  lp_build_image_function_type = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_image_function_type
  lp_build_image_function_type.restype = LLVMTypeRef
  lp_build_image_function_type.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.POINTER(struct_lp_img_params),
    ctypes.c_bool,
    ctypes.c_bool,
...
union_lp_descriptor_0._anonymous_ = (
  "_0",
  "_1",
)
...
try:
  ...
  lp_build_const_int_vec.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    struct_lp_type,
    ctypes.c_int64,
  ]
...
try:
  ...
  lp_build_const_mask_aos.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    struct_lp_type,
    ctypes.c_uint32,
    ctypes.c_uint32,
...
try:
  ...
  lp_build_const_double.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.c_float,
  ]
except AttributeError:
...
try:
  ...
  lp_build_const_int_pointer.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.POINTER(None),
  ]
except AttributeError:
...
try:
  ...
  lp_build_const_string.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.POINTER(ctypes.c_char),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  lp_build_const_func_pointer_from_type = _libraries[
    "libtinymesa_cpu.so"
  ].lp_build_const_func_pointer_from_type
  lp_build_const_func_pointer_from_type.restype = LLVMValueRef
  lp_build_const_func_pointer_from_type.argtypes = [
    ctypes.POINTER(struct_gallivm_state),
    ctypes.POINTER(None),
    LLVMTypeRef,
    ctypes.POINTER(ctypes.c_char),
...
__all__ = [
  ...
  "ACCESS_COHERENT",
  "ACCESS_CP_GE_COHERENT_AMD",
  "ACCESS_FMASK_LOWERED_AMD",
  ...
  "MESA_SHADER_VERTEX",
  "NAK_TS_DOMAIN_ISOLINE",
  "NAK_TS_DOMAIN_QUAD",
  "NAK_TS_DOMAIN_TRIANGLE",
  "NAK_TS_PRIMS_LINES",
  "NAK_TS_PRIMS_POINTS",
  ...
  "NAK_TS_SPACING_INTEGER",
  "NIR_CMAT_A_SIGNED",
  "NIR_CMAT_B_SIGNED",
  "NIR_CMAT_C_SIGNED",
  "NIR_CMAT_RESULT_SIGNED",
  ...
  "PIPE_TEXTURE_RECT",
  "RALLOC_PRINT_INFO_SUMMARY_ONLY",
  "SCOPE_DEVICE",
  "SCOPE_INVOCATION",
  "SCOPE_NONE",
  "SCOPE_QUEUE_FAMILY",
  ...
  "SUBGROUP_SIZE_REQUIRE_128",
  "SUBGROUP_SIZE_REQUIRE_16",
  "SUBGROUP_SIZE_REQUIRE_32",
  "SUBGROUP_SIZE_REQUIRE_4",
  "SUBGROUP_SIZE_REQUIRE_64",
  "SUBGROUP_SIZE_REQUIRE_8",
  ...
  "blob_copy_bytes",
  "blob_finish",
  "blob_finish_get_buffer",
  "blob_init",
  "blob_init_fixed",
  "blob_overwrite_bytes",
  "blob_overwrite_intptr",
  "blob_overwrite_uint32",
  "blob_overwrite_uint8",
  "blob_read_bytes",
  "blob_read_intptr",
  "blob_read_string",
  "blob_read_uint16",
  ...
  "c__EA_LLVMTypeKind",
  "c__EA_gl_system_value",
  "c__EA_gl_varying_slot",
  "c__EA_mesa_scope",
  "c__EA_nir_address_format",
  "c__EA_nir_alu_type",
  "c__EA_nir_atomic_op",
  "c__EA_nir_cf_node_type",
  "c__EA_nir_cmat_signed",
  "c__EA_nir_cursor_option",
  "c__EA_nir_depth_layout",
  "c__EA_nir_deref_instr_has_complex_use_options",
  "c__EA_nir_deref_type",
  "c__EA_nir_divergence_options",
  "c__EA_nir_instr_type",
  "c__EA_nir_intrinsic_index_flag",
  "c__EA_nir_intrinsic_op",
  "c__EA_nir_intrinsic_semantic_flag",
  "c__EA_nir_io_options",
  "c__EA_nir_jump_type",
  "c__EA_nir_load_grouping",
  "c__EA_nir_loop_control",
  ...
  "c__EA_nir_lower_io_options",
  "c__EA_nir_lower_packing_op",
  "c__EA_nir_mem_access_shift_method",
  "c__EA_nir_memory_semantics",
  "c__EA_nir_metadata",
  "c__EA_nir_move_options",
  "c__EA_nir_op",
  "c__EA_nir_op_algebraic_property",
  "c__EA_nir_opt_if_options",
  "c__EA_nir_opt_move_to_top_options",
  "c__EA_nir_opt_varyings_progress",
  "c__EA_nir_preamble_class",
  "c__EA_nir_ray_query_value",
  "c__EA_nir_resource_data_intel",
  "c__EA_nir_rounding_mode",
  "c__EA_nir_selection_control",
  "c__EA_nir_var_declaration_type",
  "c__EA_nir_variable_mode",
  "c__Ea_GLSL_PRECISION_NONE",
  "c__Ea_LP_JIT_BUFFER_BASE",
  "c__Ea_LP_JIT_IMAGE_BASE",
  "c__Ea_LP_JIT_RES_CONSTANTS",
  "c__Ea_LP_JIT_SAMPLER_MIN_LOD",
  ...
  "gl_derivative_group",
  "gl_shader_stage",
  "gl_shader_stage__enumvalues",
  "gl_subgroup_size",
  "gl_system_value",
  "gl_system_value__enumvalues",
  "gl_varying_slot",
  ...
  "glsl_base_type_is_float",
  "glsl_base_type_is_integer",
  "glsl_bf16vec_type",
  "glsl_bfloat16_t_type",
  "glsl_bfloatN_t_type",
  "glsl_bool_type",
  "glsl_bvec2_type",
  "glsl_bvec4_type",
  ...
  "glsl_cmat_use",
  "glsl_contains_array",
  "glsl_contains_atomic",
  "glsl_contains_double",
  "glsl_contains_integer",
  "glsl_contains_opaque",
  "glsl_contains_sampler",
  "glsl_contains_subroutine",
  "glsl_count_attribute_slots",
  "glsl_count_dword_slots",
  ...
  "glsl_get_cl_type_size_align",
  "glsl_get_cmat_description",
  "glsl_get_cmat_element",
  "glsl_get_column_type",
  "glsl_get_component_slots",
  "glsl_get_component_slots_aligned",
  "glsl_get_components",
  ...
  "glsl_get_sampler_dim_coordinate_components",
  "glsl_get_sampler_result_type",
  "glsl_get_scalar_type",
  "glsl_get_std140_base_alignment",
  "glsl_get_std140_size",
  "glsl_get_std430_array_stride",
  "glsl_get_std430_base_alignment",
  "glsl_get_std430_size",
  ...
  "glsl_sampler_type_is_shadow",
  "glsl_sampler_type_to_texture",
  "glsl_scalar_type",
  "glsl_signed_base_type_of",
  "glsl_simple_explicit_type",
  "glsl_simple_type",
  "glsl_size_align_handle_array_and_structs",
  "glsl_struct_field",
  "glsl_struct_type",
  "glsl_struct_type_is_packed",
  "glsl_struct_type_with_explicit_alignment",
  "glsl_subroutine_type",
  "glsl_texture_type",
  "glsl_texture_type_to_sampler",
  "glsl_transposed_type",
  "glsl_type",
  "glsl_type_compare_no_precision",
  "glsl_type_contains_32bit",
  "glsl_type_contains_64bit",
  ...
  "glsl_type_is_array_of_arrays",
  "glsl_type_is_array_or_matrix",
  "glsl_type_is_atomic_uint",
  "glsl_type_is_bare_sampler",
  "glsl_type_is_bfloat_16",
  "glsl_type_is_boolean",
  "glsl_type_is_cmat",
  "glsl_type_is_double",
  "glsl_type_is_dual_slot",
  "glsl_type_is_e4m3fn",
  "glsl_type_is_e5m2",
  "glsl_type_is_error",
  "glsl_type_is_float",
  "glsl_type_is_float_16",
  "glsl_type_is_float_16_32",
  "glsl_type_is_float_16_32_64",
  "glsl_type_is_image",
  "glsl_type_is_int_16_32",
  "glsl_type_is_int_16_32_64",
  "glsl_type_is_integer",
  "glsl_type_is_integer_16",
  "glsl_type_is_integer_16_32",
  "glsl_type_is_integer_16_32_64",
  "glsl_type_is_integer_32",
  "glsl_type_is_integer_32_64",
  "glsl_type_is_integer_64",
  "glsl_type_is_interface",
  "glsl_type_is_leaf",
  "glsl_type_is_matrix",
  "glsl_type_is_numeric",
  "glsl_type_is_packed",
  "glsl_type_is_sampler",
  "glsl_type_is_scalar",
  "glsl_type_is_struct",
  "glsl_type_is_struct_or_ifc",
  "glsl_type_is_subroutine",
  "glsl_type_is_texture",
  "glsl_type_is_uint_16_32",
  "glsl_type_is_uint_16_32_64",
  "glsl_type_is_unsized_array",
  "glsl_type_is_vector",
  "glsl_type_is_vector_or_scalar",
  "glsl_type_is_void",
  "glsl_type_replace_vec3_with_vec4",
  ...
  "lp_build_array_get2",
  "lp_build_array_get_ptr2",
  "lp_build_const_aos",
  "lp_build_const_channel_vec",
  "lp_build_const_double",
  "lp_build_const_elem",
  "lp_build_const_float",
  "lp_build_const_func_pointer",
  "lp_build_const_func_pointer_from_type",
  "lp_build_const_int32",
  "lp_build_const_int64",
  "lp_build_const_int_pointer",
  "lp_build_const_int_vec",
  "lp_build_const_mask_aos",
  "lp_build_const_mask_aos_swizzled",
  "lp_build_const_string",
  "lp_build_const_vec",
  ...
  "lp_build_flow_skip_begin",
  "lp_build_flow_skip_cond_break",
  "lp_build_flow_skip_end",
  "lp_build_for_loop_begin",
  "lp_build_for_loop_end",
  "lp_build_if",
  "lp_build_image_function_type",
  "lp_build_init",
  "lp_build_init_native_width",
  "lp_build_insert_new_block",
  "lp_build_int_elem_type",
  ...
  "lp_build_pointer_get_unaligned2",
  "lp_build_pointer_set",
  "lp_build_pointer_set_unaligned",
  "lp_build_sample_function_type",
  "lp_build_size_function_type",
  "lp_build_struct_get2",
  "lp_build_struct_get_ptr2",
  "lp_build_tex_modifier",
  "lp_build_undef",
  "lp_build_vec_type",
  ...
  "lp_free_generated_code",
  "lp_free_memory_manager",
  "lp_free_objcache",
  "lp_get_called_value",
  "lp_get_default_memory_manager",
  "lp_img_op_from_intrinsic",
  ...
  "lp_sizeof_llvm_type",
  "lp_translate_atomic_op",
  "lp_type_fixed",
  "lp_type_float",
  "lp_type_float_vec",
  "lp_type_from_format",
  "lp_type_from_format_desc",
  "lp_type_int",
  "lp_type_int_vec",
  "lp_type_ufixed",
  "lp_type_uint",
  ...
  "nak_get_qmd_cbuf_desc_layout",
  "nak_get_qmd_dispatch_size_layout",
  "nak_nir_lower_image_addrs",
  "nak_nir_options",
  "nak_postprocess_nir",
  "nak_preprocess_nir",
  "nak_qmd_size_B",
  "nak_shader_bin_destroy",
  "nak_ts_domain",
  "nak_ts_prims",
  "nak_ts_spacing",
  "nir_a_minus_bc",
  ...
  "nir_address_format__enumvalues",
  "nir_address_format_bit_size",
  ...
  "nir_after_cf_list",
  "nir_after_cf_node",
  "nir_after_cf_node_and_phis",
  "nir_after_impl",
  "nir_after_instr",
  "nir_after_instr_and_phis",
  "nir_after_phis",
  "nir_after_reg_decls",
  "nir_align_imm",
  ...
  "nir_binding",
  "nir_bitcast_vector",
  "nir_bitfield_insert_imm",
  "nir_block",
  "nir_block_cf_tree_next",
  "nir_block_cf_tree_prev",
  "nir_block_contains_work",
  "nir_block_create",
  "nir_block_dominates",
  "nir_block_ends_in_break",
  ...
  "nir_block_get_following_loop",
  "nir_block_get_predecessors_sorted",
  "nir_block_is_reachable",
  "nir_block_is_unreachable",
  "nir_block_last_instr",
  "nir_block_last_phi_instr",
  "nir_block_unstructured_next",
  "nir_break_if",
  "nir_build_addr_iadd",
  ...
  "nir_builder_alu_instr_finish_and_insert",
  "nir_builder_at",
  "nir_builder_cf_insert",
  "nir_builder_create",
  "nir_builder_init_simple_shader",
  "nir_builder_instr_insert",
  "nir_builder_instr_insert_at_top",
  "nir_builder_is_inside_cf",
  "nir_builder_last_instr",
  "nir_calc_dominance",
  "nir_calc_dominance_impl",
  "nir_calc_use_dominance_impl",
  "nir_call_instr",
  "nir_call_instr_create",
  "nir_call_serialized",
  ...
  "nir_channel",
  "nir_channel_or_undef",
  "nir_channels",
  "nir_chase_binding",
  "nir_cleanup_functions",
  "nir_clear_mediump_io_flag",
  "nir_clear_shared_memory",
  "nir_clone_deref_instr",
  "nir_clone_uniform_variable",
  "nir_cmat_signed",
  "nir_cmat_signed__enumvalues",
  "nir_collect_src_uniforms",
  "nir_combine_barrier_cb",
  "nir_combined_align",
  ...
  "nir_component_mask_t",
  "nir_const_value",
  "nir_const_value_as_bool",
  "nir_const_value_as_float",
  "nir_const_value_as_int",
  "nir_const_value_as_uint",
  "nir_const_value_for_bool",
  "nir_const_value_for_float",
  "nir_const_value_for_int",
  "nir_const_value_for_raw_uint",
  "nir_const_value_for_uint",
  "nir_const_value_negative_equal",
  "nir_constant",
  "nir_constant_clone",
  "nir_convert_from_ssa",
  "nir_convert_loop_to_lcssa",
  "nir_convert_to_bit_size",
  ...
  "nir_def_is_frag_coord_z",
  "nir_def_is_unused",
  "nir_def_last_component_read",
  "nir_def_only_used_by_if",
  "nir_def_replace",
  ...
  "nir_deref_instr_remove_if_unused",
  "nir_deref_mode_is",
  "nir_deref_mode_is_in_set",
  "nir_deref_mode_is_one_of",
  "nir_deref_mode_may_be",
  "nir_deref_mode_must_be",
  "nir_deref_type",
  "nir_deref_type__enumvalues",
  ...
  "nir_divergence_options",
  "nir_divergence_options__enumvalues",
  ...
  "nir_dump_cfg",
  "nir_dump_cfg_impl",
  "nir_dump_dom_frontier",
  "nir_dump_dom_frontier_impl",
  "nir_dump_dom_tree",
  "nir_dump_dom_tree_impl",
  "nir_explicit_io_address_from_deref",
  "nir_extract_bits",
  "nir_extract_i8_imm",
  "nir_extract_u8_imm",
  ...
  "nir_fixup_deref_types",
  "nir_fixup_is_exported",
  "nir_fle_imm",
  "nir_fmul_imm",
  "nir_foreach_def_cb",
  "nir_foreach_function_with_impl_first",
  ...
  "nir_get_io_arrayed_index_src",
  "nir_get_io_arrayed_index_src_number",
  "nir_get_io_index_src",
  "nir_get_io_index_src_number",
  "nir_get_io_intrinsic",
  ...
  "nir_instr_clear_src",
  "nir_instr_clone",
  "nir_instr_clone_deep",
  "nir_instr_debug_info",
  "nir_instr_def",
  "nir_instr_dominates_use",
  "nir_instr_filter_cb",
  "nir_instr_free",
  "nir_instr_free_and_dce",
  "nir_instr_free_list",
  "nir_instr_get_debug_info",
  "nir_instr_get_gc_pointer",
  "nir_instr_init_src",
  "nir_instr_insert",
  "nir_instr_insert_after",
  "nir_instr_insert_after_block",
  "nir_instr_insert_after_cf",
  "nir_instr_insert_after_cf_list",
  ...
  "nir_io_mediump_is_32bit",
  "nir_io_mix_convergent_flat_with_interpolated",
  "nir_io_options",
  "nir_io_options__enumvalues",
  ...
  "nir_is_load_reg",
  "nir_is_output_load",
  "nir_is_rounding_mode_rtne",
  "nir_is_rounding_mode_rtz",
  "nir_is_same_comp_swizzle",
  "nir_is_sequential_comp_swizzle",
  "nir_is_store_reg",
  "nir_ishl_imm",
  "nir_ishr_imm",
  ...
  "nir_jump_halt",
  "nir_jump_instr",
  "nir_jump_instr_create",
  "nir_jump_return",
  "nir_jump_type",
  "nir_jump_type__enumvalues",
  "nir_last_intrinsic",
  "nir_last_opcode",
  "nir_legalize_16bit_sampler_srcs",
  ...
  "nir_load_grouping",
  "nir_load_grouping__enumvalues",
  "nir_load_param",
  "nir_load_reg",
  "nir_load_reg_for_def",
  ...
  "nir_log_shader_annotated_tagged",
  "nir_loop",
  "nir_loop_analyze_impl",
  "nir_loop_continue_target",
  "nir_loop_control",
  "nir_loop_control__enumvalues",
  "nir_loop_control_dont_unroll",
  "nir_loop_control_none",
  "nir_loop_control_unroll",
  "nir_loop_create",
  ...
  "nir_lower_doubles_op_to_options_mask",
  "nir_lower_doubles_options",
  "nir_lower_doubles_options__enumvalues",
  ...
  "nir_lower_int64_options__enumvalues",
  "nir_lower_int_to_float",
  "nir_lower_interpolation",
  ...
  "nir_lower_io_options",
  "nir_lower_io_options__enumvalues",
  "nir_lower_io_passes",
  ...
  "nir_lower_shader_calls_should_remat_func",
  "nir_lower_shift64",
  "nir_lower_single_sampled",
  "nir_lower_ssa_defs_to_regs_block",
  "nir_lower_ssbo",
  ...
  "nir_lower_undef_to_zero",
  "nir_lower_uniforms_to_ubo",
  "nir_lower_usub_sat64",
  "nir_lower_var_copies",
  "nir_lower_var_copy_instr",
  "nir_lower_variable_initializers",
  "nir_lower_vars_to_explicit_types",
  "nir_lower_vars_to_scratch",
  ...
  "nir_memcpy_deref_with_access",
  "nir_memory_semantics",
  "nir_memory_semantics__enumvalues",
  "nir_metadata",
  "nir_metadata__enumvalues",
  "nir_metadata_all",
  ...
  "nir_op_algebraic_property__enumvalues",
  ...
  "nir_opt_varyings_progress__enumvalues",
  "nir_opt_vectorize",
  ...
  "nir_push_loop",
  "nir_ray_query_value",
  "nir_ray_query_value__enumvalues",
  ...
  "nir_rematerialize_deref_in_use_blocks",
  "nir_rematerialize_derefs_in_use_blocks_impl",
  "nir_remove_dead_derefs",
  "nir_remove_dead_derefs_impl",
  "nir_remove_dead_variables",
  "nir_remove_dead_variables_options",
  "nir_remove_entrypoints",
  "nir_remove_non_entrypoints",
  "nir_remove_non_exported",
  "nir_remove_single_src_phis_block",
  "nir_remove_sysval_output",
  "nir_remove_tex_shadow",
  "nir_remove_unused_io_vars",
  "nir_remove_unused_varyings",
  "nir_remove_varying",
  "nir_repair_ssa",
  ...
  "nir_rewrite_image_intrinsic",
  "nir_rewrite_uses_to_load_reg",
  "nir_round_down_components",
  "nir_round_up_components",
  "nir_rounding_mode",
  "nir_rounding_mode__enumvalues",
  "nir_rounding_mode_rd",
  "nir_rounding_mode_rtne",
  "nir_rounding_mode_rtz",
  "nir_rounding_mode_ru",
  "nir_rounding_mode_undef",
  "nir_samples_identical_deref",
  "nir_scalar",
  "nir_scalar_alu_op",
  "nir_scalar_as_bool",
  "nir_scalar_as_const_value",
  "nir_scalar_as_float",
  "nir_scalar_as_int",
  "nir_scalar_as_uint",
  "nir_scalar_chase_alu_src",
  "nir_scalar_chase_movs",
  "nir_scalar_equal",
  "nir_scalar_intrinsic_op",
  "nir_scalar_is_alu",
  "nir_scalar_is_const",
  "nir_scalar_is_intrinsic",
  "nir_scalar_is_undef",
  "nir_scalar_resolved",
  "nir_scale_fdiv",
  ...
  "nir_selection_control__enumvalues",
  ...
  "nir_shader_get_function_for_name",
  "nir_shader_get_preamble",
  "nir_shader_index_vars",
  "nir_shader_instructions_pass",
  ...
  "nir_steal_tex_src",
  "nir_store_array_var",
  "nir_store_array_var_imm",
  "nir_store_deref",
  "nir_store_deref_with_access",
  "nir_store_global",
  "nir_store_reg",
  "nir_store_reg_for_def",
  "nir_store_var",
  "nir_sweep",
  "nir_swizzle",
  "nir_system_value_from_intrinsic",
  ...
  "nir_var_uniform",
  "nir_var_vec_indexable_modes",
  "nir_variable",
  "nir_variable_clone",
  "nir_variable_count_slots",
  "nir_variable_create",
  "nir_variable_data",
  "nir_variable_is_global",
  "nir_variable_is_in_block",
  "nir_variable_is_in_ssbo",
  "nir_variable_is_in_ubo",
  "nir_variable_mode",
  "nir_variable_mode__enumvalues",
  "nir_vec",
  "nir_vec_scalars",
  "nir_vector_extract",
  "nir_vector_insert",
  ...
  "struct_c__SA_nir_output_deps",
  "struct_c__SA_nir_output_deps_0",
  "struct_exec_list",
  "struct_exec_node",
  "struct_gallivm_state",
  "struct_gc_ctx",
  "struct_glsl_cmat_description",
  "struct_glsl_struct_field",
  "struct_glsl_struct_field_0_0",
  "struct_glsl_type",
  "struct_hash_entry",
  "struct_hash_table",
  "struct_linear_ctx",
  "struct_list_head",
  "struct_lp_bld_tgsi_system_values",
  "struct_lp_build_context",
  "struct_lp_build_coro_suspend_info",
  "struct_lp_build_fn",
  "struct_lp_build_for_loop_state",
  "struct_lp_build_fs_iface",
  "struct_lp_build_gs_iface",
  "struct_lp_build_if_state",
  "struct_lp_build_image_soa",
  "struct_lp_build_loop_state",
  "struct_lp_build_mask_context",
  "struct_lp_build_mesh_iface",
  "struct_lp_build_sampler_aos",
  "struct_lp_build_sampler_soa",
  "struct_lp_build_skip_context",
  "struct_lp_build_tcs_iface",
  "struct_lp_build_tes_iface",
  "struct_lp_build_tgsi_params",
  "struct_lp_cached_code",
  "struct_lp_context_ref",
  "struct_lp_derivatives",
  "struct_lp_descriptor",
  "struct_lp_descriptor_0_0",
  "struct_lp_descriptor_0_1",
  "struct_lp_generated_code",
  "struct_lp_img_params",
  "struct_lp_jit_bindless_texture",
  "struct_lp_jit_buffer",
  "struct_lp_jit_image",
  "struct_lp_jit_resources",
  "struct_lp_jit_sampler",
  "struct_lp_jit_texture",
  "struct_lp_jit_texture_0_0",
  "struct_lp_passmgr",
  "struct_lp_sampler_dynamic_state",
  "struct_lp_sampler_params",
  "struct_lp_sampler_size_query_params",
  "struct_lp_static_texture_state",
  "struct_lp_texture_functions",
  "struct_lp_texture_handle",
  "struct_lp_texture_handle_state",
  "struct_lp_type",
  "struct_nak_compiler",
  "struct_nak_fs_key",
  "struct_nak_qmd_cbuf",
  "struct_nak_qmd_cbuf_desc_layout",
  "struct_nak_qmd_dispatch_size_layout",
  "struct_nak_qmd_info",
  "struct_nak_sample_location",
  "struct_nak_sample_mask",
  "struct_nak_shader_bin",
  "struct_nak_shader_info",
  "struct_nak_shader_info_0_cs",
  "struct_nak_shader_info_0_fs",
  "struct_nak_shader_info_0_ts",
  "struct_nak_shader_info_vtg",
  "struct_nak_xfb_info",
  "struct_nir_alu_instr",
  "struct_nir_alu_src",
  "struct_nir_binding",
  "struct_nir_block",
  "struct_nir_builder",
  "struct_nir_call_instr",
  "struct_nir_cf_node",
  "struct_nir_constant",
  "struct_nir_cursor",
  "struct_nir_def",
  "struct_nir_deref_instr",
  "struct_nir_deref_instr_1_arr",
  "struct_nir_deref_instr_1_cast",
  "struct_nir_deref_instr_1_strct",
  "struct_nir_function",
  "struct_nir_function_impl",
  "struct_nir_if",
  "struct_nir_input_attachment_options",
  "struct_nir_instr",
  "struct_nir_instr_debug_info",
  "struct_nir_intrinsic_info",
  "struct_nir_intrinsic_instr",
  "struct_nir_io_semantics",
  "struct_nir_io_xfb",
  "struct_nir_io_xfb_0",
  "struct_nir_jump_instr",
  "struct_nir_load_const_instr",
  "struct_nir_load_store_vectorize_options",
  "struct_nir_loop",
  "struct_nir_loop_induction_variable",
  "struct_nir_loop_info",
  "struct_nir_loop_terminator",
  "struct_nir_lower_bitmap_options",
  "struct_nir_lower_compute_system_values_options",
  "struct_nir_lower_drawpixels_options",
  "struct_nir_lower_idiv_options",
  "struct_nir_lower_image_options",
  "struct_nir_lower_mem_access_bit_sizes_options",
  ...
  "struct_nir_phi_instr",
  "struct_nir_phi_src",
  "struct_nir_remove_dead_variables_options",
  "struct_nir_scalar",
  "struct_nir_shader",
  "struct_nir_shader_compiler_options",
  "struct_nir_split_conversions_options",
  "struct_nir_src",
  "struct_nir_state_slot",
  "struct_nir_tex_instr",
  "struct_nir_tex_src",
  ...
  "struct_nir_use_dominance_state",
  "struct_nir_variable",
  "struct_nir_variable_data",
  "struct_nir_variable_data_0_image",
  "struct_nir_variable_data_0_sampler",
  "struct_nir_variable_data_0_xfb",
  "struct_nir_xfb_info",
  "struct_nv_device_info",
  "struct_nv_device_info_pci",
  "struct_set",
  "struct_set_entry",
  "struct_shader_info",
  "struct_shader_info_0_cs",
  "struct_shader_info_0_fs",
  "struct_shader_info_0_gs",
  "struct_shader_info_0_mesh",
  "struct_shader_info_0_tess",
  "struct_shader_info_0_vs",
  "struct_tgsi_shader_info",
  "struct_u_printf_info",
  "struct_util_format_block",
  "struct_util_format_channel_description",
  "struct_util_format_description",
  "tess_primitive_mode",
  "tgsi_texture_type",
  "u_printf_info",
  "uint16_t",
  ...
  "uint64_t",
  "uint8_t",
  "union_c__UA_nir_const_value",
  "union_glsl_struct_field_0",
  "union_glsl_type_fields",
  "union_lp_descriptor_0",
  "union_lp_jit_buffer_0",
  "union_lp_jit_texture_0",
  "union_nak_shader_info_0",
  "union_nir_cursor_0",
  "union_nir_deref_instr_0",
  "union_nir_deref_instr_1",
  "union_nir_parallel_copy_entry_dest",
  "union_nir_variable_data_0",
  "union_shader_info_0",
  "union_util_format_description_0",
  "util_format_colorspace",
  "util_format_layout",
  "va_list",
]
lvp_nir_options = gzip.decompress(
  base64.b64decode(
...
def __getattr__(nm):
  raise (
    AttributeError(
      "LLVMpipe requires tinymesa_cpu"
      if "tinymesa_cpu" not in dll._name
      else f"attribute {nm} not found"
    )
    if dll
    else FileNotFoundError(
      f"libtinymesa not found (MESA_PATH={BASE}). See https://github.com/sirhcm/tinymesa (tinymesa-32dc66c, mesa-25.2.4)"
    )
  )
