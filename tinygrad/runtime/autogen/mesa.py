...
nir_instr_writemask_filter_cb = ctypes.CFUNCTYPE(
  ctypes.c_bool, ctypes.POINTER(struct_nir_instr), ctypes.c_uint32, ctypes.POINTER(None)
)
...
try:
  ...
  nir_lower_amul.argtypes = [
    ctypes.POINTER(struct_nir_shader),
    ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_glsl_type), ctypes.c_bool),
  ]
except AttributeError:
  pass
try:
...
struct_nir_lower_tex_options._fields_ = [
  ...
  (
    ...
    ctypes.CFUNCTYPE(
      nir_lower_tex_packing, ctypes.POINTER(struct_nir_tex_instr), ctypes.POINTER(None)
    ),
  ),
...
struct_nir_opt_offsets_options._fields_ = [
  ...
  (
    "max_offset_cb",
    ctypes.CFUNCTYPE(
      ctypes.c_uint32, ctypes.POINTER(struct_nir_intrinsic_instr), ctypes.POINTER(None)
    ),
  ),
