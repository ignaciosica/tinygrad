...
try:
  ...
  __nvJitLinkCreate_12_4.argtypes = [
    ctypes.POINTER(ctypes.POINTER(struct_nvJitLink)),
    uint32_t,
    ctypes.POINTER(ctypes.POINTER(ctypes.c_char)),
  ]
except AttributeError:
...
try:
  ...
  __nvJitLinkDestroy_12_4.argtypes = [
    ctypes.POINTER(ctypes.POINTER(struct_nvJitLink))
  ]
except AttributeError:
  pass
...
try:
  ...
  __nvJitLinkAddData_12_4.argtypes = [
    nvJitLinkHandle,
    nvJitLinkInputType,
    ctypes.POINTER(None),
    size_t,
...
try:
  ...
  __nvJitLinkAddFile_12_4.argtypes = [
    nvJitLinkHandle,
    nvJitLinkInputType,
    ctypes.POINTER(ctypes.c_char),
  ]
...
try:
  ...
  pass
try:
  __nvJitLinkGetLinkedCubin_12_4 = _libraries[
    "libnvJitLink.so"
...
try:
  ...
  nvJitLinkGetLinkedPtxSize.argtypes = [
    nvJitLinkHandle,
    ctypes.POINTER(ctypes.c_uint64),
  ]
except AttributeError:
  pass
try:
  __nvJitLinkGetLinkedPtx_12_4 = _libraries[
    "libnvJitLink.so"
  ].__nvJitLinkGetLinkedPtx_12_4
  __nvJitLinkGetLinkedPtx_12_4.restype = nvJitLinkResult
  __nvJitLinkGetLinkedPtx_12_4.argtypes = [
    nvJitLinkHandle,
    ctypes.POINTER(ctypes.c_char),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  __nvJitLinkGetErrorLogSize_12_4 = _libraries[
    "libnvJitLink.so"
  ].__nvJitLinkGetErrorLogSize_12_4
  __nvJitLinkGetErrorLogSize_12_4.restype = nvJitLinkResult
  __nvJitLinkGetErrorLogSize_12_4.argtypes = [
    nvJitLinkHandle,
    ctypes.POINTER(ctypes.c_uint64),
  ]
except AttributeError:
...
try:
  ...
  nvJitLinkGetErrorLogSize.argtypes = [
    nvJitLinkHandle,
    ctypes.POINTER(ctypes.c_uint64),
  ]
except AttributeError:
  pass
try:
  __nvJitLinkGetErrorLog_12_4 = _libraries[
    "libnvJitLink.so"
  ].__nvJitLinkGetErrorLog_12_4
  __nvJitLinkGetErrorLog_12_4.restype = nvJitLinkResult
  __nvJitLinkGetErrorLog_12_4.argtypes = [
    nvJitLinkHandle,
    ctypes.POINTER(ctypes.c_char),
  ]
except AttributeError:
...
try:
  ...
  pass
try:
  __nvJitLinkGetInfoLogSize_12_4 = _libraries[
    "libnvJitLink.so"
  ].__nvJitLinkGetInfoLogSize_12_4
  __nvJitLinkGetInfoLogSize_12_4.restype = nvJitLinkResult
  __nvJitLinkGetInfoLogSize_12_4.argtypes = [
    nvJitLinkHandle,
    ctypes.POINTER(ctypes.c_uint64),
  ]
except AttributeError:
...
try:
  ...
  nvJitLinkGetInfoLogSize.argtypes = [
    nvJitLinkHandle,
    ctypes.POINTER(ctypes.c_uint64),
  ]
except AttributeError:
...
__all__ = [
  ...
  "NVRTC_SUCCESS",
  "__nvJitLinkAddData_12_4",
  "__nvJitLinkAddFile_12_4",
  "__nvJitLinkComplete_12_4",
  "__nvJitLinkCreate_12_4",
  "__nvJitLinkDestroy_12_4",
  "__nvJitLinkGetErrorLogSize_12_4",
  "__nvJitLinkGetErrorLog_12_4",
  "__nvJitLinkGetInfoLogSize_12_4",
  "__nvJitLinkGetInfoLog_12_4",
  ...
  "__nvJitLinkGetLinkedPtxSize_12_4",
  "__nvJitLinkGetLinkedPtx_12_4",
  "c__EA_nvJitLinkInputType",
  "c__EA_nvJitLinkResult",
  "c__EA_nvrtcResult",
  "nvJitLinkAddData",
  "nvJitLinkAddFile",
  "nvJitLinkComplete",
  ...
  "nvJitLinkHandle",
  "nvJitLinkInputType",
  "nvJitLinkInputType__enumvalues",
  "nvJitLinkResult",
  "nvJitLinkResult__enumvalues",
  "nvJitLinkVersion",
