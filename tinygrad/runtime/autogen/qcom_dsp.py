...
def _do_ioctl(__idir, __base, __nr, __user_struct, __fd, *args, **kwargs):
  ret = fcntl.ioctl(
    __fd,
    (__idir << 30)
    | (ctypes.sizeof(made := __user_struct(*args, **kwargs)) << 16)
    | (__base << 8)
    | __nr,
    made,
  )
  if ret != 0:
    raise OSError(f"ioctl returned {ret}")
  return made
...
FASTRPC_IOCTL_INVOKE = _IOWR(
  "R", 1, struct_fastrpc_ioctl_invoke
)  # macro (from list)
...
FASTRPC_IOCTL_INVOKE_FD = _IOWR(
  "R", 4, struct_fastrpc_ioctl_invoke_fd
)  # macro (from list)
...
FASTRPC_IOCTL_INVOKE_ATTRS = _IOWR(
  "R", 7, struct_fastrpc_ioctl_invoke_attrs
)  # macro (from list)
...
FASTRPC_IOCTL_INVOKE_CRC = _IOWR(
  "R", 11, struct_fastrpc_ioctl_invoke_crc
)  # macro (from list)
...
FASTRPC_IOCTL_INIT_ATTRS = _IOWR(
  "R", 10, struct_fastrpc_ioctl_init_attrs
)  # macro (from list)
...
FASTRPC_IOCTL_MUNMAP = _IOWR(
  "R", 3, struct_fastrpc_ioctl_munmap
)  # macro (from list)
...
FASTRPC_IOCTL_MUNMAP_64 = _IOWR(
  "R", 15, struct_fastrpc_ioctl_munmap_64
)  # macro (from list)
...
FASTRPC_IOCTL_MMAP_64 = _IOWR(
  "R", 14, struct_fastrpc_ioctl_mmap_64
)  # macro (from list)
...
FASTRPC_IOCTL_MUNMAP_FD = _IOWR(
  "R", 13, struct_fastrpc_ioctl_munmap_fd
)  # macro (from list)
...
FASTRPC_IOCTL_CONTROL = _IOWR(
  "R", 12, struct_fastrpc_ioctl_control
)  # macro (from list)
...
struct_fastrpc_async_callback._fields_ = [
  (
    "fn",
    ctypes.CFUNCTYPE(None, ctypes.c_uint64, ctypes.POINTER(None), ctypes.c_int32),
  ),
...
try:
  ...
  remote_handle_invoke.argtypes = [
    remote_handle,
    uint32_t,
    ctypes.POINTER(union_c__UA_remote_arg),
  ]
except AttributeError:
  pass
try:
  ...
  remote_handle64_invoke.argtypes = [
    remote_handle64,
    uint32_t,
    ctypes.POINTER(union_c__UA_remote_arg),
  ]
...
try:
  ...
  remote_handle_invoke_async.argtypes = [
    remote_handle,
    ctypes.POINTER(struct_fastrpc_async_descriptor),
    uint32_t,
    ctypes.POINTER(union_c__UA_remote_arg),
  ]
except AttributeError:
...
try:
  ...
  remote_handle64_control.argtypes = [
    remote_handle64,
    uint32_t,
    ctypes.POINTER(None),
    uint32_t,
...
try:
  ...
  remote_register_buf_attr.argtypes = [
    ctypes.POINTER(None),
    ctypes.c_int32,
    ctypes.c_int32,
    ctypes.c_int32,
...
try:
  ...
  pass
try:
  remote_register_dma_handle_attr = _libraries[
    "FIXME_STUB"
...
try:
  ...
  fastrpc_async_get_status.argtypes = [
    fastrpc_async_jobid,
    ctypes.c_int32,
...
try:
  ...
  apps_std_fopen_with_env.argtypes = [
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
...
try:
  ...
  pass
try:
  apps_std_get_search_paths_with_env = _libraries[
    "FIXME_STUB"
  ].apps_std_get_search_paths_with_env
  apps_std_get_search_paths_with_env.restype = ctypes.c_int32
  apps_std_get_search_paths_with_env.argtypes = [
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(struct__cstring1_s),
    ctypes.c_int32,
    ctypes.POINTER(ctypes.c_uint32),
...
try:
  ...
  apps_std_opendir.argtypes = [
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(struct_apps_std_DIR),
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  apps_std_readdir.argtypes = [
    ctypes.POINTER(struct_apps_std_DIR),
    ctypes.POINTER(struct_apps_std_DIRENT),
    ctypes.POINTER(ctypes.c_int32),
  ]
except AttributeError:
  pass
...
try:
  ...
  apps_std_stat.argtypes = [
    ctypes.POINTER(ctypes.c_char),
    ctypes.POINTER(struct_apps_std_STAT),
  ]
except AttributeError:
  pass
try:
...
__all__ = [
  ...
  "CAMERA_SECURE_CP_USAGE",
  "CDSP_DOMAIN",
  "CDSP_DOMAIN_ID",
  "DEFAULT_DOMAIN_ID",
  "DEVICE_NAME",
  "DISPLAY_SECURE_CP_USAGE",
  "DOMAIN_ID_MASK",
  "DOMAIN_SUPPORT",
  ...
  "FASTRPC_CONTROL_KALLOC",
  "FASTRPC_CONTROL_LATENCY",
  "FASTRPC_CONTROL_PD_DUMP",
  "FASTRPC_CONTROL_SMMU",
  "FASTRPC_DSP_SSR",
  "FASTRPC_GLINK_GUID",
  "FASTRPC_INIT_ATTACH",
  "FASTRPC_INIT_ATTACH_SENSORS",
  "FASTRPC_INIT_CREATE",
  ...
  "FASTRPC_MODE_PARALLEL",
  "FASTRPC_MODE_PROFILE",
  "FASTRPC_MODE_SERIAL",
  "FASTRPC_MODE_SESSION",
  ...
  "ION_FLAG_CP_CAMERA",
  "ION_FLAG_CP_HLOS",
  "ION_FLAG_CP_HLOS_FREE",
  "ION_FLAG_CP_NON_PIXEL",
  "ION_FLAG_CP_PIXEL",
  "ION_FLAG_CP_SEC_DISPLAY",
  "ION_FLAG_CP_TOUCH",
  "ION_FLAG_FORCE_CONTIGUOUS",
  "ION_FLAG_POOL_FORCE_ALLOC",
  "ION_FLAG_POOL_PREFETCH",
  "ION_FLAG_SECURE",
  "ION_FORCE_CONTIGUOUS",
  ...
  "VTCM_COUNT",
  "VTCM_PAGE",
  "_32BIT_PLACEHOLDER_apps_std_SEEK",
  "_APPS_STD_H",
  "_IO",
  "_IOR",
  "_IOW",
  ...
  "remote_rpc_status_flags_t__enumvalues",
  "remote_session_control",
  "remote_set_mode",
  "session_control_req_id",
  "size_t",
  "smq_invoke_buf_start",
  "smq_phy_page_start",
  "struct__cstring1_s",
  "struct_apps_std_DIR",
  "struct_apps_std_DIRENT",
  "struct_apps_std_STAT",
  "struct_c__SA_remote_buf",
  "struct_c__SA_remote_dma_handle",
  "struct_fastrpc_async_callback",
  "struct_fastrpc_async_descriptor",
  "struct_fastrpc_ctrl_kalloc",
  "struct_fastrpc_ctrl_latency",
  "struct_fastrpc_ctrl_smmu",
  "struct_fastrpc_ioctl_control",
  "struct_fastrpc_ioctl_init",
  "struct_fastrpc_ioctl_init_attrs",
  "struct_fastrpc_ioctl_invoke",
  "struct_fastrpc_ioctl_invoke_attrs",
  "struct_fastrpc_ioctl_invoke_crc",
  "struct_fastrpc_ioctl_invoke_fd",
  "struct_fastrpc_ioctl_mmap",
  "struct_fastrpc_ioctl_mmap_64",
  "struct_fastrpc_ioctl_munmap",
  "struct_fastrpc_ioctl_munmap_64",
  "struct_fastrpc_ioctl_munmap_fd",
  "struct_fastrpc_ioctl_perf",
  "struct_ion_allocation_data",
  "struct_ion_custom_data",
  "struct_ion_fd_data",
  "struct_ion_flush_data",
  "struct_ion_handle_data",
  "struct_ion_prefetch_data",
  "struct_ion_prefetch_regions",
  "struct_remote_buf",
  "struct_remote_buf64",
  "struct_remote_dma_handle",
  "struct_remote_dma_handle64",
  "struct_remote_dsp_capability",
  "struct_remote_process_type",
  "struct_remote_rpc_control_latency",
  ...
  "struct_remote_rpc_thread_params",
  "struct_smq_invoke",
  "struct_smq_invoke_buf",
  "struct_smq_invoke_rsp",
  "struct_smq_msg",
  "struct_smq_null_invoke",
  "struct_smq_phy_page",
  "uint32_t",
  "uint64_t",
  "union_c__UA_remote_arg",
  "union_fastrpc_async_descriptor_0",
  "union_fastrpc_ioctl_control_0",
  "union_remote_arg",
  "union_remote_arg64",
]
