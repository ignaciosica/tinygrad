...
struct_rgp_sqtt_marker_cb_start._anonymous_ = (
  "_0",
  "_1",
  "_2",
  "_3",
...
struct_rgp_sqtt_marker_cb_end._anonymous_ = (
  "_0",
  "_1",
  "_2",
)
...
struct_rgp_sqtt_marker_event._anonymous_ = (
  "_0",
  "_1",
  "_2",
)
...
struct_rgp_sqtt_marker_barrier_start._anonymous_ = (
  "_0",
  "_1",
)
...
struct_rgp_sqtt_marker_barrier_end._anonymous_ = (
  "_0",
  "_1",
)
...
struct_rgp_sqtt_marker_layout_transition._anonymous_ = (
  "_0",
  "_1",
)
...
struct_rgp_sqtt_marker_pipeline_bind._anonymous_ = (
  "_0",
  "_1",
)
...
__all__ = [
  ...
  "ApiCmdBindDescriptorSets",
  "ApiCmdBindIndexBuffer",
  "ApiCmdBindPipeline",
  "ApiCmdBindVertexBuffers",
  "ApiCmdBlitImage",
  "ApiCmdClearAttachments",
  "ApiCmdClearColorImage",
  "ApiCmdClearDepthStencilImage",
  "ApiCmdCopyBuffer",
  "ApiCmdCopyBufferToImage",
  "ApiCmdCopyImage",
  "ApiCmdCopyImageToBuffer",
  "ApiCmdCopyQueryPoolResults",
  "ApiCmdDispatch",
  "ApiCmdDispatchIndirect",
  "ApiCmdDraw",
  "ApiCmdDrawIndexed",
  "ApiCmdDrawIndexedIndirect",
  "ApiCmdDrawIndexedIndirectCount",
  "ApiCmdDrawIndexedIndirectCountAMD",
  "ApiCmdDrawIndirect",
  "ApiCmdDrawIndirectCount",
  "ApiCmdDrawIndirectCountAMD",
  "ApiCmdDrawMeshTasksEXT",
  "ApiCmdDrawMeshTasksIndirectCountEXT",
  "ApiCmdDrawMeshTasksIndirectEXT",
  "ApiCmdEndQuery",
  "ApiCmdEndRenderPass",
  ...
  "ApiCmdPushConstants",
  "ApiCmdResetQueryPool",
  "ApiCmdResolveImage",
  "ApiCmdSetBlendConstants",
  "ApiCmdSetDepthBias",
  "ApiCmdSetDepthBounds",
  "ApiCmdSetLineWidth",
  "ApiCmdSetScissor",
  "ApiCmdSetStencilCompareMask",
  "ApiCmdSetStencilReference",
  ...
  "EventCmdCopyBuffer",
  "EventCmdCopyBufferToImage",
  "EventCmdCopyImage",
  "EventCmdCopyImageToBuffer",
  "EventCmdCopyMemoryToAccelerationStructureKHR",
  "EventCmdCopyQueryPoolResults",
  "EventCmdDispatch",
  "EventCmdDispatchIndirect",
  "EventCmdDraw",
  "EventCmdDrawIndexed",
  "EventCmdDrawIndexedIndirect",
  "EventCmdDrawIndexedIndirectCount",
  "EventCmdDrawIndexedIndirectCountAMD",
  "EventCmdDrawIndirect",
  "EventCmdDrawIndirectCount",
  "EventCmdDrawIndirectCountAMD",
  "EventCmdDrawMeshTasksEXT",
  "EventCmdDrawMeshTasksIndirectCountEXT",
  "EventCmdDrawMeshTasksIndirectEXT",
  "EventCmdFillBuffer",
  "EventCmdPipelineBarrier",
  "EventCmdResetQueryPool",
  "EventCmdResolveImage",
  "EventCmdTraceRaysIndirectKHR",
  "EventCmdTraceRaysKHR",
  "EventCmdUpdateBuffer",
  "EventCmdWaitEvents",
  "EventInternalUnknown",
  "EventInvalid",
  "EventRenderPassColorClear",
  "EventRenderPassDepthStencilClear",
  "EventRenderPassResolve",
  "EventUnknown",
  ...
  "SQTT_FILE_VERSION_MINOR",
  "SQTT_GFXIP_LEVEL_GFXIP_10_1",
  "SQTT_GFXIP_LEVEL_GFXIP_10_3",
  "SQTT_GFXIP_LEVEL_GFXIP_11_0",
  "SQTT_GFXIP_LEVEL_GFXIP_11_5",
  "SQTT_GFXIP_LEVEL_GFXIP_12",
  "SQTT_GFXIP_LEVEL_GFXIP_6",
  "SQTT_GFXIP_LEVEL_GFXIP_7",
  "SQTT_GFXIP_LEVEL_GFXIP_8",
  "SQTT_GFXIP_LEVEL_GFXIP_8_1",
  "SQTT_GFXIP_LEVEL_GFXIP_9",
  "SQTT_GFXIP_LEVEL_NONE",
  "SQTT_GPU_NAME_MAX_SIZE",
  "SQTT_GPU_TYPE_DISCRETE",
  "SQTT_GPU_TYPE_INTEGRATED",
  "SQTT_GPU_TYPE_UNKNOWN",
  "SQTT_GPU_TYPE_VIRTUAL",
  "SQTT_INSTRUCTION_TRACE_API_PSO",
  "SQTT_INSTRUCTION_TRACE_DISABLED",
  "SQTT_INSTRUCTION_TRACE_FULL_FRAME",
  "SQTT_MAX_NUM_SE",
  "SQTT_MEMORY_TYPE_DDR",
  "SQTT_MEMORY_TYPE_DDR2",
  "SQTT_MEMORY_TYPE_DDR3",
  "SQTT_MEMORY_TYPE_DDR4",
  "SQTT_MEMORY_TYPE_DDR5",
  "SQTT_MEMORY_TYPE_GDDR3",
  "SQTT_MEMORY_TYPE_GDDR4",
  "SQTT_MEMORY_TYPE_GDDR5",
  "SQTT_MEMORY_TYPE_GDDR6",
  "SQTT_MEMORY_TYPE_HBM",
  "SQTT_MEMORY_TYPE_HBM2",
  "SQTT_MEMORY_TYPE_HBM3",
  "SQTT_MEMORY_TYPE_LPDDR4",
  "SQTT_MEMORY_TYPE_LPDDR5",
  "SQTT_MEMORY_TYPE_UNKNOWN",
  "SQTT_PROFILING_MODE_INDEX",
  "SQTT_PROFILING_MODE_PRESENT",
  "SQTT_PROFILING_MODE_TAG",
  ...
  "rgp_sqtt_marker_identifier",
  "rgp_sqtt_marker_user_event_type",
  "sqtt_api_type",
  "sqtt_engine_type",
  "sqtt_file_chunk_asic_info_flags",
  "sqtt_file_chunk_type",
  "sqtt_gfxip_level",
  "sqtt_gpu_type",
  "sqtt_instruction_trace_mode",
  "sqtt_memory_type",
  "sqtt_profiling_mode",
  "sqtt_queue_event_type",
  "sqtt_queue_type",
  "sqtt_version",
  ...
  "struct_sqtt_file_chunk_header",
  "struct_sqtt_file_chunk_id",
  ...
  "struct_sqtt_file_header",
  "struct_sqtt_file_header_flags",
  ...
  "union_rgp_sqtt_marker_cb_end_2",
  "union_rgp_sqtt_marker_cb_id",
  ...
  "union_rgp_sqtt_marker_event_0",
  "union_rgp_sqtt_marker_event_1",
  ...
  "union_rgp_sqtt_marker_user_event_0",
  "union_sqtt_data_info_0",
