...
def _IO(base, nr):
  return functools.partial(_do_ioctl_io, 0, ord(base) if isinstance(base, str) else base, nr)
...
__all__ = [
  ...
  "_IOW",
  "_IOWR",
  "c__Ea_VFIO_CCW_CONFIG_REGION_INDEX",
  "c__Ea_VFIO_CCW_IO_IRQ_INDEX",
  "c__Ea_VFIO_PCI_BAR0_REGION_INDEX",
  "c__Ea_VFIO_PCI_INTX_IRQ_INDEX",
  "struct_vfio_bitmap",
  "struct_vfio_device_feature",
  "struct_vfio_device_gfx_plane_info",
  "struct_vfio_device_info",
  "struct_vfio_device_ioeventfd",
  "struct_vfio_device_migration_info",
  "struct_vfio_eeh_pe_err",
  "struct_vfio_eeh_pe_op",
  "struct_vfio_group_status",
  ...
  "struct_vfio_iova_range",
  "struct_vfio_irq_info",
  "struct_vfio_irq_set",
  "struct_vfio_pci_dependent_device",
  "struct_vfio_pci_hot_reset",
  "struct_vfio_pci_hot_reset_info",
  "struct_vfio_region_gfx_edid",
  "struct_vfio_region_info",
  ...
  "union_vfio_device_gfx_plane_info_0",
  "union_vfio_eeh_pe_op_0",
]
