...
_libraries = {}
_libraries["webgpu"] = ctypes.CDLL(
  webgpu_support.WEBGPU_PATH
)  #  ctypes.CDLL('webgpu')
...
WGPUBufferMapCallback = ctypes.CFUNCTYPE(
  None, WGPUBufferMapAsyncStatus, ctypes.POINTER(None)
)
...
WGPUCompilationInfoCallback = ctypes.CFUNCTYPE(
  None,
  WGPUCompilationInfoRequestStatus,
  ctypes.POINTER(struct_WGPUCompilationInfo),
  ctypes.POINTER(None),
)
...
WGPUCreateComputePipelineAsyncCallback = ctypes.CFUNCTYPE(
  None,
  WGPUCreatePipelineAsyncStatus,
  ctypes.POINTER(struct_WGPUComputePipelineImpl),
  struct_WGPUStringView,
  ctypes.POINTER(None),
)
WGPUCreateRenderPipelineAsyncCallback = ctypes.CFUNCTYPE(
  None,
  WGPUCreatePipelineAsyncStatus,
...
WGPUDawnLoadCacheDataFunction = ctypes.CFUNCTYPE(
  ctypes.c_uint64,
  ctypes.POINTER(None),
  ctypes.c_uint64,
  ctypes.POINTER(None),
...
WGPUDawnStoreCacheDataFunction = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(None),
  ctypes.c_uint64,
  ctypes.POINTER(None),
...
WGPUDeviceLostCallback = ctypes.CFUNCTYPE(
  None, WGPUDeviceLostReason, struct_WGPUStringView, ctypes.POINTER(None)
)
WGPUDeviceLostCallbackNew = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(ctypes.POINTER(struct_WGPUDeviceImpl)),
  WGPUDeviceLostReason,
  struct_WGPUStringView,
  ctypes.POINTER(None),
)
WGPUErrorCallback = ctypes.CFUNCTYPE(
  None, WGPUErrorType, struct_WGPUStringView, ctypes.POINTER(None)
)
WGPULoggingCallback = ctypes.CFUNCTYPE(
  None, WGPULoggingType, struct_WGPUStringView, ctypes.POINTER(None)
)
WGPUPopErrorScopeCallback = ctypes.CFUNCTYPE(
  None,
...
WGPUQueueWorkDoneCallback = ctypes.CFUNCTYPE(
  None, WGPUQueueWorkDoneStatus, ctypes.POINTER(None)
)
WGPURequestAdapterCallback = ctypes.CFUNCTYPE(
  None,
  WGPURequestAdapterStatus,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  struct_WGPUStringView,
  ctypes.POINTER(None),
)
WGPURequestDeviceCallback = ctypes.CFUNCTYPE(
  None,
  WGPURequestDeviceStatus,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  struct_WGPUStringView,
  ctypes.POINTER(None),
)
WGPUBufferMapCallback2 = ctypes.CFUNCTYPE(
  None,
  WGPUMapAsyncStatus,
  struct_WGPUStringView,
  ctypes.POINTER(None),
...
WGPUCompilationInfoCallback2 = ctypes.CFUNCTYPE(
  None,
  WGPUCompilationInfoRequestStatus,
  ctypes.POINTER(struct_WGPUCompilationInfo),
  ctypes.POINTER(None),
...
WGPUCreateComputePipelineAsyncCallback2 = ctypes.CFUNCTYPE(
  None,
  WGPUCreatePipelineAsyncStatus,
  ctypes.POINTER(struct_WGPUComputePipelineImpl),
  struct_WGPUStringView,
...
WGPUCreateRenderPipelineAsyncCallback2 = ctypes.CFUNCTYPE(
  None,
  WGPUCreatePipelineAsyncStatus,
  ctypes.POINTER(struct_WGPURenderPipelineImpl),
  struct_WGPUStringView,
...
WGPUDeviceLostCallback2 = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(ctypes.POINTER(struct_WGPUDeviceImpl)),
  WGPUDeviceLostReason,
  struct_WGPUStringView,
...
WGPUPopErrorScopeCallback2 = ctypes.CFUNCTYPE(
  None,
  WGPUPopErrorScopeStatus,
  WGPUErrorType,
  struct_WGPUStringView,
...
WGPUQueueWorkDoneCallback2 = ctypes.CFUNCTYPE(
  None, WGPUQueueWorkDoneStatus, ctypes.POINTER(None), ctypes.POINTER(None)
)
WGPURequestAdapterCallback2 = ctypes.CFUNCTYPE(
  None,
  WGPURequestAdapterStatus,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  struct_WGPUStringView,
...
WGPURequestDeviceCallback2 = ctypes.CFUNCTYPE(
  None,
  WGPURequestDeviceStatus,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  struct_WGPUStringView,
...
WGPUUncapturedErrorCallback = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(ctypes.POINTER(struct_WGPUDeviceImpl)),
  WGPUErrorType,
  struct_WGPUStringView,
...
struct_WGPUBufferMapCallbackInfo._fields_ = [
  ...
  (
    "callback",
    ctypes.CFUNCTYPE(None, WGPUBufferMapAsyncStatus, ctypes.POINTER(None)),
  ),
  ("userdata", ctypes.POINTER(None)),
]
...
struct_WGPUDawnRenderPassColorAttachmentRenderToSingleSampled._pack_ = (
  1  # source:False
)
...
struct_WGPUQueueWorkDoneCallbackInfo._fields_ = [
  ...
  (
    "callback",
    ctypes.CFUNCTYPE(None, WGPUQueueWorkDoneStatus, ctypes.POINTER(None)),
  ),
  ("userdata", ctypes.POINTER(None)),
]
...
struct_WGPUSharedTextureMemoryVkDedicatedAllocationDescriptor._pack_ = (
  1  # source:False
)
...
struct_WGPUPipelineLayoutDescriptor._fields_ = [
  ...
  (
    "bindGroupLayouts",
    ctypes.POINTER(ctypes.POINTER(struct_WGPUBindGroupLayoutImpl)),
  ),
...
struct_WGPURenderPassDescriptor._fields_ = [
  ...
  (
    ...
    ctypes.POINTER(struct_WGPURenderPassDepthStencilAttachment),
  ),
...
WGPUProcAdapterPropertiesMemoryHeapsFreeMembers = ctypes.CFUNCTYPE(
  None, struct_WGPUAdapterPropertiesMemoryHeaps
)
WGPUProcCreateInstance = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUInstanceImpl),
  ctypes.POINTER(struct_WGPUInstanceDescriptor),
)
WGPUProcDrmFormatCapabilitiesFreeMembers = ctypes.CFUNCTYPE(
  None, struct_WGPUDrmFormatCapabilities
)
WGPUProcGetInstanceFeatures = ctypes.CFUNCTYPE(
  WGPUStatus, ctypes.POINTER(struct_WGPUInstanceFeatures)
)
WGPUProcGetProcAddress = ctypes.CFUNCTYPE(
  ctypes.CFUNCTYPE(None), struct_WGPUStringView
)
WGPUProcSharedBufferMemoryEndAccessStateFreeMembers = ctypes.CFUNCTYPE(
  None, struct_WGPUSharedBufferMemoryEndAccessState
)
WGPUProcSharedTextureMemoryEndAccessStateFreeMembers = ctypes.CFUNCTYPE(
  None, struct_WGPUSharedTextureMemoryEndAccessState
)
WGPUProcSupportedFeaturesFreeMembers = ctypes.CFUNCTYPE(
  None, struct_WGPUSupportedFeatures
)
WGPUProcSurfaceCapabilitiesFreeMembers = ctypes.CFUNCTYPE(
  None, struct_WGPUSurfaceCapabilities
)
WGPUProcAdapterCreateDevice = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUAdapterImpl),
  ctypes.POINTER(struct_WGPUDeviceDescriptor),
)
WGPUProcAdapterGetFeatures = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  ctypes.POINTER(struct_WGPUSupportedFeatures),
)
WGPUProcAdapterGetFormatCapabilities = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  WGPUTextureFormat,
  ctypes.POINTER(struct_WGPUFormatCapabilities),
)
WGPUProcAdapterGetInfo = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  ctypes.POINTER(struct_WGPUAdapterInfo),
)
WGPUProcAdapterGetInstance = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUInstanceImpl), ctypes.POINTER(struct_WGPUAdapterImpl)
)
WGPUProcAdapterGetLimits = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  ctypes.POINTER(struct_WGPUSupportedLimits),
)
WGPUProcAdapterHasFeature = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUAdapterImpl), WGPUFeatureName
)
WGPUProcAdapterRequestDevice = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  ctypes.POINTER(struct_WGPUDeviceDescriptor),
  ctypes.CFUNCTYPE(
...
WGPUProcAdapterRequestDevice2 = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  ctypes.POINTER(struct_WGPUDeviceDescriptor),
  struct_WGPURequestDeviceCallbackInfo2,
)
WGPUProcAdapterRequestDeviceF = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUAdapterImpl),
  ctypes.POINTER(struct_WGPUDeviceDescriptor),
  struct_WGPURequestDeviceCallbackInfo,
)
WGPUProcAdapterAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUAdapterImpl)
)
WGPUProcAdapterRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUAdapterImpl)
)
WGPUProcBindGroupSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUBindGroupImpl), struct_WGPUStringView
)
WGPUProcBindGroupAddRef = ctypes.CFUNCTYPE(
...
WGPUProcBindGroupLayoutSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUBindGroupLayoutImpl), struct_WGPUStringView
)
WGPUProcBindGroupLayoutAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUBindGroupLayoutImpl)
)
WGPUProcBindGroupLayoutRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUBindGroupLayoutImpl)
)
WGPUProcBufferDestroy = ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_WGPUBufferImpl))
WGPUProcBufferGetConstMappedRange = ctypes.CFUNCTYPE(
  ctypes.POINTER(None),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
  ctypes.c_uint64,
)
WGPUProcBufferGetMapState = ctypes.CFUNCTYPE(
  WGPUBufferMapState, ctypes.POINTER(struct_WGPUBufferImpl)
)
WGPUProcBufferGetMappedRange = ctypes.CFUNCTYPE(
  ctypes.POINTER(None),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
  ctypes.c_uint64,
)
WGPUProcBufferGetSize = ctypes.CFUNCTYPE(
  ctypes.c_uint64, ctypes.POINTER(struct_WGPUBufferImpl)
)
WGPUProcBufferGetUsage = ctypes.CFUNCTYPE(
  ctypes.c_uint64, ctypes.POINTER(struct_WGPUBufferImpl)
)
WGPUProcBufferMapAsync = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
  ctypes.c_uint64,
...
WGPUProcBufferMapAsync2 = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
  ctypes.c_uint64,
  ctypes.c_uint64,
  struct_WGPUBufferMapCallbackInfo2,
)
WGPUProcBufferMapAsyncF = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
  ctypes.c_uint64,
...
WGPUProcBufferSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUBufferImpl), struct_WGPUStringView
)
...
WGPUProcCommandBufferSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandBufferImpl), struct_WGPUStringView
)
WGPUProcCommandBufferAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandBufferImpl)
)
WGPUProcCommandBufferRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandBufferImpl)
)
WGPUProcCommandEncoderBeginComputePass = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUComputePassEncoderImpl),
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUComputePassDescriptor),
)
WGPUProcCommandEncoderBeginRenderPass = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPURenderPassDescriptor),
)
WGPUProcCommandEncoderClearBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
...
WGPUProcCommandEncoderCopyBufferToBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
...
WGPUProcCommandEncoderCopyBufferToTexture = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUImageCopyBuffer),
  ctypes.POINTER(struct_WGPUImageCopyTexture),
  ctypes.POINTER(struct_WGPUExtent3D),
)
WGPUProcCommandEncoderCopyTextureToBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUImageCopyTexture),
  ctypes.POINTER(struct_WGPUImageCopyBuffer),
...
WGPUProcCommandEncoderFinish = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUCommandBufferImpl),
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUCommandBufferDescriptor),
)
WGPUProcCommandEncoderInjectValidationError = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandEncoderImpl), struct_WGPUStringView
)
WGPUProcCommandEncoderInsertDebugMarker = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandEncoderImpl), struct_WGPUStringView
)
WGPUProcCommandEncoderPopDebugGroup = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandEncoderImpl)
)
WGPUProcCommandEncoderPushDebugGroup = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandEncoderImpl), struct_WGPUStringView
)
WGPUProcCommandEncoderResolveQuerySet = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUQuerySetImpl),
  ctypes.c_uint32,
  ctypes.c_uint32,
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
)
WGPUProcCommandEncoderSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandEncoderImpl), struct_WGPUStringView
)
WGPUProcCommandEncoderWriteBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
...
WGPUProcCommandEncoderWriteTimestamp = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUQuerySetImpl),
  ctypes.c_uint32,
)
WGPUProcCommandEncoderAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandEncoderImpl)
)
WGPUProcCommandEncoderRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUCommandEncoderImpl)
)
WGPUProcComputePassEncoderDispatchWorkgroups = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUComputePassEncoderImpl),
  ctypes.c_uint32,
  ctypes.c_uint32,
...
WGPUProcComputePassEncoderDispatchWorkgroupsIndirect = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUComputePassEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
)
WGPUProcComputePassEncoderEnd = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePassEncoderImpl)
)
WGPUProcComputePassEncoderInsertDebugMarker = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePassEncoderImpl), struct_WGPUStringView
)
WGPUProcComputePassEncoderPopDebugGroup = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePassEncoderImpl)
)
WGPUProcComputePassEncoderPushDebugGroup = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePassEncoderImpl), struct_WGPUStringView
)
WGPUProcComputePassEncoderSetBindGroup = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUComputePassEncoderImpl),
  ctypes.c_uint32,
...
WGPUProcComputePassEncoderSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePassEncoderImpl), struct_WGPUStringView
)
WGPUProcComputePassEncoderSetPipeline = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUComputePassEncoderImpl),
  ctypes.POINTER(struct_WGPUComputePipelineImpl),
)
WGPUProcComputePassEncoderWriteTimestamp = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUComputePassEncoderImpl),
  ctypes.POINTER(struct_WGPUQuerySetImpl),
  ctypes.c_uint32,
)
WGPUProcComputePassEncoderAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePassEncoderImpl)
)
WGPUProcComputePassEncoderRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePassEncoderImpl)
)
WGPUProcComputePipelineGetBindGroupLayout = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUBindGroupLayoutImpl),
  ctypes.POINTER(struct_WGPUComputePipelineImpl),
  ctypes.c_uint32,
)
WGPUProcComputePipelineSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePipelineImpl), struct_WGPUStringView
)
WGPUProcComputePipelineAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePipelineImpl)
)
WGPUProcComputePipelineRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUComputePipelineImpl)
)
WGPUProcDeviceCreateBindGroup = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUBindGroupImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUBindGroupDescriptor),
)
WGPUProcDeviceCreateBindGroupLayout = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUBindGroupLayoutImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUBindGroupLayoutDescriptor),
)
WGPUProcDeviceCreateBuffer = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUBufferDescriptor),
)
WGPUProcDeviceCreateCommandEncoder = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUCommandEncoderImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUCommandEncoderDescriptor),
)
WGPUProcDeviceCreateComputePipeline = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUComputePipelineImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUComputePipelineDescriptor),
)
...
WGPUProcDeviceCreateComputePipelineAsync2 = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUComputePipelineDescriptor),
  struct_WGPUCreateComputePipelineAsyncCallbackInfo2,
...
WGPUProcDeviceCreateErrorBuffer = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUBufferDescriptor),
)
WGPUProcDeviceCreateErrorExternalTexture = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUExternalTextureImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
)
WGPUProcDeviceCreateErrorShaderModule = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUShaderModuleImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUShaderModuleDescriptor),
  struct_WGPUStringView,
)
WGPUProcDeviceCreateErrorTexture = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUTextureImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUTextureDescriptor),
)
WGPUProcDeviceCreateExternalTexture = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUExternalTextureImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUExternalTextureDescriptor),
)
WGPUProcDeviceCreatePipelineLayout = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUPipelineLayoutImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUPipelineLayoutDescriptor),
)
WGPUProcDeviceCreateQuerySet = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUQuerySetImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUQuerySetDescriptor),
)
WGPUProcDeviceCreateRenderBundleEncoder = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPURenderBundleEncoderDescriptor),
)
WGPUProcDeviceCreateRenderPipeline = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPURenderPipelineImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPURenderPipelineDescriptor),
)
...
WGPUProcDeviceCreateRenderPipelineAsync2 = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPURenderPipelineDescriptor),
  struct_WGPUCreateRenderPipelineAsyncCallbackInfo2,
)
WGPUProcDeviceCreateRenderPipelineAsyncF = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPURenderPipelineDescriptor),
  struct_WGPUCreateRenderPipelineAsyncCallbackInfo,
...
WGPUProcDeviceCreateSampler = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUSamplerImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUSamplerDescriptor),
)
WGPUProcDeviceCreateShaderModule = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUShaderModuleImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUShaderModuleDescriptor),
)
WGPUProcDeviceCreateTexture = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUTextureImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUTextureDescriptor),
)
WGPUProcDeviceDestroy = ctypes.CFUNCTYPE(None, ctypes.POINTER(struct_WGPUDeviceImpl))
WGPUProcDeviceForceLoss = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  WGPUDeviceLostReason,
  struct_WGPUStringView,
...
WGPUProcDeviceGetAHardwareBufferProperties = ctypes.CFUNCTYPE(
  ...
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(None),
  ctypes.POINTER(struct_WGPUAHardwareBufferProperties),
)
WGPUProcDeviceGetAdapter = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUAdapterImpl), ctypes.POINTER(struct_WGPUDeviceImpl)
)
WGPUProcDeviceGetAdapterInfo = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUAdapterInfo),
)
WGPUProcDeviceGetFeatures = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUSupportedFeatures),
)
WGPUProcDeviceGetLimits = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUSupportedLimits),
)
WGPUProcDeviceGetLostFuture = ctypes.CFUNCTYPE(
  struct_WGPUFuture, ctypes.POINTER(struct_WGPUDeviceImpl)
)
WGPUProcDeviceGetQueue = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUQueueImpl), ctypes.POINTER(struct_WGPUDeviceImpl)
)
WGPUProcDeviceHasFeature = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUDeviceImpl), WGPUFeatureName
)
WGPUProcDeviceImportSharedBufferMemory = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUSharedBufferMemoryImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUSharedBufferMemoryDescriptor),
)
WGPUProcDeviceImportSharedFence = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUSharedFenceImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUSharedFenceDescriptor),
)
WGPUProcDeviceImportSharedTextureMemory = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUSharedTextureMemoryImpl),
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUSharedTextureMemoryDescriptor),
)
...
WGPUProcDevicePopErrorScope = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.CFUNCTYPE(None, WGPUErrorType, struct_WGPUStringView, ctypes.POINTER(None)),
  ctypes.POINTER(None),
)
WGPUProcDevicePopErrorScope2 = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUDeviceImpl),
...
WGPUProcDevicePushErrorScope = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUDeviceImpl), WGPUErrorFilter
)
WGPUProcDeviceSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUDeviceImpl), struct_WGPUStringView
)
WGPUProcDeviceSetLoggingCallback = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.CFUNCTYPE(
    None, WGPULoggingType, struct_WGPUStringView, ctypes.POINTER(None)
...
WGPUProcDeviceValidateTextureDescriptor = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUDeviceImpl),
  ctypes.POINTER(struct_WGPUTextureDescriptor),
)
...
WGPUProcExternalTextureDestroy = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUExternalTextureImpl)
)
WGPUProcExternalTextureExpire = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUExternalTextureImpl)
)
WGPUProcExternalTextureRefresh = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUExternalTextureImpl)
)
WGPUProcExternalTextureSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUExternalTextureImpl), struct_WGPUStringView
)
WGPUProcExternalTextureAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUExternalTextureImpl)
)
WGPUProcExternalTextureRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUExternalTextureImpl)
)
WGPUProcInstanceCreateSurface = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUSurfaceImpl),
  ctypes.POINTER(struct_WGPUInstanceImpl),
  ctypes.POINTER(struct_WGPUSurfaceDescriptor),
)
WGPUProcInstanceEnumerateWGSLLanguageFeatures = ctypes.CFUNCTYPE(
  ctypes.c_uint64,
  ctypes.POINTER(struct_WGPUInstanceImpl),
  ctypes.POINTER(WGPUWGSLFeatureName),
)
WGPUProcInstanceHasWGSLLanguageFeature = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUInstanceImpl), WGPUWGSLFeatureName
)
WGPUProcInstanceProcessEvents = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUInstanceImpl)
)
WGPUProcInstanceRequestAdapter = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUInstanceImpl),
  ctypes.POINTER(struct_WGPURequestAdapterOptions),
  ctypes.CFUNCTYPE(
    None,
    WGPURequestAdapterStatus,
    ctypes.POINTER(struct_WGPUAdapterImpl),
...
WGPUProcInstanceRequestAdapter2 = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUInstanceImpl),
  ctypes.POINTER(struct_WGPURequestAdapterOptions),
  struct_WGPURequestAdapterCallbackInfo2,
)
WGPUProcInstanceRequestAdapterF = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUInstanceImpl),
  ctypes.POINTER(struct_WGPURequestAdapterOptions),
  struct_WGPURequestAdapterCallbackInfo,
)
WGPUProcInstanceWaitAny = ctypes.CFUNCTYPE(
  WGPUWaitStatus,
  ctypes.POINTER(struct_WGPUInstanceImpl),
  ctypes.c_uint64,
  ctypes.POINTER(struct_WGPUFutureWaitInfo),
  ctypes.c_uint64,
)
WGPUProcInstanceAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUInstanceImpl)
)
WGPUProcInstanceRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUInstanceImpl)
)
WGPUProcPipelineLayoutSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUPipelineLayoutImpl), struct_WGPUStringView
)
WGPUProcPipelineLayoutAddRef = ctypes.CFUNCTYPE(
...
WGPUProcQuerySetDestroy = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUQuerySetImpl)
)
WGPUProcQuerySetGetCount = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUQuerySetImpl)
)
WGPUProcQuerySetGetType = ctypes.CFUNCTYPE(
  WGPUQueryType, ctypes.POINTER(struct_WGPUQuerySetImpl)
)
WGPUProcQuerySetSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUQuerySetImpl), struct_WGPUStringView
)
WGPUProcQuerySetAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUQuerySetImpl)
)
WGPUProcQuerySetRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUQuerySetImpl)
)
WGPUProcQueueCopyExternalTextureForBrowser = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUQueueImpl),
  ctypes.POINTER(struct_WGPUImageCopyExternalTexture),
  ctypes.POINTER(struct_WGPUImageCopyTexture),
  ctypes.POINTER(struct_WGPUExtent3D),
  ctypes.POINTER(struct_WGPUCopyTextureForBrowserOptions),
)
...
WGPUProcQueueOnSubmittedWorkDone2 = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUQueueImpl),
  struct_WGPUQueueWorkDoneCallbackInfo2,
)
WGPUProcQueueOnSubmittedWorkDoneF = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUQueueImpl),
  struct_WGPUQueueWorkDoneCallbackInfo,
)
WGPUProcQueueSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUQueueImpl), struct_WGPUStringView
)
WGPUProcQueueSubmit = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUQueueImpl),
  ctypes.c_uint64,
  ctypes.POINTER(ctypes.POINTER(struct_WGPUCommandBufferImpl)),
)
WGPUProcQueueWriteBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUQueueImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
...
WGPUProcQueueWriteTexture = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUQueueImpl),
  ctypes.POINTER(struct_WGPUImageCopyTexture),
  ctypes.POINTER(None),
  ctypes.c_uint64,
  ctypes.POINTER(struct_WGPUTextureDataLayout),
  ctypes.POINTER(struct_WGPUExtent3D),
)
...
WGPUProcRenderBundleSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleImpl), struct_WGPUStringView
)
WGPUProcRenderBundleAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleImpl)
)
WGPUProcRenderBundleRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleImpl)
)
WGPUProcRenderBundleEncoderDraw = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.c_uint32,
  ctypes.c_uint32,
...
WGPUProcRenderBundleEncoderDrawIndexed = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.c_uint32,
  ctypes.c_uint32,
...
WGPUProcRenderBundleEncoderDrawIndexedIndirect = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
)
WGPUProcRenderBundleEncoderDrawIndirect = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
)
WGPUProcRenderBundleEncoderFinish = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPURenderBundleImpl),
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.POINTER(struct_WGPURenderBundleDescriptor),
)
WGPUProcRenderBundleEncoderInsertDebugMarker = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleEncoderImpl), struct_WGPUStringView
)
WGPUProcRenderBundleEncoderPopDebugGroup = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleEncoderImpl)
)
WGPUProcRenderBundleEncoderPushDebugGroup = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleEncoderImpl), struct_WGPUStringView
)
WGPUProcRenderBundleEncoderSetBindGroup = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.c_uint32,
  ctypes.POINTER(struct_WGPUBindGroupImpl),
...
WGPUProcRenderBundleEncoderSetIndexBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  WGPUIndexFormat,
...
WGPUProcRenderBundleEncoderSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleEncoderImpl), struct_WGPUStringView
)
WGPUProcRenderBundleEncoderSetPipeline = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.POINTER(struct_WGPURenderPipelineImpl),
)
WGPUProcRenderBundleEncoderSetVertexBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderBundleEncoderImpl),
  ctypes.c_uint32,
  ctypes.POINTER(struct_WGPUBufferImpl),
...
WGPUProcRenderBundleEncoderAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleEncoderImpl)
)
WGPUProcRenderBundleEncoderRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderBundleEncoderImpl)
)
WGPUProcRenderPassEncoderBeginOcclusionQuery = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl), ctypes.c_uint32
)
WGPUProcRenderPassEncoderDraw = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.c_uint32,
  ctypes.c_uint32,
...
WGPUProcRenderPassEncoderDrawIndexed = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.c_uint32,
  ctypes.c_uint32,
...
WGPUProcRenderPassEncoderDrawIndexedIndirect = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
)
WGPUProcRenderPassEncoderDrawIndirect = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
)
WGPUProcRenderPassEncoderEnd = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl)
)
WGPUProcRenderPassEncoderEndOcclusionQuery = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl)
)
WGPUProcRenderPassEncoderExecuteBundles = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.c_uint64,
  ctypes.POINTER(ctypes.POINTER(struct_WGPURenderBundleImpl)),
)
WGPUProcRenderPassEncoderInsertDebugMarker = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl), struct_WGPUStringView
)
WGPUProcRenderPassEncoderMultiDrawIndexedIndirect = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
...
WGPUProcRenderPassEncoderMultiDrawIndirect = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.c_uint64,
...
WGPUProcRenderPassEncoderPixelLocalStorageBarrier = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl)
)
WGPUProcRenderPassEncoderPopDebugGroup = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl)
)
WGPUProcRenderPassEncoderPushDebugGroup = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl), struct_WGPUStringView
)
WGPUProcRenderPassEncoderSetBindGroup = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.c_uint32,
  ctypes.POINTER(struct_WGPUBindGroupImpl),
...
WGPUProcRenderPassEncoderSetBlendConstant = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPUColor),
)
WGPUProcRenderPassEncoderSetIndexBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  WGPUIndexFormat,
...
WGPUProcRenderPassEncoderSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl), struct_WGPUStringView
)
WGPUProcRenderPassEncoderSetPipeline = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPURenderPipelineImpl),
)
...
WGPUProcRenderPassEncoderSetStencilReference = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl), ctypes.c_uint32
)
WGPUProcRenderPassEncoderSetVertexBuffer = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.c_uint32,
  ctypes.POINTER(struct_WGPUBufferImpl),
...
WGPUProcRenderPassEncoderSetViewport = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.c_float,
  ctypes.c_float,
...
WGPUProcRenderPassEncoderWriteTimestamp = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPURenderPassEncoderImpl),
  ctypes.POINTER(struct_WGPUQuerySetImpl),
  ctypes.c_uint32,
)
WGPUProcRenderPassEncoderAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl)
)
WGPUProcRenderPassEncoderRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPassEncoderImpl)
)
WGPUProcRenderPipelineGetBindGroupLayout = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUBindGroupLayoutImpl),
  ctypes.POINTER(struct_WGPURenderPipelineImpl),
  ctypes.c_uint32,
)
WGPUProcRenderPipelineSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPURenderPipelineImpl), struct_WGPUStringView
)
WGPUProcRenderPipelineAddRef = ctypes.CFUNCTYPE(
...
WGPUProcSamplerSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSamplerImpl), struct_WGPUStringView
)
WGPUProcSamplerAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSamplerImpl)
)
WGPUProcSamplerRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSamplerImpl)
)
WGPUProcShaderModuleGetCompilationInfo = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUShaderModuleImpl),
  ctypes.CFUNCTYPE(
    None,
...
WGPUProcShaderModuleGetCompilationInfo2 = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUShaderModuleImpl),
  struct_WGPUCompilationInfoCallbackInfo2,
)
WGPUProcShaderModuleGetCompilationInfoF = ctypes.CFUNCTYPE(
  struct_WGPUFuture,
  ctypes.POINTER(struct_WGPUShaderModuleImpl),
  struct_WGPUCompilationInfoCallbackInfo,
)
WGPUProcShaderModuleSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUShaderModuleImpl), struct_WGPUStringView
)
WGPUProcShaderModuleAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUShaderModuleImpl)
)
WGPUProcShaderModuleRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUShaderModuleImpl)
)
WGPUProcSharedBufferMemoryBeginAccess = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUSharedBufferMemoryImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.POINTER(struct_WGPUSharedBufferMemoryBeginAccessDescriptor),
)
WGPUProcSharedBufferMemoryCreateBuffer = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.POINTER(struct_WGPUSharedBufferMemoryImpl),
  ctypes.POINTER(struct_WGPUBufferDescriptor),
)
WGPUProcSharedBufferMemoryEndAccess = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUSharedBufferMemoryImpl),
  ctypes.POINTER(struct_WGPUBufferImpl),
  ctypes.POINTER(struct_WGPUSharedBufferMemoryEndAccessState),
)
WGPUProcSharedBufferMemoryGetProperties = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUSharedBufferMemoryImpl),
  ctypes.POINTER(struct_WGPUSharedBufferMemoryProperties),
)
WGPUProcSharedBufferMemoryIsDeviceLost = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUSharedBufferMemoryImpl)
)
WGPUProcSharedBufferMemorySetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSharedBufferMemoryImpl), struct_WGPUStringView
)
WGPUProcSharedBufferMemoryAddRef = ctypes.CFUNCTYPE(
...
WGPUProcSharedFenceExportInfo = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUSharedFenceImpl),
  ctypes.POINTER(struct_WGPUSharedFenceExportInfo),
)
WGPUProcSharedFenceAddRef = ctypes.CFUNCTYPE(
...
WGPUProcSharedTextureMemoryBeginAccess = ctypes.CFUNCTYPE(
  ...
  ctypes.POINTER(struct_WGPUSharedTextureMemoryImpl),
  ctypes.POINTER(struct_WGPUTextureImpl),
  ctypes.POINTER(struct_WGPUSharedTextureMemoryBeginAccessDescriptor),
)
WGPUProcSharedTextureMemoryCreateTexture = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUTextureImpl),
  ctypes.POINTER(struct_WGPUSharedTextureMemoryImpl),
  ctypes.POINTER(struct_WGPUTextureDescriptor),
)
WGPUProcSharedTextureMemoryEndAccess = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUSharedTextureMemoryImpl),
  ctypes.POINTER(struct_WGPUTextureImpl),
  ctypes.POINTER(struct_WGPUSharedTextureMemoryEndAccessState),
)
WGPUProcSharedTextureMemoryGetProperties = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUSharedTextureMemoryImpl),
  ctypes.POINTER(struct_WGPUSharedTextureMemoryProperties),
)
WGPUProcSharedTextureMemoryIsDeviceLost = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUSharedTextureMemoryImpl)
)
WGPUProcSharedTextureMemorySetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSharedTextureMemoryImpl), struct_WGPUStringView
)
WGPUProcSharedTextureMemoryAddRef = ctypes.CFUNCTYPE(
...
WGPUProcSurfaceConfigure = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUSurfaceImpl),
  ctypes.POINTER(struct_WGPUSurfaceConfiguration),
)
WGPUProcSurfaceGetCapabilities = ctypes.CFUNCTYPE(
  WGPUStatus,
  ctypes.POINTER(struct_WGPUSurfaceImpl),
  ctypes.POINTER(struct_WGPUAdapterImpl),
  ctypes.POINTER(struct_WGPUSurfaceCapabilities),
)
WGPUProcSurfaceGetCurrentTexture = ctypes.CFUNCTYPE(
  None,
  ctypes.POINTER(struct_WGPUSurfaceImpl),
  ctypes.POINTER(struct_WGPUSurfaceTexture),
)
WGPUProcSurfacePresent = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSurfaceImpl)
)
WGPUProcSurfaceSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSurfaceImpl), struct_WGPUStringView
)
WGPUProcSurfaceUnconfigure = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSurfaceImpl)
)
WGPUProcSurfaceAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSurfaceImpl)
)
WGPUProcSurfaceRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUSurfaceImpl)
)
WGPUProcTextureCreateErrorView = ctypes.CFUNCTYPE(
  ctypes.POINTER(struct_WGPUTextureViewImpl),
  ctypes.POINTER(struct_WGPUTextureImpl),
  ctypes.POINTER(struct_WGPUTextureViewDescriptor),
)
...
WGPUProcTextureDestroy = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureGetDepthOrArrayLayers = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureGetDimension = ctypes.CFUNCTYPE(
  WGPUTextureDimension, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureGetFormat = ctypes.CFUNCTYPE(
  WGPUTextureFormat, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureGetHeight = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureGetMipLevelCount = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureGetSampleCount = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureGetUsage = ctypes.CFUNCTYPE(
  ctypes.c_uint64, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureGetWidth = ctypes.CFUNCTYPE(
  ctypes.c_uint32, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUTextureImpl), struct_WGPUStringView
)
WGPUProcTextureAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUTextureImpl)
)
WGPUProcTextureViewSetLabel = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUTextureViewImpl), struct_WGPUStringView
)
WGPUProcTextureViewAddRef = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUTextureViewImpl)
)
WGPUProcTextureViewRelease = ctypes.CFUNCTYPE(
  None, ctypes.POINTER(struct_WGPUTextureViewImpl)
)
try:
...
try:
  ...
  wgpuAdapterPropertiesMemoryHeapsFreeMembers.argtypes = [
...
try:
  ...
  wgpuSharedBufferMemoryEndAccessStateFreeMembers.argtypes = [
...
try:
  ...
  wgpuSharedTextureMemoryEndAccessStateFreeMembers.argtypes = [
...
try:
  ...
  wgpuAdapterCreateDevice.argtypes = [
    WGPUAdapter,
    ctypes.POINTER(struct_WGPUDeviceDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuAdapterGetFeatures.argtypes = [
    WGPUAdapter,
    ctypes.POINTER(struct_WGPUSupportedFeatures),
  ]
except AttributeError:
...
try:
  ...
  wgpuAdapterGetFormatCapabilities.argtypes = [
    WGPUAdapter,
    WGPUTextureFormat,
    ctypes.POINTER(struct_WGPUFormatCapabilities),
  ]
...
try:
  ...
  wgpuAdapterRequestDevice.argtypes = [
    WGPUAdapter,
    ctypes.POINTER(struct_WGPUDeviceDescriptor),
...
try:
  ...
  wgpuAdapterRequestDevice2.argtypes = [
    WGPUAdapter,
    ctypes.POINTER(struct_WGPUDeviceDescriptor),
    WGPURequestDeviceCallbackInfo2,
  ]
except AttributeError:
  pass
try:
  ...
  wgpuAdapterRequestDeviceF.argtypes = [
    WGPUAdapter,
    ctypes.POINTER(struct_WGPUDeviceDescriptor),
...
try:
  ...
  wgpuBufferMapAsync2.argtypes = [
    WGPUBuffer,
    WGPUMapMode,
    size_t,
    size_t,
    WGPUBufferMapCallbackInfo2,
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  wgpuCommandEncoderBeginComputePass.argtypes = [
    WGPUCommandEncoder,
    ctypes.POINTER(struct_WGPUComputePassDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuCommandEncoderBeginRenderPass.argtypes = [
    WGPUCommandEncoder,
    ctypes.POINTER(struct_WGPURenderPassDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuCommandEncoderClearBuffer.argtypes = [
    WGPUCommandEncoder,
    WGPUBuffer,
    uint64_t,
    uint64_t,
...
try:
  ...
  wgpuCommandEncoderCopyBufferToBuffer.argtypes = [
    WGPUCommandEncoder,
    WGPUBuffer,
    uint64_t,
    WGPUBuffer,
...
try:
  ...
  wgpuCommandEncoderCopyBufferToTexture.argtypes = [
    WGPUCommandEncoder,
    ctypes.POINTER(struct_WGPUImageCopyBuffer),
    ctypes.POINTER(struct_WGPUImageCopyTexture),
    ctypes.POINTER(struct_WGPUExtent3D),
...
try:
  ...
  wgpuCommandEncoderCopyTextureToBuffer.argtypes = [
    WGPUCommandEncoder,
    ctypes.POINTER(struct_WGPUImageCopyTexture),
    ctypes.POINTER(struct_WGPUImageCopyBuffer),
    ctypes.POINTER(struct_WGPUExtent3D),
...
try:
  ...
  wgpuCommandEncoderCopyTextureToTexture.argtypes = [
    WGPUCommandEncoder,
    ctypes.POINTER(struct_WGPUImageCopyTexture),
    ctypes.POINTER(struct_WGPUImageCopyTexture),
    ctypes.POINTER(struct_WGPUExtent3D),
...
try:
  ...
  wgpuCommandEncoderFinish.argtypes = [
    WGPUCommandEncoder,
    ctypes.POINTER(struct_WGPUCommandBufferDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuCommandEncoderInjectValidationError.argtypes = [
    WGPUCommandEncoder,
    WGPUStringView,
  ]
except AttributeError:
...
try:
  ...
  wgpuCommandEncoderResolveQuerySet.argtypes = [
    WGPUCommandEncoder,
    WGPUQuerySet,
    uint32_t,
    uint32_t,
...
try:
  ...
  wgpuCommandEncoderWriteBuffer.argtypes = [
    WGPUCommandEncoder,
    WGPUBuffer,
    uint64_t,
    ctypes.POINTER(ctypes.c_ubyte),
...
try:
  ...
  wgpuCommandEncoderWriteTimestamp.argtypes = [
    WGPUCommandEncoder,
    WGPUQuerySet,
    uint32_t,
  ]
...
try:
  ...
  wgpuComputePassEncoderDispatchWorkgroups.argtypes = [
...
try:
  ...
  wgpuComputePassEncoderDispatchWorkgroupsIndirect.argtypes = [
    WGPUComputePassEncoder,
    WGPUBuffer,
    uint64_t,
  ]
...
try:
  ...
  wgpuComputePassEncoderInsertDebugMarker.argtypes = [
    WGPUComputePassEncoder,
    WGPUStringView,
  ]
except AttributeError:
...
try:
  ...
  wgpuComputePassEncoderPushDebugGroup.argtypes = [
    WGPUComputePassEncoder,
    WGPUStringView,
  ]
except AttributeError:
...
try:
  ...
  wgpuComputePassEncoderSetBindGroup.argtypes = [
    WGPUComputePassEncoder,
    uint32_t,
    WGPUBindGroup,
    size_t,
...
try:
  ...
  wgpuComputePassEncoderSetPipeline.argtypes = [
    WGPUComputePassEncoder,
    WGPUComputePipeline,
  ]
except AttributeError:
...
try:
  ...
  wgpuComputePassEncoderWriteTimestamp.argtypes = [
    WGPUComputePassEncoder,
    WGPUQuerySet,
    uint32_t,
  ]
...
try:
  ...
  wgpuDeviceCreateBindGroup.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUBindGroupDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateBindGroupLayout.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUBindGroupLayoutDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateBuffer.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUBufferDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateCommandEncoder.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUCommandEncoderDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateComputePipeline.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUComputePipelineDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateComputePipelineAsync.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUComputePipelineDescriptor),
...
try:
  ...
  wgpuDeviceCreateComputePipelineAsync2.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUComputePipelineDescriptor),
    WGPUCreateComputePipelineAsyncCallbackInfo2,
  ]
...
try:
  ...
  wgpuDeviceCreateComputePipelineAsyncF.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUComputePipelineDescriptor),
    WGPUCreateComputePipelineAsyncCallbackInfo,
  ]
...
try:
  ...
  wgpuDeviceCreateErrorBuffer.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUBufferDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateErrorShaderModule.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUShaderModuleDescriptor),
    WGPUStringView,
  ]
...
try:
  ...
  wgpuDeviceCreateErrorTexture.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUTextureDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateExternalTexture.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUExternalTextureDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreatePipelineLayout.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUPipelineLayoutDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateQuerySet.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUQuerySetDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateRenderBundleEncoder.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPURenderBundleEncoderDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateRenderPipeline.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPURenderPipelineDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateRenderPipelineAsync.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPURenderPipelineDescriptor),
...
try:
  ...
  wgpuDeviceCreateRenderPipelineAsync2.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPURenderPipelineDescriptor),
    WGPUCreateRenderPipelineAsyncCallbackInfo2,
  ]
...
try:
  ...
  wgpuDeviceCreateRenderPipelineAsyncF.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPURenderPipelineDescriptor),
    WGPUCreateRenderPipelineAsyncCallbackInfo,
  ]
...
try:
  ...
  wgpuDeviceCreateSampler.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUSamplerDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateShaderModule.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUShaderModuleDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceCreateTexture.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUTextureDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceGetAHardwareBufferProperties.argtypes = [
    WGPUDevice,
    ctypes.POINTER(None),
    ctypes.POINTER(struct_WGPUAHardwareBufferProperties),
  ]
...
try:
  ...
  wgpuDeviceGetAdapterInfo.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUAdapterInfo),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceGetFeatures.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUSupportedFeatures),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceImportSharedBufferMemory.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUSharedBufferMemoryDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceImportSharedFence.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUSharedFenceDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDeviceImportSharedTextureMemory.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUSharedTextureMemoryDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuDevicePopErrorScope.argtypes = [
    WGPUDevice,
    WGPUErrorCallback,
    ctypes.POINTER(None),
  ]
...
try:
  ...
  wgpuDeviceSetLoggingCallback.argtypes = [
    WGPUDevice,
    WGPULoggingCallback,
    ctypes.POINTER(None),
  ]
...
try:
  ...
  wgpuDeviceValidateTextureDescriptor.argtypes = [
    WGPUDevice,
    ctypes.POINTER(struct_WGPUTextureDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuInstanceCreateSurface.argtypes = [
    WGPUInstance,
    ctypes.POINTER(struct_WGPUSurfaceDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuInstanceEnumerateWGSLLanguageFeatures.argtypes = [
    WGPUInstance,
    ctypes.POINTER(WGPUWGSLFeatureName),
  ]
except AttributeError:
...
try:
  ...
  wgpuInstanceRequestAdapter.argtypes = [
    WGPUInstance,
    ctypes.POINTER(struct_WGPURequestAdapterOptions),
...
try:
  ...
  wgpuInstanceRequestAdapter2.argtypes = [
    WGPUInstance,
    ctypes.POINTER(struct_WGPURequestAdapterOptions),
...
try:
  ...
  wgpuInstanceRequestAdapterF.argtypes = [
    WGPUInstance,
    ctypes.POINTER(struct_WGPURequestAdapterOptions),
...
try:
  ...
  wgpuQueueCopyExternalTextureForBrowser.argtypes = [
    WGPUQueue,
    ctypes.POINTER(struct_WGPUImageCopyExternalTexture),
    ctypes.POINTER(struct_WGPUImageCopyTexture),
    ctypes.POINTER(struct_WGPUExtent3D),
...
try:
  ...
  wgpuQueueCopyTextureForBrowser.argtypes = [
    WGPUQueue,
    ctypes.POINTER(struct_WGPUImageCopyTexture),
    ctypes.POINTER(struct_WGPUImageCopyTexture),
    ctypes.POINTER(struct_WGPUExtent3D),
...
try:
  ...
  wgpuQueueOnSubmittedWorkDone.argtypes = [
    WGPUQueue,
...
try:
  ...
  wgpuQueueOnSubmittedWorkDone2.argtypes = [
    WGPUQueue,
    WGPUQueueWorkDoneCallbackInfo2,
  ]
except AttributeError:
  pass
try:
...
try:
  ...
  wgpuQueueWriteTexture.argtypes = [
    WGPUQueue,
    ctypes.POINTER(struct_WGPUImageCopyTexture),
    ctypes.POINTER(None),
    size_t,
...
try:
  ...
  wgpuRenderBundleEncoderDraw.argtypes = [
...
try:
  ...
  wgpuRenderBundleEncoderDrawIndexed.argtypes = [
    WGPURenderBundleEncoder,
    uint32_t,
    uint32_t,
    uint32_t,
...
try:
  ...
  wgpuRenderBundleEncoderDrawIndexedIndirect.argtypes = [
    WGPURenderBundleEncoder,
    WGPUBuffer,
    uint64_t,
  ]
...
try:
  ...
  wgpuRenderBundleEncoderDrawIndirect.argtypes = [
    WGPURenderBundleEncoder,
    WGPUBuffer,
    uint64_t,
  ]
...
try:
  ...
  wgpuRenderBundleEncoderFinish.argtypes = [
    WGPURenderBundleEncoder,
    ctypes.POINTER(struct_WGPURenderBundleDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderBundleEncoderInsertDebugMarker.argtypes = [
    WGPURenderBundleEncoder,
    WGPUStringView,
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderBundleEncoderPushDebugGroup.argtypes = [
    WGPURenderBundleEncoder,
    WGPUStringView,
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderBundleEncoderSetBindGroup.argtypes = [
    WGPURenderBundleEncoder,
    uint32_t,
    WGPUBindGroup,
    size_t,
...
try:
  ...
  wgpuRenderBundleEncoderSetIndexBuffer.argtypes = [
    WGPURenderBundleEncoder,
    WGPUBuffer,
    WGPUIndexFormat,
    uint64_t,
...
try:
  ...
  wgpuRenderBundleEncoderSetLabel.argtypes = [
    WGPURenderBundleEncoder,
    WGPUStringView,
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderBundleEncoderSetPipeline.argtypes = [
    WGPURenderBundleEncoder,
    WGPURenderPipeline,
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderBundleEncoderSetVertexBuffer.argtypes = [
    WGPURenderBundleEncoder,
    uint32_t,
    WGPUBuffer,
    uint64_t,
...
try:
  ...
  wgpuRenderPassEncoderBeginOcclusionQuery.argtypes = [
...
try:
  ...
  wgpuRenderPassEncoderDraw.argtypes = [
    WGPURenderPassEncoder,
    uint32_t,
    uint32_t,
    uint32_t,
...
try:
  ...
  wgpuRenderPassEncoderDrawIndexed.argtypes = [
    WGPURenderPassEncoder,
    uint32_t,
    uint32_t,
    uint32_t,
...
try:
  ...
  wgpuRenderPassEncoderDrawIndexedIndirect.argtypes = [
    WGPURenderPassEncoder,
    WGPUBuffer,
    uint64_t,
  ]
...
try:
  ...
  wgpuRenderPassEncoderDrawIndirect.argtypes = [
    WGPURenderPassEncoder,
    WGPUBuffer,
    uint64_t,
  ]
...
try:
  ...
  wgpuRenderPassEncoderExecuteBundles.argtypes = [
    WGPURenderPassEncoder,
    size_t,
    ctypes.POINTER(ctypes.POINTER(struct_WGPURenderBundleImpl)),
  ]
...
try:
  ...
  wgpuRenderPassEncoderMultiDrawIndexedIndirect.argtypes = [
    WGPURenderPassEncoder,
    WGPUBuffer,
    uint64_t,
    uint32_t,
...
try:
  ...
  wgpuRenderPassEncoderMultiDrawIndirect.argtypes = [
    WGPURenderPassEncoder,
    WGPUBuffer,
    uint64_t,
    uint32_t,
...
try:
  ...
  wgpuRenderPassEncoderPushDebugGroup.argtypes = [
    WGPURenderPassEncoder,
    WGPUStringView,
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderPassEncoderSetBindGroup.argtypes = [
    WGPURenderPassEncoder,
    uint32_t,
    WGPUBindGroup,
    size_t,
...
try:
  ...
  wgpuRenderPassEncoderSetBlendConstant.argtypes = [
    WGPURenderPassEncoder,
    ctypes.POINTER(struct_WGPUColor),
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderPassEncoderSetIndexBuffer.argtypes = [
    WGPURenderPassEncoder,
    WGPUBuffer,
    WGPUIndexFormat,
    uint64_t,
...
try:
  ...
  wgpuRenderPassEncoderSetPipeline.argtypes = [
    WGPURenderPassEncoder,
    WGPURenderPipeline,
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderPassEncoderSetScissorRect.argtypes = [
    WGPURenderPassEncoder,
    uint32_t,
    uint32_t,
    uint32_t,
...
try:
  ...
  wgpuRenderPassEncoderSetStencilReference.argtypes = [
    WGPURenderPassEncoder,
    uint32_t,
  ]
except AttributeError:
...
try:
  ...
  wgpuRenderPassEncoderSetVertexBuffer.argtypes = [
    WGPURenderPassEncoder,
    uint32_t,
    WGPUBuffer,
    uint64_t,
...
try:
  ...
  wgpuRenderPassEncoderSetViewport.argtypes = [
    WGPURenderPassEncoder,
    ctypes.c_float,
    ctypes.c_float,
    ctypes.c_float,
...
try:
  ...
  wgpuRenderPassEncoderWriteTimestamp.argtypes = [
    WGPURenderPassEncoder,
    WGPUQuerySet,
    uint32_t,
  ]
...
try:
  ...
  wgpuShaderModuleGetCompilationInfo.argtypes = [
    WGPUShaderModule,
...
try:
  ...
  wgpuShaderModuleGetCompilationInfo2.argtypes = [
    WGPUShaderModule,
...
try:
  ...
  wgpuShaderModuleGetCompilationInfoF.argtypes = [
    WGPUShaderModule,
...
try:
  ...
  wgpuSharedBufferMemoryBeginAccess.argtypes = [
...
try:
  ...
  wgpuSharedBufferMemoryCreateBuffer.argtypes = [
    WGPUSharedBufferMemory,
    ctypes.POINTER(struct_WGPUBufferDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuSharedBufferMemoryEndAccess.argtypes = [
    WGPUSharedBufferMemory,
    WGPUBuffer,
    ctypes.POINTER(struct_WGPUSharedBufferMemoryEndAccessState),
  ]
...
try:
  ...
  wgpuSharedBufferMemoryGetProperties.argtypes = [
    WGPUSharedBufferMemory,
    ctypes.POINTER(struct_WGPUSharedBufferMemoryProperties),
  ]
except AttributeError:
...
try:
  ...
  wgpuSharedFenceExportInfo.argtypes = [
    WGPUSharedFence,
    ctypes.POINTER(struct_WGPUSharedFenceExportInfo),
  ]
except AttributeError:
...
try:
  ...
  wgpuSharedTextureMemoryBeginAccess.argtypes = [
...
try:
  ...
  wgpuSharedTextureMemoryCreateTexture.argtypes = [
    WGPUSharedTextureMemory,
    ctypes.POINTER(struct_WGPUTextureDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuSharedTextureMemoryEndAccess.argtypes = [
    WGPUSharedTextureMemory,
    WGPUTexture,
    ctypes.POINTER(struct_WGPUSharedTextureMemoryEndAccessState),
  ]
...
try:
  ...
  wgpuSharedTextureMemoryGetProperties.argtypes = [
    WGPUSharedTextureMemory,
    ctypes.POINTER(struct_WGPUSharedTextureMemoryProperties),
  ]
except AttributeError:
...
try:
  ...
  wgpuSharedTextureMemorySetLabel.argtypes = [
    WGPUSharedTextureMemory,
    WGPUStringView,
  ]
except AttributeError:
...
try:
  ...
  wgpuSurfaceGetCapabilities.argtypes = [
    WGPUSurface,
    WGPUAdapter,
    ctypes.POINTER(struct_WGPUSurfaceCapabilities),
  ]
...
try:
  ...
  wgpuSurfaceGetCurrentTexture.argtypes = [
    WGPUSurface,
    ctypes.POINTER(struct_WGPUSurfaceTexture),
  ]
except AttributeError:
...
try:
  ...
  wgpuTextureCreateErrorView.argtypes = [
    WGPUTexture,
    ctypes.POINTER(struct_WGPUTextureViewDescriptor),
  ]
except AttributeError:
...
try:
  ...
  wgpuTextureCreateView.argtypes = [
    WGPUTexture,
    ctypes.POINTER(struct_WGPUTextureViewDescriptor),
  ]
except AttributeError:
...
__all__ = [
  ...
  "WGPUDrmFormatCapabilities",
  "WGPUDrmFormatProperties",
  "WGPUErrorCallback",
  "WGPUErrorFilter",
  ...
  "WGPUProcDevicePopErrorScope2",
  "WGPUProcDevicePopErrorScopeF",
  ...
  "int32_t",
  "size_t",
  "struct_WGPUAHardwareBufferProperties",
  "struct_WGPUAdapterImpl",
  ...
  "struct_WGPUBindGroupLayoutImpl",
  ...
  "struct_WGPUComputePipelineImpl",
  ...
  "struct_WGPUInstanceFeatures",
  "struct_WGPUInstanceImpl",
  "struct_WGPULimits",
  "struct_WGPUMemoryHeapInfo",
  ...
  "struct_WGPUSharedFenceExportInfo",
  "struct_WGPUSharedFenceImpl",
  "struct_WGPUSharedFenceMTLSharedEventDescriptor",
  "struct_WGPUSharedFenceMTLSharedEventExportInfo",
